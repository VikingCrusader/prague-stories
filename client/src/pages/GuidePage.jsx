...
const CONTENT = {
  en: {
    ...
    start: [
      { b: "Register", rest: " — choose a username you won't regret in six months. You begin at Level 1: Newcomer. This is accurate. Embrace it." },
    ...
    cats: [],
    mapTitle: "Map",
    map: "Your command centre. Gold markers = yours. Grey = unclaimed. Your position is shown as a red dot. Marker size scales with zoom. Walk within 100 m of an unvisited location and an OS notification fires — even when you're in another app. Tap it. The app checks you in automatically and opens the card.",
    ...
    steps: [
      ...
      "Option A — tap the proximity notification. The app checks you in automatically and opens the card. Done.",
      "Option B — open the location detail from the Explore grid and tap Collect.",
    ...
    xpOutro: "30 levels total: from Newcomer to Prague Legend. The gold cards know where you need to go.",
  ...
  cz: {
    ...
    start: [
      { b: "Registrace", rest: " — vyber si uživatelské jméno, kterého nebudeš litovat za šest měsíců. Začínáš na Úrovni 1: Nováček. Toto je přesné. Přijmi to." },
    ...
    cats: [],
    mapTitle: "Mapa",
    map: "Tvoje velitelské centrum. Zlaté značky = tvoje. Šedé = nevyžádané. Tvoje poloha je zobrazena jako červená tečka. Velikost značek se mění podle přiblížení. Přijď do 100 m od nenavštíveného místa a vyskočí ti systémové oznámení — i když máš otevřenou jinou aplikaci. Klepni na oznámení. Aplikace tě automaticky přihlásí a otevře kartu místa.",
    ...
    steps: [
      ...
      "Možnost A — klepni na oznámení o blízkosti. Aplikace tě automaticky přihlásí a otevře kartu místa. Hotovo.",
      "Možnost B — otevři detail místa z Průzkumu a klikni na Sbírat.",
    ...
    xpOutro: "30 úrovní celkem: od Nováčka po Pražskou Legendu. Zlaté karty ti ukážou, kam jít.",
    achTitle: "Úspěchy",
  ...
  zh: {
    ...
    startTitle: "快速开始",
    start: [
      { b: "注册", rest: "——选一个六个月后不会后悔的用户名。你从第1级：新来者开始。这很准确，接受现实吧。" },
    ...
    cats: [],
    mapTitle: "地图",
    map: "你的指挥中心。金色标记=已解锁。灰色=待征服。你的位置以红点显示，圆圈大小随缩放比例动态调整。走进未访问地点100米范围内，系统通知会自动弹出——即使你正在使用其他应用也没关系。点击通知，应用会自动为你打卡并打开地点卡片。",
    detailTitle: "地点详情",
    ...
    steps: [
      "去那个地点。亲身前往，带上你的身体。",
      "方式一——点击附近通知。应用自动为你打卡并打开地点卡片，完成。",
      "方式二——在探索网格中打开地点详情，点击打卡。",
      "应用悄悄请求你的GPS坐标。",
      "服务器检查你是否真的在范围内。",
    ...
    xpOutro: "共30个等级：从新来者到布拉格传奇。金色卡牌会告诉你该去哪里。",
    achTitle: "成就",
