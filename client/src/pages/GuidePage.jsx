...
const CONTENT = {
  en: {
    ...
    explore: "Every location in the game. Filter by category, search by name (which defeats some of the mystery, but is allowed), or switch to My Collections to review past conquests smugly.",
    cats: [
    ...
    xpTitle: "XP & Levels",
    xpIntro: "Each location pays 10–30 XP. Harder to reach = more rewarding. Difficulty rated 1–3:",
    diff: [
      "You will trip over it leaving your hotel.",
      "Requires a tram, some intention, and a vague idea of which direction north is.",
      "You planned this. You brought snacks.",
    ],
    xpOutro: "8 levels total: from Lost Tourist to Prague Legend. Commitment is rewarded.",
    ...
    tips: [
      ...
      { icon: "🥾", text: "Difficulty 3 locations reward commitment. Reaching a riverside confluence with zero other tourists present is its own reward. The XP is almost a footnote." },
  ...
  cz: {
    ...
    explore: "Všechna místa ve hře. Filtruj podle kategorie, hledej podle jména (což kazí část záhady, ale je to povoleno), nebo přepni na Moje sbírka pro sebechvalnou prohlídku minulých výbojů.",
    cats: [
    ...
    xpTitle: "XP a úrovně",
    xpIntro: "Každé místo vyplácí 10–30 XP. Hůř dostupné = víc odměňující. Obtížnost hodnocena 1–3:",
    diff: [
      "Zakopneš o to při odchodu z hotelu.",
      "Vyžaduje tramvaj, nějaký záměr a přibližnou představu, kde je sever.",
      "Plánoval jsi to. Přinesl jsi svačinu.",
    ],
    xpOutro: "8 úrovní celkem: od Ztraceného Turisty po Pražskou Legendu. Odhodlání se vyplácí.",
    achTitle: "Úspěchy",
    ...
    tips: [
      ...
      { icon: "🥾", text: "Obtížnost 3 odměňuje odhodlání. Dostat se k soutočí řek bez dalších turistů je samo o sobě odměnou. XP je téměř bonus navíc." },
  ...
  zh: {
    ...
    screensTitle: "各个页面",
    exploreTitle: "探索网格",
    explore: "游戏中的所有地点。按类别筛选、按名字搜索（这会破坏一些神秘感，但仍然允许），或切换到我的收藏，自我陶醉地回顾过去的战绩。",
    cats: [
    ...
    xpTitle: "经验值与等级",
    xpIntro: "每个地点奖励10–30经验值。越难到达，奖励越高。难度分1–3：",
    diff: [
      "你离开酒店时会绊到它。",
      "需要乘坐有轨电车，一些意图，以及对哪个方向是北方的模糊了解。",
      "你专程来这里的。你带了零食。",
    ],
    xpOutro: "共8个等级：从迷路的游客到布拉格传奇。坚持就是奖励。",
    achTitle: "成就",
    ...
    tips: [
      ...
      { icon: "🥾", text: "3难度地点奖励毅力。在没有其他游客的情况下到达两河交汇处，本身就是奖励。经验值几乎是附赠的。" },
