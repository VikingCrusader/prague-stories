...
const CONTENT = {
  en: {
    ...
    xpOutro: "60 levels total: from Newcomer to Prague Legend. The gold cards know where you need to go.",
  ...
  cz: {
    ...
    xpOutro: "60 úrovní celkem: od Nováčka po Pražskou Legendu. Zlaté karty ti ukážou, kam jít.",
    achTitle: "Úspěchy",
  ...
  zh: {
    ...
    xpOutro: "共60个等级：从新来者到布拉格传奇。金色卡牌会告诉你该去哪里。",
    achTitle: "成就",
