...
const CONTENT = {
  en: {
    ...
    tips: [
      ...
      { icon: "◆", text: "Epic and Legend locations pay the most XP. Open the Rarity filter, select Epic or Legend, and go there first. The XP is proportional to the effort — and the effort is proportional to how few other tourists are present." },
  ...
  cz: {
    ...
    tips: [
      ...
      { icon: "◆", text: "Epická a Legendární místa platí nejvíce XP. Otevři filtr Vzácnost, vyber Epické nebo Legendární a jdi tam jako první. XP odpovídá úsilí — a úsilí odpovídá tomu, jak málo turistů tam bude." },
  ...
  zh: {
    ...
    tips: [
      ...
      { icon: "◆", text: "史诗和传说地点经验最高。打开稀有度筛选器，选择史诗或传说，优先去那里。经验值与你付出的努力成正比——而努力程度通常与那里没有其他游客成正比。" },
