...
const T = {
  en: {
    ...
    'grid.filterAll': '★ All',
    'grid.filterDiscovered': '✓ Discovered',
    ...
    'proximity.prompt': 'You discovered {name}! Check in now?',
  ...
  cz: {
    ...
    'grid.filterAll': '★ Vše',
    'grid.filterDiscovered': '✓ Navštíveno',
    ...
    'proximity.prompt': 'Objevil jsi {name}! Přihlásit se?',
  ...
  zh: {
    ...
    'proximity.title': '★ 发现！',
    'proximity.prompt': '你发现了{name}！现在打卡？',
    'common.checkIn': '★ 打卡',
