...
export const historyEvents = [
  ...
  },
  {
    ...
    images: ["/history/three-guardians-1279.webp"],
    tone: "humorous",
    title: {
      en: "A Captive Boy-King and His Three Guardians",
      cz: "Zajatý chlapecký král a jeho tři poručníci",
      zh: "一个被囚禁的少主和他的三个监护人",
    },
    hookLine: {
