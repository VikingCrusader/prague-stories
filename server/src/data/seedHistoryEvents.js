...
export const historyEvents = [
  ...
  },
  {
    ...
    relatedLandmarks: [
      ...
      },
      {
        slug: "olomouc",
        relation: {
          en: "The city Vratislaus carved a whole new diocese out of in 1063 — the real opening shot in his feud with his own brother, years before Vyšehrad ever entered the picture.",
          cz: "Město, ze kterého Vratislav v roce 1063 vyčlenil úplně novou diecézi — skutečný první výstřel v jeho sporu s vlastním bratrem, roky předtím, než do hry vůbec vstoupil Vyšehrad.",
          zh: "1063年，弗拉季斯拉夫从这里划出了一整个新教区——这才是他跟亲弟弟那场纷争真正的第一枪，比维谢赫拉德登场还要早上好几年。",
        },
      },
    ],
  ...
  },
  {
    ...
    summary: {
      en: "Wenceslas had made two separate enemies over the past decade, and in 1303 they finally figured out they wanted the same thing at the same time. Albert of Habsburg — this timeline's own old acquaintance, the man Wenceslas quietly maneuvered out of the imperial election back in 1292, King of the Romans in his own right now, since defeating Adolf of Nassau at Göllheim in 1298 — had already inherited one grudge straight from his predecessor: Adolf's own old push to seize Thuringia and Meissen from the Wettin family, the very same territory Adolf had once promised Wenceslas and then quietly reneged on. Same fight, new heir, same result either way — Bohemia losing out. Albert now joined forces with Pope Boniface VIII, who'd already thrown his weight behind Charles Robert of Anjou's rival claim to Hungary. Together they handed Wenceslas an ultimatum: give up Poland. Give up Hungary. And give up Bohemia's rights to Kutná Hora's silver. The first two at least came dressed in legal reasoning — Boniface VIII had been arguing for years that conferring those two crowns was the Holy See's prerogative, not any king's, however self-serving that argument happened to be. Nobody bothered dressing up the third one at all: Kutná Hora was Bohemia's own city, on Bohemia's own soil, funding Bohemia's own crown, and Albert simply wanted a piece of it — no pretext offered, none apparently needed. That was, of course, the demand that actually mattered. Nobody assembles a coalition over a hollow Hungarian crown sitting on a child's head anyway — Albert wanted the mines that had just turned Bohemia into one of the wealthiest kingdoms in Europe.\n\nWenceslas answered on two diplomatic fronts at once, both run by the same man: Peter of Aspelt, an experienced and well-traveled negotiator. In the summer of 1303, Peter brokered the outline of an alliance with Philip IV of France, who had his own long-running fight with Boniface VIII over exactly how much authority a pope got to claim over a king — Wenceslas even agreed to raise 100,000 marks of silver in northern Germany toward a war chest as part of the deal. None of this was really a stance against Charles Robert's own family, even though the two of them were distant cousins. Philip's branch of the Capetians and the Angevins of Naples got along fine elsewhere — the two crowns had even signed a treaty together a decade earlier. Philip's fight with the Pope was strictly a domestic matter: he needed money for a war with England, wanted to tax the French clergy to raise it, and Boniface's insistence that popes outranked kings on exactly that question threatened Philip's own authority at home, not his cousins' ambitions in Hungary. By September 1303, the quarrel had turned personal enough that Philip's own agents seized the Pope at Anagni. Boniface died a month later. It was that death, not any change of heart about Hungary, that let his successor make peace with France almost immediately — the broader Czech-French cooperation those 1303 talks had aimed for never fully materialized, and Philip's support evaporated before it had done Wenceslas any real good. Peter tried the opposite direction too, traveling to Vienna to talk Albert down before it came to open war. That failed as well.\n\nAlbert's own version of the ultimatum, delivered formally in 1304, went further than Wenceslas's own diplomacy could head off: pay the imperial tithe — a tax Bohemia's kings had been formally exempted from since 1298 — or hand over Kutná Hora for six years outright, and, either way, surrender control of the Pleissnerland, Cheb, Meissen, Hungary, and Poland. Wenceslas refused flatly. That May, Albert placed him under the imperial ban. A long list of ambitious nobles, expecting an easy Habsburg win, signed on for the campaign — mostly for the plunder they assumed was coming.\n\nThat August, Charles Robert of Anjou and Wenceslas's own Polish rival, Władysław Łokietek, met in Bratislava — then under Albert's own control — to coordinate the attack; Henry III, Duke of Głogów, reportedly promised support too. Wenceslas wasn't friendless either. The Ascanians of Brandenburg and the Teutonic Knights, both with a long history of good relations with Bohemia, pledged their own alliance. Before leaving for Hungary that summer, Wenceslas handed the regency to Herman of Brandenburg — who happened, in one of this whole affair's tidier ironies, to be Albert's own son-in-law, having married his daughter Anne.\n\nCzech troops had to pull out of Hungary that same summer — not only because the position there had become hopeless, but because Albert's own advance units, joined by his son Rudolf III, Duke of Austria, and by Charles Robert of Anjou himself, had already started attacking Moravia while Wenceslas was still abroad. Even with an imperial army bearing down, Bohemia's own nobility held firm: the Vítkovci, guarding the border forests, stayed loyal this time — unlike parts of Bohemia's own nobility, who had slipped over to the Roman king's side once before, under Otakar II.\n\nNot until early October did the imperial army — reinforced by Hungarian allies who'd spent the intervening months systematically plundering Moravia — finally push toward Kutná Hora itself. Albert wanted one decisive battle. Wenceslas refused to give him one, splitting his own forces into smaller, faster units built to wear the invaders down rather than meet them head-on. The Ascanians waited at Nymburk for his orders: Herman of Brandenburg and his own sixty-year-old uncle, Otto 'the Arrow.' Command of part of Wenceslas's own German mercenary troops went to Rupert of Nassau — son of the very King Adolf that Albert had killed to take the throne, and, not incidentally, Wenceslas's own former son-in-law, once married to his daughter Agnes.\n\nAlbert laid siege to Kutná Hora directly — and then his camp fell apart from the inside. Dysentery tore through the besieging army, and medieval chroniclers were in no doubt about the cause: the miners themselves, fouling the very stream that fed the enemy's water supply.\n\n[[quote:1]]\n\nWhatever the exact mechanism, the effect was real. An army that had come for the mines was being poisoned by them instead.\n\nAs Wenceslas closed in, Albert pulled back from the siege to wait for the decisive battle he still wanted — and never got the chance to fight it. With nowhere left to advance and no way to force the issue, the Roman king had no choice but to retreat, and Wenceslas's own forces picked off his scattered allied contingents as they went. An orderly withdrawal collapsed into a flight across highlands already covered in early snow. Only a remnant of the army Albert had marched in with ever made it home.\n\nMeanwhile, his son's position in Hungary was unraveling on its own terms: Matthew Csák and the Abas, two of the noble factions that had once backed young Wenceslas, defected to Charles's side in 1303, leaving the boy king dangerously exposed. What doesn't come through in a list of invasions, sieges, and alliances is that underneath the strategy, this was also just a father worried about his son. The Zbraslav Chronicle puts it plainly:\n\n[[quote:0]]\n\nHe marched into Hungary that June — already, though barely anyone around him seemed to notice yet, troubled by a persistent cough that wouldn't go away. What happened once he got there is its own story.",
      cz: "Václav si za poslední desetiletí nadělal dva samostatné nepřátele, a v roce 1303 konečně přišli na to, že chtějí totéž, a to ve stejnou chvíli. Albrecht Habsburský — stará známost téhle časové osy, muž, kterého Václav v roce 1292 potichu vymanévroval z císařské volby, teď už sám římským králem od chvíle, kdy v roce 1298 porazil Adolfa Nasavského u Göllheimu — už si od svého předchůdce zdědil jednu starou při: Adolfovu vlastní snahu urvat Wettinům Duryňsko a Míšeňsko, přesně to samé území, které Adolf kdysi slíbil Václavovi a pak ho z toho potichu vyšachoval. Stejný spor, nový dědic, výsledek stejný — Čechy zase krátí. Albrecht teď spojil síly s papežem Bonifácem VIII., který už dřív vsadil celou svou váhu na Karla Roberta z Anjou jako soupeře o uherský trůn. Společně Václavovi předložili ultimátum: vzdej se Polska. Vzdej se Uher. A vzdej se českých práv na kutnohorské stříbro. První dva požadavky měly aspoň nějaké právní odůvodnění — Bonifác VIII. už léta tvrdil, že udílet obě tyto koruny je výsadou Svatého stolce, ne kteréhokoli krále, ať už bylo tohle tvrzení jakkoli účelové. Třetí požadavek si nikdo nedal ani tu práci nějak zaobalit: Kutná Hora byla české město, na české půdě, financující českou korunu — a Albrecht si z toho prostě chtěl ukousnout, bez záminky a zjevně i bez potřeby nějaké mít. To byl samozřejmě ten požadavek, na kterém skutečně záleželo. Nikdo nesestavuje koalici kvůli prázdné uherské koruně na hlavě dítěte — Albrecht chtěl doly, které z Čech právě udělaly jedno z nejbohatších království Evropy.\n\nVáclav odpověděl hned na dvou diplomatických frontách zároveň, obě vedl tentýž muž: Petr z Aspeltu, zkušený a znalý vyjednavač. V létě 1303 Petr vyjednal obrysy spojenectví s francouzským Filipem IV., který měl s Bonifácem VIII. vlastní dlouholetý spor o to, kolik moci si papež smí nárokovat nad králem — Václav se v rámci dohody dokonce zavázal vybrat v severním Německu 100 000 hřiven stříbra na válečnou pokladnu. Nešlo tady vůbec o postoj vůči Karlově vlastní rodině, i když byli vzdálení bratranci. Filipova větev Kapetovců a neapolští Anjouovci si jinak vycházeli dobře — obě koruny spolu dokonce před deseti lety podepsaly smlouvu. Filipův spor s papežem byl čistě domácí záležitost: potřeboval peníze na válku s Anglií, chtěl je vybrat zdaněním francouzského duchovenstva, a Bonifácovo tvrzení, že v téhle otázce stojí papež nad králem, ohrožovalo Filipovu vlastní moc doma, ne ambice jeho bratranců v Uhrách. V září 1303 se ten spor vyhrotil natolik, že Filipovi lidé papeže přímo zajali v Anagni. Bonifác zemřel o měsíc později. Právě tahle smrt, ne žádná změna názoru na Uhry, umožnila jeho nástupci téměř okamžitě uzavřít s Francií mír — širší česko-francouzská spolupráce, o kterou se ta jednání z roku 1303 snažila, se nakonec nikdy plně nerozvinula, a Filipova podpora se vypařila dřív, než Václavovi stihla k něčemu opravdu být. Petr to zkusil i opačným směrem: odjel do Vídně vyjednávat s Albrechtem, aby zabránil otevřené válce. Ani to se nepovedlo.\n\nAlbrechtova vlastní verze ultimáta, doručená formálně v roce 1304, šla dál, než co Václavova vlastní diplomacie dokázala odvrátit: zaplať říšský desátek — daň, od které byli čeští králové od roku 1298 formálně osvobozeni — nebo vydej Kutnou Horu na šest let, a tak jako tak se vzdej vlády nad Plisenskem, Chebskem, Míšeňskem, Uhrami a Polskem. Václav odmítl naprosto. Toho května na něj Albrecht uvalil říšskou klatbu. Dlouhá řada ctižádostivých šlechticů, počítajících s lehkým habsburským vítězstvím, se k tažení přihlásila — většinou kvůli kořisti, kterou od něj čekali.\n\nToho srpna se v Bratislavě — tou dobou pod Albrechtovou vlastní kontrolou — sešli Karel Robert z Anjou a Václavův vlastní polský sok Vladislav Lokýtek, aby sladili útok; podporu prý přislíbil i Jindřich III. Hlohovský. Václav ale osamocený nebyl. Braniborští Askánci a řád německých rytířů, oba s dlouhou historií dobrých vztahů s Čechami, přislíbili vlastní spojenectví. Než toho léta odjel do Uher, svěřil Václav regentství Heřmanovi Braniborskému — který shodou okolností, v jedné z úhlednějších ironií celé téhle aféry, byl Albrechtovým vlastním zetěm, ženatým s jeho dcerou Annou.\n\nČeské oddíly musely toho samého léta z Uher odtáhnout — nejen proto, že tamní pozice se stala beznadějnou, ale i proto, že Albrechtovy předsunuté jednotky, posílené jeho synem Rudolfem III., vévodou rakouským, a samotným Karlem Robertem z Anjou, už zatím, co byl Václav v cizině, začaly útočit na Moravu. I tváří v tvář postupující říšské armádě zůstala česká šlechta věrná: Vítkovci, střežící pohraniční lesy, tentokrát zůstali loajální — na rozdíl od části české šlechty, která se kdysi, za Otakara II., na stranu římského krále už jednou přiklonila.\n\nAž začátkem října se říšská armáda — posílená uherskými spojenci, kteří mezitím soustavně plenili Moravu — konečně vydala směrem ke Kutné Hoře samotné. Albrecht chtěl jednu rozhodující bitvu. Václav mu ji odmítl dopřát a rozdělil vlastní vojsko na menší, pohyblivější oddíly stavěné na to, aby útočníky opotřebovávaly, ne aby se s nimi střetly čelně. Askánci čekali na jeho rozkazy v Nymburce: Heřman Braniborský a jeho vlastní šedesátiletý strýc Otto „se šípem\". Velení nad částí Václavových vlastních německých žoldnéřských oddílů připadlo Ruprechtovi Nasavskému — synovi téhož krále Adolfa, kterého Albrecht zabil, aby se dostal na trůn, a mimochodem i Václavovu vlastnímu bývalému zeti, kdysi ženatému s jeho dcerou Anežkou.\n\nAlbrecht oblehl Kutnou Horu přímo — a jeho tábor se pak rozpadl zevnitř. Obléhajícím vojskem se prohnala úplavice, a dobové kroniky o příčině neměly pochyb: sami horníci, znečišťující právě ten potok, který zásoboval vodou nepřátelský tábor.\n\n[[quote:1]]\n\nAť už byl přesný mechanismus jakýkoli, účinek byl skutečný. Vojsko, které přitáhlo kvůli dolům, teď doly samotné otrávily.\n\nJak se Václav blížil, Albrecht od obléhání ustoupil a čekal na rozhodující bitvu, kterou pořád chtěl svést — a nikdy nedostal příležitost ji svést. Bez možnosti postupovat dál a bez způsobu, jak si vynutit rozhodnutí, neměl římský král jinou možnost než ustoupit, a Václavovy vlastní síly cestou vybíraly jeho rozptýlené spojenecké oddíly jeden po druhém. Z organizovaného ústupu se stal útěk přes vysočinu, už pokrytou časným sněhem. Domů se vrátil jen zlomek vojska, se kterým Albrecht vytáhl.\n\nMezitím se postavení jeho syna v Uhrách hroutilo vlastním tempem: Matúš Čák a rod Abovců, dvě šlechtické frakce, které kdysi podporovaly mladého Václava, přeběhly v roce 1303 na Karlovu stranu a nechaly chlapeckého krále nebezpečně nekrytého. Co v seznamu invazí, obléhání a spojenectví úplně nevynikne, je to, že pod celou tou strategií byl taky prostě otec, který se bojí o syna. Zbraslavská kronika to říká na rovinu:\n\n[[quote:0]]\n\nDo Uher vytáhl toho června — už tehdy, ačkoli si toho v jeho okolí skoro nikdo ještě nevšímal, trápil ho neustupující kašel. Co se stalo, jakmile tam dorazil, je už jiný příběh.",
      zh: "瓦茨拉夫过去十年里得罪了两个各自独立的敌人。1303年，这两人终于发现彼此想要的是同一件事，而且是在同一时间。哈布斯堡的阿尔布雷希特——我们的老熟人，1292年被瓦茨拉夫悄悄操作出局、没能拿到皇位选举资格的那位——如今已经凭自己实力当上了罗马人的国王，自从1298年在戈尔海姆击败拿骚的阿道夫以后。他从前任手里还顺带继承了一笔旧账：阿道夫当年也想从韦廷家族手里夺走图林根和迈森，正是他曾经许给瓦茨拉夫、后来又悄悄食言的那同一块地方。仇恨换了个人扛，结果还是一样——吃亏的还是波希米亚。阿尔布雷希特这时联手了教皇卜尼法斯八世——教皇早就把全部分量都押在了安茹的查理·罗伯特争夺匈牙利王位这件事上。两人联手向瓦茨拉夫下了最后通牒：放弃波兰。放弃匈牙利。还有，放弃波希米亚对库特纳霍拉银矿的权利。前两项好歹还披着一层法理的外衣——卜尼法斯八世多年来一直坚称，这两顶王冠该由谁来戴，是圣座的特权，不归任何国王管，尽管这套说辞本身私心昭然。第三项，压根没人费心去包装：库特纳霍拉是波希米亚自己的城市，长在波希米亚自己的土地上，供养着波希米亚自己的王室——阿尔布雷希特就是单纯想要分一杯羹，没给理由，显然也懒得给。这才是真正要命的那一条。没人会为了一顶戴在年幼的国王头上、且形同虚设的匈牙利王冠特意组一个联盟——阿尔布雷希特真正想要的，是那片刚刚把波希米亚变成欧洲最富有王国之一的银矿。\n\n瓦茨拉夫同时在两条外交战线上回应，操盘的都是同一个人：经验丰富的谈判高手阿斯佩尔特的彼得。1303年夏天，彼得促成了一份跟法国腓力四世结盟的初步协议——后者跟卜尼法斯八世也有自己一场旷日持久的争执，争的是教皇到底能对国王的权力伸手伸到多远——瓦茨拉夫甚至承诺要在德意志北部筹集10万格里夫纳白银，充作战争基金的一部分。这跟查理·罗伯特自己的家族没什么关系，虽然两人算是远房表亲。腓力这一支卡佩家族，跟那不勒斯的安茹家族，其他场合处得还不错——两家王室十年前甚至还签过一份条约。腓力和教皇的这场争执，纯粹是法国内部的事：他打英国需要钱，想对法国教士征税来筹钱，卜尼法斯坚持这种事上教皇的权威高过国王，这威胁到的是腓力自己在国内的权力，跟他那些在匈牙利的堂表亲的野心没什么关系。1303年9月，双方闹到腓力的人直接在阿纳尼把教皇给绑了。一个月后，卜尼法斯就去世了。真正让新教皇跟法国几乎立刻和解的，是这次死亡，不是什么对匈牙利问题改了主意——1303年那场谈判本来想促成的更广泛的捷法合作，最终也没能真正落地。腓力的支持还没来得及帮上什么忙，就已经烟消云散。彼得也试过反方向的路子：跑去维也纳，想在事情演变成公开战争之前先说服阿尔布雷希特。这条路同样没能走通。\n\n阿尔布雷希特自己那版最后通牒，1304年正式送达，比瓦茨拉夫这边的外交手段所能挡住的要过分得多：要么缴纳帝国什一税——一项波希米亚国王自1298年起就被正式豁免的税——要么直接交出库特纳霍拉六年，而且不管选哪条，都要放弃对普利申斯克、赫布、迈森、匈牙利和波兰的控制权。瓦茨拉夫断然拒绝。当年5月，阿尔布雷希特对他下达了帝国禁令。一长串野心勃勃的贵族，笃定哈布斯堡这边稳赢，纷纷报名加入这场远征——多半是冲着他们以为唾手可得的战利品来的。\n\n那年8月，安茹的查理·罗伯特和瓦茨拉夫自己的波兰对头瓦迪斯瓦夫·洛基泰克，在当时由阿尔布雷希特控制的布拉迪斯拉发碰头，商量联手进攻的部署；据说格沃古夫公爵亨利三世也承诺出兵支持。但瓦茨拉夫这边也不是孤立无援。勃兰登堡的阿斯坎家族和条顿骑士团——两边都跟波希米亚素来交好——也各自承诺结盟。那年夏天离开去匈牙利之前，瓦茨拉夫把摄政大权交给了勃兰登堡的赫尔曼——这整件事里比较工整的一个讽刺是：赫尔曼恰好是阿尔布雷希特自己的女婿，娶的是他女儿安娜。\n\n那同一个夏天，波希米亚军队不得不从匈牙利撤出——不只是因为那边的局势已经无可挽回，还因为阿尔布雷希特的先头部队，加上他儿子奥地利公爵鲁道夫三世，还有查理·罗伯特本人，趁瓦茨拉夫还在国外的时候，已经开始进攻摩拉维亚了。即便帝国大军压境，波希米亚本国的贵族依然站稳了脚跟：镇守边境森林的维特科维奇家族，这一次没有倒戈——不像当年奥托卡二世治下，波希米亚贵族里曾经有一部分人真的投向过罗马国王那边。\n\n直到10月初，帝国军队——这时已经有那些一路系统性劫掠摩拉维亚的匈牙利盟友加入——才终于向库特纳霍拉本身推进。阿尔布雷希特想要的是一场决定性会战。瓦茨拉夫不给他这个机会，把自己的军队拆成了更小、更灵活的部队，专门用来消耗入侵者，而不是正面硬碰。阿斯坎家族的人在宁布尔克等着他的命令：赫尔曼和他六十岁的叔叔“箭王”奥托。瓦茨拉夫麾下一部分德意志雇佣兵的指挥权，落在了拿骚的鲁普雷希特手里——他正是阿尔布雷希特为了夺权而杀掉的那位阿道夫国王的儿子，顺带一提，也是瓦茨拉夫自己的前女婿，当年娶过他的女儿阿格妮丝。\n\n阿尔布雷希特直接围攻库特纳霍拉——结果自己的军营从内部先垮了。痢疾席卷了整支围城部队，当时的编年史家对病因毫不怀疑：是矿工自己动的手，污染了那条供应敌军水源的溪流。\n\n[[quote:1]]\n\n不管具体是怎么办到的，效果是实打实的。一支冲着银矿而来的军队，反倒被银矿本身给放倒了。\n\n瓦茨拉夫步步逼近之际，阿尔布雷希特从围城中撤了出来，等着他一直想打的那场决定性会战——可他到死都没等来开打的机会。无路可进，也没法逼出一个结果，这位罗马国王除了撤军别无选择，瓦茨拉夫的部队则沿路一个个收拾掉他那些分散的盟军。一场原本还算有序的撤退，最后演变成了穿越已经落雪的高地的一场溃逃。跟着阿尔布雷希特出征的那支军队，最后只有一小部分残兵回到了家。\n\n与此同时，他儿子在匈牙利那边的处境，正按自己的节奏在崩塌：马泰·恰克和阿巴家族，这两个曾经支持过年轻瓦茨拉夫的贵族派系，1303年倒向了查理那边，把这位男孩国王暴露在了危险之中。一长串入侵、围城和结盟的清单没能完全体现出来的是：在这套战略布局底下，这其实也不过是一位父亲在为儿子的安危发愁。《兹布拉斯拉夫编年史》说得很直白：\n\n[[quote:0]]\n\n他那年六月出兵匈牙利——那时他已经被一阵怎么都止不住的咳嗽缠上了，只是身边几乎没人把这当回事。至于他抵达之后发生了什么，那是另一个故事了。",
    },
    quotes: [
      {
        text: {
      ...
      {
        text: {
          en: "For many miners mixed coal-slag and foamy silver dross and other muddy filth from the pits and smelting-houses into that stream flowing toward the enemy army… so that countless men and livestock perished, poisoned by that venom…",
          cz: "Neboť četní horníci přimísili mour a pěnovou strusku ze stříbra a jiné bahnité nečistoty z jam a hutí do onoho potoka, tekoucího k nepřátelskému vojsku… takže zahynulo bez počtu lidí a dobytka, otráveno oním jedem…",
          zh: "许多矿工把煤渣、白银熔炼产生的泡沫状矿渣，以及矿坑和冶炼作坊里的其他污浊杂质，一并混进了那条流向敌军的溪水中……以致无数人畜因中毒而丧命……",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "Wait, Isn't That France's Flag?",
      cz: "Počkat, není to vlajka Francie?",
      zh: "等等，这不是法国的旗子吗？",
    },
    hookLine: {
      en: "The banner behind Charles Robert of Anjou looks suspiciously like France's own. It's a family resemblance — literally.",
      cz: "Vlajka za Karlem Robertem z Anjou vypadá podezřele jako ta francouzská. Je to rodinná podobnost — doslova.",
      zh: "查理·罗伯特身后那面旗子，看着跟法国的旗子出奇地像。这是一种血缘上的相似——真的是血缘。",
    },
    summary: {
      en: "The blue-and-gold-lily banner flying over Charles Robert of Anjou's men looks like it should belong to the King of France — and in a sense, it almost does. The House of Anjou was a cadet branch of France's own royal family: Charles of Anjou, a younger brother of King Louis IX (Saint Louis), inherited the county of Anjou in the 1240s and, a generation later, took an offer nobody in France was making him. The Papacy, locked in its own long fight against the German Hohenstaufen emperors for control of Italy, needed a loyal Catholic prince to conquer southern Italy and rule it in Rome's interest instead. Charles took the job: he defeated and killed King Manfred of Sicily in 1266, executed the teenage Hohenstaufen heir Conradin two years later, and became King of Naples and Sicily — a French prince ruling an Italian kingdom, on the Pope's own invitation.\n\nThe family kept the fleur-de-lis, but not the plain version — a red 'label,' a short bar with hanging tags across the top of the flag, marked every Angevin banner as a junior branch, never the crown itself. That distinction mattered enough to draw, but it didn't stop the family from spreading: Charles's own descendants picked up a claim to Hungary too, through a marriage two generations later — which is exactly how his great-grandson, Charles Robert, ended up as the rival claimant giving Wenceslas's own son such a hard time in Hungary. Keep an eye on this banner. French cadet branches like this one tended to land thrones rather than titles, and this particular one is about to spend the next several decades actually running Hungary.",
      cz: "Modro-zlatá vlajka s liliemi, kterou nesou muži Karla Roberta z Anjou, vypadá, jako by měla patřit francouzskému králi — a v jistém smyslu k tomu není daleko. Rod Anjou byl vedlejší větví samotné francouzské královské rodiny: Karel z Anjou, mladší bratr krále Ludvíka IX. (svatého Ludvíka), zdědil ve 40. letech 13. století hrabství Anjou a o generaci později přijal nabídku, kterou mu nikdo ve Francii nedával. Papežství, uvízlé ve vlastním dlouhém boji s německými Hohenstaufeny o vliv v Itálii, potřebovalo věrného katolického knížete, který by dobyl jižní Itálii a vládl jí v zájmu Říma místo nich. Karel tu nabídku přijal: v roce 1266 porazil a zabil sicilského krále Manfréda, o dva roky později popravil tehdy ještě mladého hohenstaufského dědice Konradina a stal se králem Neapole a Sicílie — francouzský princ vládnoucí italskému království, na přímé pozvání papeže.\n\nRodina si liliovou lilii nechala, ale ne v čisté podobě — červený 'label', krátký pruh se závěsnými jazýčky přes horní část vlajky, značil každou andegavskou vlajku jako vedlejší větev, nikdy jako samotnou korunu. Ten rozdíl stál za to zaznamenat, ale rodinu to nezastavilo v šíření: Karlovi potomci si o dvě generace později přivlastnili sňatkem i nárok na uherský trůn — přesně tak se jeho pravnuk, Karel Robert, dostal do role rivala, který dával Václavovu synovi v Uhrách tak zabrat. Tuhle vlajku si pamatujte. Francouzské vedlejší větve tohoto typu měly ve zvyku získávat trůny, ne jen tituly, a tahle konkrétní se chystá dalších několik desetiletí skutečně vládnout Uhrám.",
      zh: "查理·罗伯特的部下扛的那面蓝底金鸢尾花旗子，看上去像是该属于法国国王的旗子——某种意义上，也确实差不了多少。安茹家族是法国王室自己的一个旁支：安茹的查理，法王路易九世（“圣路易”）的弟弟，13世纪40年代继承了安茹伯爵领地，一代人之后，他接下了一个法国国内没人给他的差事。当时教廷正跟德意志的霍亨斯陶芬皇室在意大利争夺控制权，正好需要一位忠实的天主教亲王去征服意大利南部、替罗马而不是替皇帝统治那里。查理接下了这个活：1266年他打败并杀死了西西里国王曼弗雷德，两年后又处死了当时还年少的霍亨斯陶芬继承人康拉丁，自己当上了那不勒斯和西西里国王——一位法国王子，靠教皇亲自邀请，统治着一个意大利王国。\n\n家族保留了鸢尾花纹样，但不是纯正版本——旗子上方那道红色“标签”，一小段带着垂下小舌片的横条，标明每一面安茹旗都只是旁支，从来不是本家王冠。这点差异虽小，却值得留意；不过这没能挡住这个家族继续开枝散叶：两代人之后，查理的后人又通过一场联姻拿到了匈牙利王位的继承权——他的曾孙查理·罗伯特正是这样，才成了在匈牙利让瓦茨拉夫的儿子吃尽苦头的那个对手。记住这面旗子。这类法国旁支家族向来擅长拿到的是王位，不是虚衔——而这一支接下来还要真真切切统治匈牙利好几十年。",
    },
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Capetian_House_of_Anjou",
  },
  {
    slug: "papal-supremacy-1303",
    era: "rise-of-a-kingdom",
    startYear: 1303.8,
    cardType: "background",
    year: {
    ...
    tone: "humorous",
    title: {
      en: "Does the Pope Outrank the King?",
      cz: "Stojí papež nad králem?",
      zh: "教皇的权威，真的高过国王吗？",
    },
    hookLine: {
      en: "To a modern reader, a king rules his own country and a pope just handles church matters. Medieval Europe didn't see it that way at all.",
      cz: "Pro moderního čtenáře vládne král své vlastní zemi a papež se stará jen o církevní záležitosti. Středověká Evropa to viděla úplně jinak.",
      zh: "对现代读者来说，国王管国家，教皇管宗教，两不相干。中世纪欧洲可完全不是这么想的。",
    },
    summary: {
      en: "To a modern reader, the split looks obvious: a king runs his own kingdom, and a pope handles religious matters, full stop. Medieval Europe operated on a genuinely different premise. The Church taught that spiritual authority outranked worldly authority, and the Pope held the spiritual sword. A king's crown was legitimate only because the Church said so — which meant, in the hands of an ambitious pope, that the Church could also say it wasn't.\n\nThat idea has real theological roots — Pope Gelasius I sketched out a version of it back in the 5th century — but it turned genuinely dangerous in the 1070s, under Pope Gregory VII. Gregory claimed, in writing, that a pope could depose an emperor. In 1076 he made good on it, excommunicating King Henry IV and stripping him of the right to rule. Henry's answer was to grovel: in January 1077, barefoot and dressed in sackcloth, he stood for three days in the snow outside Gregory's castle at Canossa, begging forgiveness, before Gregory finally let him back into the Church. No army had beaten Henry. A decree had.\n\nThis isn't a foreign story to this timeline, either — Bohemia had a hand in it. When Henry and Gregory fell out again a few years later, Henry marched on Rome to physically drive the Pope out, and Duke Vratislaus II of Bohemia rode with him: Bohemian troops entered Rome itself in 1083, on the emperor's side, against the Pope's own capital.\n\nBoniface VIII, the same pope leaning on Wenceslas over Poland and Hungary, took this idea about as far as it would ever go. His 1302 bull Unam Sanctam put it in writing about as bluntly as a pope ever has:\n\n[[quote:0]]\n\nThat's not a metaphor. That's the actual claim: every king, emperor, and peasant alike, subject to Rome, no exceptions.\n\nIt didn't hold. Within a year, Philip IV's own men had Boniface seized at Anagni, and he was dead within weeks of it. Within six years of that same absolute bull, his successors had relocated the entire papacy to Avignon, inside France's own back yard, where it would stay under heavy French influence for the next seventy years. The doctrine had just claimed its widest reach ever — and the institution behind it was about to spend most of the next century humbled instead of humbling anyone else. Worth remembering the shape of this fight, on both sides: Bohemia itself is only a few generations away from becoming the site of Europe's own next great religious rupture.",
      cz: "Pro moderního čtenáře je to rozdělení jasné: král vládne své zemi a papež se stará o náboženské záležitosti, a tím to končí. Středověká Evropa fungovala na skutečně jiném předpokladu. Církev učila, že duchovní moc stojí nad světskou, a papež držel ten duchovní meč. Královská koruna byla legitimní jen proto, že to řekla církev — což znamenalo, že v rukou ambiciózního papeže mohla církev stejně snadno prohlásit, že legitimní není.\n\nTa myšlenka má skutečné teologické kořeny — náčrt podobné teorie nabídl už v 5. století papež Gelasius I. — ale skutečně nebezpečnou se stala v 70. letech 11. století, za papeže Řehoře VII. Řehoř písemně prohlásil, že papež smí sesadit císaře. V roce 1076 to dokázal v praxi: vyobcoval krále Jindřicha IV. z církve a odebral mu právo vládnout. Jindřichova odpověď byla ponížení: v lednu 1077 stál tři dny bosý, v žíněné košili, ve sněhu před Řehořovým hradem v Canosse a prosil o odpuštění, než ho Řehoř konečně přijal zpátky do církve. Jindřicha neporazilo žádné vojsko. Porazil ho výnos.\n\nAni tahle časová osa k tomu není úplně mimo — Čechy v tom měly svůj podíl. Když se Jindřich a Řehoř o pár let později znovu rozešli, Jindřich vytáhl na Řím, aby papeže vypudil silou, a český kníže Vratislav II. jel s ním: české oddíly vstoupily v roce 1083 přímo do Říma, na straně císaře, proti samotnému papežskému hlavnímu městu.\n\nBonifác VIII., tentýž papež, který na Václava tlačil ohledně Polska a Uher, dovedl tuhle myšlenku tak daleko, jak jen mohla dojít. Jeho bula Unam Sanctam z roku 1302 to vyjádřila tak přímo, jak jen to nějaký papež kdy dokázal:\n\n[[quote:0]]\n\nNení to metafora. Je to skutečný nárok: každý král, císař i sedlák, podřízený Římu, bez výjimky.\n\nNevydrželo to. Do roka Filipovi IV. lidé zajali Bonifáce v Anagni, a ten byl během týdnů mrtvý. Do šesti let od téže absolutní buly se jeho nástupci přestěhovali s celým papežstvím do Avignonu, přímo na francouzském dvorku, kde zůstane pod silným francouzským vlivem dalších sedmdesát let. Doktrína si právě nárokovala svůj nejširší dosah v historii — a instituce za ní se chystala strávit většinu příštího století spíš pokořená, než aby pokořovala někoho jiného. Stojí za to si tenhle spor, z obou stran, pamatovat: samy Čechy jsou jen pár generací od toho, stát se dějištěm dalšího velkého evropského náboženského zlomu.",
      zh: "在现代读者眼里，这种分工很清楚：国王管自己的国家，教皇管宗教事务，仅此而已。中世纪欧洲的想法完全不同。教会教导说，精神权威高于世俗权威，而教皇握着那把“精神之剑”。国王的王位之所以合法，是因为教会说它合法。反过来，一个有野心的教皇，也就能说它不合法。\n\n这个想法有真实的神学根源。早在5世纪，教皇格拉西乌斯一世就提出过类似说法。但真正变得危险，是在11世纪70年代，教皇格里高利七世手里。格里高利公开宣称，教皇有权废黜皇帝。1076年，他真的这么做了：把亨利四世逐出教会，剥夺他统治的权力。亨利的回应是低头认错。1077年1月，他光着脚、穿着粗布衣，在卡诺莎城堡外的雪地里站了三天，请求宽恕，格里高利这才让他重新回到教会。打败亨利的，不是任何一支军队，是一份诏令。\n\n这条时间线跟这场斗争其实也有点关系——波希米亚也参与过。几年后，亨利和格里高利再次决裂，亨利亲自率军进逼罗马，要武力驱逐教皇。波希米亚公爵弗拉季斯拉夫二世也跟着一起去了。1083年，波希米亚军队随皇帝一同攻入罗马城，站在皇帝这边，对抗教皇自己的都城。\n\n卜尼法斯八世——正是那位向瓦茨拉夫施压、要他放弃波兰和匈牙利的教皇——把这个想法推到了极致。1302年，他颁布教皇诏书《一圣教谕》，把这个主张写得再直白不过：\n\n[[quote:0]]\n\n这不是什么比喻。这是一条实实在在的主张：每一位国王、皇帝、平民，都要臣服于罗马，没有例外。\n\n但这没能撑住。不到一年，腓力四世的人就在阿纳尼把卜尼法斯抓了起来，几周后他就去世了。同一份“绝对权威”的诏书颁布还不到六年，他的继任者们就把整个教廷搬去了阿维尼翁——就在法国自家后院，此后七十年一直笼罩在法国的强势影响之下。这套教义刚刚宣称了它史上最大的权威范围，而支撑它的这个机构，接下来大半个世纪却要被别人压着，而不是压着别人。这场争斗的两面都值得记住——因为波希米亚自己，再过几代人，就要成为欧洲下一场大型宗教裂痕的发生地。",
    },
    quotes: [
      {
        text: {
          en: "Furthermore, we declare, we proclaim, we define that it is absolutely necessary for salvation that every human creature be subject to the Roman Pontiff.",
          cz: "Dále prohlašujeme, oznamujeme a stanovujeme, že je pro spásu naprosto nezbytné, aby se každý lidský tvor podřídil římskému papeži.",
          zh: "此外，我们宣告、宣布、并确定：对每一个人而言，臣服于罗马教皇，都是获得救赎所绝对必需的。",
        },
        attribution: {
          en: "Pope Boniface VIII, Unam Sanctam (1302)",
          cz: "Papež Bonifác VIII., bula Unam Sanctam (1302)",
          zh: "教皇卜尼法斯八世，《一圣教谕》诏书（1302年）",
        },
      },
    ],
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Unam_sanctam",
  },
  {
    slug: "too-soon-1305",
    era: "rise-of-a-kingdom",
    ...
    hookLine: {
      en: "He held off an emperor, a pope, and two rival kings all at once. What finally beat him was a cough nobody took seriously in time.",
      cz: "Ubránil se najednou císaři, papeži i dvěma soupeřícím králům. Co ho v konci porazilo, byl kašel, který nikdo včas nevzal vážně.",
      zh: "他同时挡住了皇帝、教皇和两位争位的国王。真正打倒他的，是一场谁都没当回事的咳嗽。",
    },
    summary: {
      en: "Wenceslas marched into Hungary that June and, for a little while, it looked like it might actually work. He took Esztergom — the seat of Hungary's own church, a real, symbolic prize — and for a moment had something to show for the trip. Then he saw the rest of the country for himself: a kingdom fractured into a dozen fiefdoms, a son with no functioning base of support left to speak of, oligarchs who answered to nobody but their own interests. Esztergom wasn't a foothold. It was the best this campaign was ever going to get.\n\nIn August 1304, Wenceslas pulled his son out of Hungary for good, leaving Ivan Kőszegi behind as 'governor' of a throne Bohemia had just abandoned — one last tidy irony, handing the keys to the very oligarch who'd never actually let the boy hold them in the first place. The one thing that did leave Hungary with them was the Holy Crown itself, carried back to Prague, which meant that even after Bohemia gave up its own claim, Charles Robert still couldn't complete a fully legitimate coronation of his own for years to come.\n\nThe cough that had been following Wenceslas since before he'd even left for Hungary never went away. It only got worse. Nobody at the time wrote down exactly when it turned from an inconvenience into a diagnosis — medieval court records aren't built for that kind of precision — but by the spring of 1305, whatever it was had stopped being something a king could simply push through.\n\nWenceslas II died in Prague on 21 June 1305, probably of tuberculosis, at thirty-three. He'd spent barely a decade and a half on the throne holding off — simultaneously, more than once — an emperor, a pope, two rival kings, and his own kingdom's fractured nobility, and had somehow still found time to reform the currency, found a monastery, and wear three crowns at once, however briefly. The Zbraslav Chronicle, written by the monks of that same monastery, recorded the scale of the grief that followed in a single, striking image:\n\n[[quote:0]]\n\nA kingdom that had cried itself out of tears.\n\nHe was buried at Zbraslav, in the monastery he himself had founded thirteen years earlier as a new royal resting place, on the site of his own father's old hunting lodge — his wish granted far sooner than he could have wanted. His son inherited Bohemia and Poland at fifteen, already crowned King of Hungary in name if nothing else. What that inheritance actually looked like, and how long it lasted, is its own story.",
      cz: "Václav vytáhl toho června do Uher, a chvíli to vypadalo, že by to skutečně mohlo vyjít. Dobyl Ostřihom — sídlo uherské církve, skutečnou a symbolickou kořist — a na okamžik měl z celé cesty co ukázat. Pak uviděl na vlastní oči zbytek země: království rozdrobené na tucet lenních území, syna bez jakékoli fungující podpory, oligarchy, kteří neodpovídali nikomu než svým vlastním zájmům. Ostřihom nebyl opěrný bod. Byl to strop toho, co tohle tažení vůbec mohlo dát.\n\nV srpnu 1304 Václav svého syna z Uher definitivně stáhl a jako 'guvernéra' trůnu, který Čechy právě opustily, tam nechal Ivana Kőszegiho — poslední úhledná ironie, předání klíčů přesně tomu oligarchovi, který chlapci od začátku nikdy nedovolil je skutečně držet. Jediné, co s sebou z Uher přece jen odvezli, byla samotná svatoštěpánská koruna, odvezená zpátky do Prahy — což znamenalo, že ani poté, co se Čechy svého nároku vzdaly, se Karel Robert ještě řadu let nemohl dočkat vlastní plně legitimní korunovace.\n\nKašel, který se Václava držel ještě předtím, než vůbec odjel do Uher, nikdy nezmizel. Jen se zhoršoval. Nikdo si tehdy nezapsal přesně, kdy se z nepříjemnosti proměnil v diagnózu — dvorské záznamy na takovou přesnost nejsou stavěné — ale do jara 1305 už to, ať to bylo cokoli, přestalo být něčím, co by král mohl jen tak překonat.\n\nVáclav II. zemřel v Praze 21. června 1305, pravděpodobně na tuberkulózu, ve třiatřiceti letech. Na trůnu strávil necelých patnáct let, po celou tu dobu čelil — víc než jednou zároveň — císaři, papeži, dvěma soupeřícím králům i vlastní rozeštěné šlechtě, a přesto si ještě stihl najít čas na měnovou reformu, založení kláštera a — byť jen krátce — na to, nosit naráz tři koruny. Zbraslavská kronika, sepsaná mnichy téhož kláštera, zachytila rozsah smutku, který následoval, v jediném pádném obraze:\n\n[[quote:0]]\n\nKrálovství, které si vyplakalo všechny slzy.\n\nByl pohřben ve Zbraslavi, v klášteře, který sám před třinácti lety založil jako nové královské pohřebiště, na místě starého loveckého hrádku svého otce — jeho přání se splnilo mnohem dřív, než by si kdy přál. Jeho syn zdědil Čechy a Polsko v patnácti letech, už teď formálně korunovaný uherský král, i když jinak nic víc. Jak to dědictví ve skutečnosti vypadalo a jak dlouho vydrželo, je už jiný příběh.",
      zh: "瓦茨拉夫那年六月出兵匈牙利，一开始看着还真有点希望。他拿下了埃斯泰尔戈姆——匈牙利教会的所在地，一份真正拿得出手的战果。这一趟总算没有白跑。可等他亲眼看清了这个国家其余的样子——四分五裂成十几块，儿子几乎没有任何真正的支持力量，各地寡头只听自己的——他才明白，埃斯泰尔戈姆已经是这场远征能拿到的全部了。\n\n1304年8月，瓦茨拉夫彻底把儿子从匈牙利撤了回来。他把这个波希米亚刚刚放弃的王位，留给伊万·克塞吉去当“摄政”。这是最后一记讽刺：钥匙交到的，正是那个从头到尾都没让男孩真正握过权柄的寡头手里。他们从匈牙利带走的唯一东西，是那顶圣冠本身，一路运回了布拉格。这意味着，哪怕波希米亚放弃了自己的主张，查理·罗伯特还要再等好几年，才能真正名正言顺地加冕。\n\n那阵在他出发去匈牙利之前就缠上他的咳嗽，一直没好，只是越来越重。当时没人记下它究竟是什么时候从一个小毛病变成了一个病症——宫廷记录本来就不擅长记这种细节。但到1305年春天，不管那是什么病，已经不再是一个国王能硬撑过去的东西了。\n\n1305年6月21日，瓦茨拉夫二世在布拉格去世，很可能死于肺结核，年仅三十三岁。他在位不到十五年，这些年里不止一次同时对抗过皇帝、教皇、两位争位的国王，还有自己国内四分五裂的贵族——却还是抽出空来完成了货币改革、建了一座修道院，甚至一度同时戴上过三顶王冠，哪怕只是短暂的一段时间。《兹布拉斯拉夫编年史》的作者，正是那座修道院里的修士，用一个格外有力的画面，记下了当时举国哀恸的场面：\n\n[[quote:0]]\n\n一个哭到再也流不出眼泪的国家。\n\n他被葬在兹布拉斯拉夫——十三年前，他亲手建起的那座修道院，就在自己父亲那处旧猎苑的原址上，本意是要给波希米亚历代国王一个新的安息之地。这个愿望兑现得比他自己想要的要早得多。他的儿子在十五岁那年，继承了波希米亚和波兰，名义上还是匈牙利的加冕国王，仅此而已。这份继承到底是什么样子，又能撑多久，那是另一个故事了。",
    },
    quotes: [
      {
        text: {
          en: "From the long weeping with which everyone wept, the streams of tears in their eyes had already completely dried up, and so, without weeping or shedding tears, they raised together their sorrowful lament to the heavens…",
          cz: "Pro dlouhý pláč, kterým všichni plakali, již úplně vyschly proudy slz v očích, a proto už bez pláče a prolévání slz spolu vznášeli smutný nářek k nebesům…",
          zh: "众人哭得太久太狠，眼中的泪水早已彻底流干，于是他们不再哭泣、不再流泪，却一同将悲哀的哭喊，遥遥呈向天际……",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        slug: "zbraslavsky-zamek",
        relation: {
          en: "Wenceslas II's actual burial site, 1305 — the royal necropolis he founded here in 1292, put to its intended use far sooner than he could have wanted.",
          cz: "Skutečné místo posledního odpočinku Václava II. z roku 1305 — královské pohřebiště, které tu sám založil v roce 1292, naplnilo svůj účel mnohem dřív, než by si kdy přál.",
          zh: "瓦茨拉夫二世1305年的真正安葬地——他1292年亲手在这里建立的王室墓地，比他自己想要的时间早得多，就派上了用场。",
        },
      },
      {
        slug: "plzen",
        relation: {
          en: "No statue of Wenceslas II survives anywhere — the closest thing to one is this whole city. He founded it in 1295, and it outlived every crown he ever wore.",
          cz: "Nikde se nedochovala žádná socha Václava II. — nejbližší věc, kterou po sobě zanechal, je celé tohle město. Založil ho v roce 1295, a přežilo úplně každou korunu, kterou kdy nosil.",
          zh: "瓦茨拉夫二世没有留下任何一座雕像——最接近雕像的东西，就是这整座城市。他1295年建立了它，而它，比他戴过的每一顶王冠都活得更久。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Wenceslaus_II_of_Bohemia",
  ...
  {
    slug: "the-ambitious-new-king-1306",
    era: "rise-of-a-kingdom",
    startYear: 1305.5,
    year: {
      en: "1305–1306",
    ...
    title: {
      ...
      cz: "Ctižádostivý nový král",
      zh: "野心勃勃的新国王",
    },
    hookLine: {
      en: "At sixteen, Wenceslas III believed his dynasty's best days were still ahead of it. He wasn't wrong about the ambition. He was wrong about almost everything else.",
      cz: "V šestnácti letech věřil Václav III., že nejlepší časy jeho dynastie teprve přijdou. V ambicích se nemýlil. Skoro ve všem ostatním ano.",
      zh: "十六岁的瓦茨拉夫三世相信，自己这个王朝最好的日子还在后头。野心这点，他没说错。剩下的几乎一切，他都想错了。",
    },
    summary: {
      en: "Wenceslas III became king at fifteen, his father's only son, and grief didn't slow him down — if anything, it sharpened him. He wasn't interested in simply holding what his father had left behind; he wanted to finish what Wenceslas II had started, and do it better. The most urgent piece of that inheritance was Hungary, a crown his father had spent years fighting for and, in the end, couldn't hold. Wenceslas made the call his father had already all but made for him: on 9 October 1305, at Brno, he formally handed the Holy Crown of Hungary to Otto III, Duke of Bavaria, another Árpád-descended claimant with a far cleaner path to the throne than his own. It wasn't a retreat. It was a trade — cutting loose a crown that had never been more than a name on paper, to put everything he had into the one that actually mattered.\n\nIn the same weeks, he broke off his own childhood engagement to Elizabeth of Töss, Andrew III's own daughter, and married Viola of Teschen instead, on the advice of Bohemia's own lords. It was a domestic match, not a foreign one — nothing like the ambitious dynastic marriages his father and grandfather had always reached for. That wasn't a step down. Consolidating at home was exactly the point.\n\nAt sixteen, still months short of his seventeenth birthday, Wenceslas's own ambitions weren't any smaller than theirs. His grandfather Otakar II had once ruled from the Sudetes to the Adriatic. His father had worn three crowns at once, however briefly. Wenceslas meant to keep building on that inheritance, not just guard it — and Poland was where he intended to prove it, securing for good the crown his father had spent a decade fighting to hold onto.\n\nThe plans that followed were serious ones, not a boy playing at kingship. He dismissed the young favorites he'd surrounded himself with in his first year on the throne and put his own brother-in-law, Henry of Carinthia — freshly married to his sister Anna that same year — in charge of Bohemia and Moravia while he campaigned. The appointment came with the kind of clause every regency needed on paper, routine enough that nobody would have thought twice about it: if the king did not return, Henry could claim the throne himself.\n\nBuilding the alliance needed to secure Poland meant paying for it. Władysław Łokietek — our old acquaintance, the man Wenceslas II had out-maneuvered for Kraków back in 1291 and driven out of the country entirely in 1300 — had spent the past year clawing his way back in with papal backing, chipping away at Bohemian-held ground duchy by duchy. An August 1305 attempt to trade Meissen to the Brandenburg margraves for their support over Pomerelia never got finalized, so in July 1306 Wenceslas simply handed Waldemar and Herman of Brandenburg the disputed territory of Gdańsk and Pomerania outright, as fiefs, in exchange for their soldiers.\n\nBy early August, the army was ready. The road to Poland ran first through Moravia — and through the town of Olomouc, where the king stopped to rest before the final push north.",
      cz: "Václav III. se stal králem v patnácti letech, jediný syn svého otce, a zármutek ho nezpomalil — spíš ho zocelil. Nezajímalo ho jen udržet to, co po sobě otec zanechal; chtěl dokončit, co Václav II. začal, a udělat to líp. Nejnaléhavější částí toho dědictví byly Uhry, koruna, o kterou se jeho otec léta bil a nakonec ji neudržel. Václav udělal rozhodnutí, které za něj jeho otec už skoro učinil sám: 9. října 1305, v Brně, formálně předal uherskou svatoštěpánskou korunu Otovi III., vévodovi bavorskému, dalšímu uchazeči z arpádovské linie s mnohem čistší cestou k trůnu, než měl on sám. Nebyl to ústup. Byla to výměna — zbavit se koruny, která nikdy nebyla víc než jméno na papíře, a vsadit všechno na tu, na které skutečně záleželo.\n\nVe stejných týdnech zrušil vlastní dětské zasnoubení s Alžbětou Töss, dcerou Ondřeje III., a místo ní se oženil s Violou Těšínskou, na radu samotných českých pánů. Byl to domácí sňatek, ne zahraniční — nic jako ty ambiciózní dynastické sňatky, po kterých vždycky sahal jeho otec i děd. Nebyl to krok zpátky. Upevnit poměry doma bylo přesně to, o co šlo.\n\nV šestnácti letech, ještě pár měsíců před sedmnáctými narozeninami, nebyly Václavovy vlastní ambice o nic menší než jejich. Jeho děd Otakar II. kdysi vládl od Sudet až k Jadranu. Jeho otec nosil, byť jen krátce, naráz tři koruny. Václav hodlal na tomhle dědictví dál stavět, ne ho jen hlídat — a Polsko bylo místo, kde to chtěl dokázat, tím, že napevno zajistí korunu, o kterou se jeho otec bil celou dekádu.\n\nPlány, které následovaly, byly vážné, ne chlapecké hraní si na krále. Propustil mladé oblíbence, kterými se za první rok na trůně obklopil, a řízením Čech a Moravy během svého tažení pověřil vlastního švagra, Jindřicha Korutanského — téhož roku čerstvě ženatého s jeho sestrou Annou. K jmenování patřila i doložka, jakou potřebovala na papíře každá regentská správa, natolik rutinní, že by si jí nikdo dvakrát nevšiml: kdyby se král z tažení nevrátil, mohl si Jindřich nárokovat trůn sám.\n\nZajistit spojenectví potřebné k udržení Polska stálo peníze. Vladislav Lokýtek — stará známost, muž, kterého Václav II. v roce 1291 přechytračil kvůli Krakovu a v roce 1300 úplně vyhnal ze země — se poslední rok drápal zpátky s papežskou podporou a knížectví po knížectví ukusoval z území, které Čechy dosud držely. Pokus z srpna 1305 vyměnit Míšeňsko za podporu braniborských markrabat ohledně Pomořanska se nikdy nedotáhl do konce, a tak v červenci 1306 Václav prostě rovnou předal Valdemarovi a Heřmanovi Braniborským sporné území Gdaňska a Pomořanska jako léno, výměnou za jejich vojáky.\n\nZačátkem srpna bylo vojsko připraveno. Cesta do Polska vedla nejdřív přes Moravu — a přes město Olomouc, kde se král zastavil odpočinout, než vyrazí na poslední úsek na sever.",
      zh: "瓦茨拉夫三世十五岁登基，是父亲唯一的儿子。悲痛没有让他慢下来——反而让他更坚定了。他不满足于只是守住父亲留下的家业，他想接着把父亲没做完的事做完，而且要做得更好。这份遗产里最紧迫的一块，是匈牙利——一顶父亲拼了好几年、最终还是没能守住的王冠。瓦茨拉夫做了一个父亲其实早已替他做好的决定：1305年10月9日，在布尔诺，他正式把匈牙利圣冠交给了巴伐利亚公爵奥托三世——另一位有阿尔帕德血统、但通往王位的路比他自己干净得多的候选人。这不是撤退。这是一笔交易：舍弃一顶从来都只是纸面上好看的王冠，把全部心力押在真正要紧的那一顶上。\n\n同一段时间里，他解除了自己童年时定下的婚约——对象是安德烈三世的女儿伊丽莎白——转而在波希米亚贵族们的建议下，娶了特申的维奥拉。这是一桩国内联姻，不是对外联姻，跟他父亲和祖父一贯偏爱的那种野心勃勃的王朝联姻完全不是一回事。这不是退步。稳住国内，本来就是重点。\n\n十六岁，离十七岁生日还差几个月，瓦茨拉夫自己的野心，一点也不比他们小。他的祖父奥托卡二世，当年疆域一路从苏台德延伸到亚得里亚海。他的父亲，哪怕只是短暂的一段时间，也曾同时戴过三顶王冠。瓦茨拉夫打算在这份家业的基础上继续往上垒，而不只是守着它——波兰，就是他打算证明这一点的地方：把父亲拼了整整十年才勉强保住的那顶王冠，这次真正坐稳。\n\n接下来的部署是认真的，不是一个孩子在玩过家家。他辞退了自己登基第一年身边那批年轻宠臣，把波希米亚和摩拉维亚的治理，交给了自己的妹夫——克恩滕的亨利，同一年刚娶了他妹妹安娜。这项任命附带了一条条款，是任何摄政安排在纸面上都少不了的那种，寻常到没人会多想一句：如果国王没能从这次远征回来，亨利可以自己主张继承王位。\n\n要凑齐拿下波兰所需的联盟，是要花钱的。瓦迪斯瓦夫·洛基泰克——我们的老熟人，1291年被瓦茨拉夫二世在克拉科夫的争夺中略胜一筹、1300年又被彻底赶出这个国家的那位——过去一年靠着教皇撑腰一点点杀了回来，一个公国接一个公国地啃食波希米亚原本控制的地盘。1305年8月，一次拿迈森换勃兰登堡藩侯支持波美拉尼亚的交易没能谈成，于是1306年7月，瓦茨拉夫索性直接把有争议的但泽和波美拉尼亚，作为封地整块交给了勃兰登堡的瓦尔德马和赫尔曼，换来他们的军队。\n\n8月初，军队集结完毕。通往波兰的路，先要穿过摩拉维亚——途经奥洛穆茨这座城，国王在那里停下休整，准备发起最后一段向北的行军。",
    },
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Wenceslaus_III_of_Bohemia",
  },
  {
    slug: "four-centuries-ended-1306",
    era: "rise-of-a-kingdom",
    startYear: 1306.1,
    year: {
      en: "4 August 1306",
    ...
    title: {
      ...
      cz: "Čtyři století, zmařená za jedno odpoledne",
      zh: "四百余年王朝的猝逝",
    },
    hookLine: {
      en: "Three knife wounds. One afternoon in Olomouc. Four hundred and thirty-six years of unbroken succession, over before anyone even agreed on who was responsible.",
      cz: "Tři bodné rány. Jedno odpoledne v Olomouci. Čtyři sta třicet šest let nepřerušeného nástupnictví, u konce dřív, než se kdokoli shodl na tom, kdo za to mohl.",
      zh: "三刀。奥洛穆茨的一个下午。四百三十六年不曾中断的王统，就此终结——而凶手是谁，至今没人说得清。",
    },
    summary: {
      en: "On the afternoon of 4 August 1306, Wenceslas III was alone in the palace at Olomouc, seeking relief from the summer heat, dressed in nothing more than a shirt and cloak — resting, unguarded, suspecting no plot at all. A knife found him three times. He was not yet seventeen. The army he'd spent the summer assembling — Bohemian levies, Brandenburg allies, everything built to put Władysław Łokietek back in his place — never left Moravia. It simply had no king left to lead it.\n\nThe Zbraslav Chronicle, writing within living memory of the event, described what happened in terms that still carry the shock nearly seven centuries later:\n\n[[quote:0]]\n\nThe knight seen fleeing, Konrad of Botenstein, a Thuringian, never got the chance to explain himself — bystanders caught him and killed him on the spot as the king's murderer, before he could speak a single word. Whether he was truly the killer, or simply the man closest to hand when a crowd needed someone to blame, is exactly the question the chronicle itself admits it can't answer. That uncertainty has never gone away.\n\nHistorians have spent the centuries since arguing over who might have stood behind him, if anyone did. Some point to Albert of Habsburg — this timeline's own old acquaintance, and the man with the clearest political motive of anyone alive that August. Others suspect Władysław Łokietek himself, the exact rival this whole campaign had been raised to crush. Still others blame Bohemia's own nobility, worried about what a king this determined might eventually do to men who'd crossed him. And a few point somewhere closer to home entirely: one of the young favorites Wenceslas had just dismissed from his household, weeks before he ever reached Olomouc.\n\nWhichever version is true, the result wasn't in dispute. The Přemyslid dynasty had ruled Bohemia in an unbroken male line since Bořivoj I, back around 870 — the same duke this whole timeline started with. Four hundred and thirty-six years of succession, kings following fathers and grandfathers in a chain nobody had ever seriously expected to break, ended in one house, on one afternoon, with three wounds nobody could fully explain.\n\nThe regency appointment Wenceslas had made before he ever left Prague — the one nobody had thought twice about at the time — mattered again almost immediately. Henry of Carinthia moved to claim the throne it had promised him. He would not be the only one asking. What came next is its own story.",
      cz: "Odpoledne 4. srpna 1306 byl Václav III. sám na paláci v Olomouci, hledal úlevu od letního horka, oblečený jen v košili a plášti — odpočíval, bez stráže, aniž by tušil jakoukoli úklady. Nůž ho zasáhl třikrát. Ještě mu nebylo sedmnáct. Vojsko, které celé léto shromažďoval — česká hotovost, braniborští spojenci, všechno postavené na to, aby Vladislava Lokýtka konečně srazilo zpátky na kolena — z Moravy nikdy nevytáhlo. Prostě už nemělo koho vést.\n\nZbraslavská kronika, psaná ještě v živé paměti té události, popsala, co se stalo, slovy, která nesou svůj šok ještě skoro sedm století poté:\n\n[[quote:0]]\n\nRytíř spatřený při útěku, Konrád z Botenštejna, rodem Durynk, se nikdy nedostal k tomu, aby se vysvětlil — kolemstojící ho na místě chytili a zabili jako králova vraha, dřív než mohl promluvit jediné slovo. Zda byl skutečným vrahem, nebo jen mužem, který se náhodou ocitl nejblíž, když dav potřeboval na koho ukázat, je přesně ta otázka, na kterou si i sama kronika přiznává, že neumí odpovědět. Ta nejistota nikdy nezmizela.\n\nHistorikové se od té doby po staletí přou o to, kdo za ním případně mohl stát. Někteří ukazují na Albrechta Habsburského — starou známost téhle časové osy, a muže s nejjasnějším politickým motivem ze všech, kdo byli toho srpna naživu. Jiní podezírají přímo Vladislava Lokýtka, přesně toho soupeře, kvůli kterému bylo celé tohle tažení svoláno. Další viní samotnou českou šlechtu, znepokojenou tím, co by tak odhodlaný král mohl jednou udělat mužům, kteří mu zkřížili plány. A někteří ukazují ještě blíž domů: na jednoho z mladých oblíbenců, které Václav ze svého dvora propustil jen pár týdnů předtím, než vůbec dorazil do Olomouce.\n\nAť je pravdivá kterákoli verze, na výsledku se nic neměnilo. Přemyslovská dynastie vládla Čechám v nepřerušené mužské linii od Bořivoje I., zhruba od roku 870 — od téhož knížete, kterým celá tahle časová osa kdysi začala. Čtyři sta třicet šest let nástupnictví, králů následujících otce a dědy v řetězu, o kterém nikdo vážně nečekal, že se kdy přetrhne, skončilo v jednom domě, jedno odpoledne, třemi ranami, které nikdo nedokázal úplně vysvětlit.\n\nRegentské jmenování, které Václav učinil, ještě než vůbec opustil Prahu — to, kterému tehdy nikdo nevěnoval druhou myšlenku — najednou znovu záleželo, a to skoro okamžitě. Jindřich Korutanský se přihlásil o trůn, který mu slibovalo. Nebyl by jediný, kdo se o něj přihlásí. Co přišlo dál, je už jiný příběh.",
      zh: "1306年8月4日下午，瓦茨拉夫三世独自一人待在奥洛穆茨的王宫里，想图个清凉躲避夏日的暑气，身上只穿着一件衬衣和斗篷——正在休息，没有护卫，也丝毫没有察觉任何阴谋。一把刀刺中了他三次。他还不到十七岁。他花了整个夏天集结起来的那支军队——波希米亚征召兵、勃兰登堡盟军，一切都是为了把瓦迪斯瓦夫·洛基泰克彻底压服——最终没能离开摩拉维亚一步。这支军队，已经没有国王可以带领它了。\n\n《兹布拉斯拉夫编年史》几乎是在事件发生的同一时代写成的，记下的这段文字，即便过了将近七个世纪，读来依然带着当时的震惊：\n\n[[quote:0]]\n\n那个被人看见逃跑的骑士——波滕施泰因的康拉德，图林根人——始终没能为自己辩解一句：外面的人当场抓住他，把他当作弑君凶手打死，他甚至没来得及说出一个字。他到底是不是真凶，还是只是恰好离得最近、被人群当成靶子的倒霉蛋——这正是连编年史自己都承认答不上来的问题。这份不确定，从来没有消失过。\n\n此后几个世纪，历史学家们一直在争论，康拉德背后到底有没有人指使，如果有，又是谁。一些人把矛头指向哈布斯堡的阿尔布雷希特——这条时间线的老熟人，那个8月里在世的人当中，政治动机最明显的一个。另一些人怀疑瓦迪斯瓦夫·洛基泰克本人——正是这整场远征本来要压服的那个对手。还有人把矛头指向波希米亚本国的贵族，担心一位如此有决断力的国王，将来会怎么对付那些曾经跟他作对的人。也有人的怀疑对象离得更近——瓦茨拉夫抵达奥洛穆茨之前几周，才刚刚从他自己家里辞退的那批年轻宠臣里的一个。\n\n不管哪种说法是真的，结果没有争议。普热米斯尔王朝自博日沃伊一世起——大约870年，就是这整条时间线当初开篇的那位公爵——男系一脉不曾中断地统治了波希米亚。四百三十六年的王统传承，一代代国王接着父亲和祖父的班，一条谁都没真正设想过会断掉的链条，就在一座宅邸里，一个下午，三处谁也说不清全部缘由的伤口，戛然而止。\n\n瓦茨拉夫离开布拉格之前定下的那项摄政任命——当时谁都没多想一句的那项——几乎立刻又重新变得举足轻重。克恩滕的亨利，出面主张那顶本来许给他的王位。他不会是唯一一个提出主张的人。接下来发生的事，是另一个故事了。",
    },
    quotes: [
      {
        text: {
          en: "For in the summer season, to cool himself, he was alone in the palace, dressed only in a shirt and cloak. Someone — who must not be regarded as a human being at all, but rather as a companion of Satan, the author of crime, an enemy against nature, the dregs and stench of all wickedness — approached the young man, who suspected no plot whatsoever, and, seizing the fitting opportunity, wounded him with three mortal blows and fled. We are all amazed, however, that to this very day it is still not known who was certainly the perpetrator of such immeasurable infamy. A certain knight, however, was seen, called Konrad of Botenstein, Thuringian by birth, leaping from the palace, holding a bloodied knife in his hand, and fleeing; and those who were outside caught him and killed him as the king's murderer, before he could speak a single word. Whether he or another was guilty, I do not know — God knows — but this I do know, and it is known to the whole world, that the destruction of that young king brought about the growth of countless hardships.",
          cz: "Když totiž byl v letní době pro ochlazení pouze sám na paláci, oděn jen v košili a plášť. Kdosi, kdo naprosto nesmí být pokládán za člověka, nýbrž spíše za společníka satanova, původce zločinu, nepřítel proti přírodě, sedlina a puch vší špatnosti, přistoupil k mladíkovi, který nikterak netušil úklady, a maje vhodnou příležitost, zranil ho třemi smrtelnými ranami a utekl. Divíme se však všichni, že se dosud až dodnes neví, kdo byl najisto pachatelem tak nezměrné hanebnosti. Byl však spatřen jakýsi rytíř, řečený Konrád z Botenštejna, rodem Durynk, jak vyskočil z paláce, drže v ruce zkrvavený nůž, a utíkal; a ti, kteří byli venku, ho chytili a jako vraha králova zabili, dříve než mohl promluvit nějaké slova. Zda byl on nebo jiný vinen, nevím, ví to Bůh, to však vím a je to známo celému světu, že záhuba onoho mladého krále způsobila vzrůst nesčíslných útrap.",
          zh: "那是夏日里，为了图个清凉，他独自一人待在王宫内，只穿着一件衬衣和一件斗篷。有个人——此人根本不配被称作人类，倒更像是撒旦的同党、罪恶的始作俑者、悖逆自然的仇敌、一切邪恶的渣滓与恶臭——靠近了这位丝毫没有察觉阴谋的年轻人，趁着这个可乘之机，刺了他三处致命的伤口，然后逃走了。可我们所有人都感到诧异：直到今天，都没人能确切知道，这桩滔天罪行的凶手到底是谁。不过有人看见一名骑士，人称“波滕施泰因的康拉德”，图林根人，从王宫里跳出来，手里攥着一把沾血的刀，仓皇逃跑；在外面的人抓住了他，当作弑君的凶手当场打死，他甚至没能说出一个字。他是否真有罪，还是另有其人，我不知道——上帝知道——但我知道这一点，而且这是全世界都知道的：那位年轻国王的殒命，招来了数不清的祸患。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        slug: "olomouc",
        relation: {
          en: "Where it happened — the town Wenceslas III never left. Already, by 1306, a major Moravian power center in its own right; this single afternoon is only one thread in a much longer history.",
          cz: "Kde se to stalo — město, které Václav III. už nikdy neopustil. Už v roce 1306 samo o sobě významné moravské mocenské centrum; tohle jediné odpoledne je jen jedna nitka v mnohem delší historii.",
          zh: "事发之地——瓦茨拉夫三世再也没能离开的那座城。早在1306年，它本身就已是摩拉维亚的重要权力中心；这一个下午，只是它更漫长历史里的一根线。",
        },
      },
      {
        slug: "zbraslavsky-zamek",
        relation: {
          en: "Where Wenceslas III was laid to rest beside his father — the royal necropolis Wenceslas II had founded in 1292, put to a second use just over a year after the first, though the son's own remains were later lost.",
          cz: "Kde byl Václav III. uložen k odpočinku vedle svého otce — královské pohřebiště, které Václav II. založil v roce 1292, posloužilo podruhé necelý rok a půl po první příležitosti, ačkoli synovy ostatky se později ztratily.",
          zh: "瓦茨拉夫三世与父亲一同长眠之地——瓦茨拉夫二世1292年建立的这座王室墓地，在启用刚过一年多一点后，就第二次派上了用场，尽管儿子的遗骨后来下落不明。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Wenceslaus_III_of_Bohemia",
  ...
  {
    slug: "seven-kings-then-none-1306",
    era: "rise-of-a-kingdom",
    startYear: 1306.2,
    year: {
      en: "1306",
    ...
    title: {
      ...
      cz: "Sedm králů, a pak žádný",
      zh: "七位国王，此后再无一人",
    },
    hookLine: {
      en: "This timeline has followed seven Bohemian kings, one after another, since the first crown landed on Vratislaus II's head in 1085. In August 1306, the chronicle needed only one line to close that whole count out.",
      cz: "Tahle časová osa sledovala sedm českých králů, jednoho po druhém, od chvíle, kdy v roce 1085 dopadla první koruna na hlavu Vratislava II. V srpnu 1306 kronice stačila jediná věta, aby ten celý počet uzavřela.",
      zh: "这条时间线一路追踪了七位波希米亚国王，从1085年第一顶王冠落在弗拉季斯拉夫二世头上开始，一位接一位。1306年8月，编年史只用了一句话，就把这个数字彻底封了顶。",
    },
    summary: {
      en: "The Zbraslav Chronicle didn't wait for historians to explain what Wenceslas III's death meant. It said so directly, in verse, within the same account that describes his murder:\n\n[[quote:0]]\n\nSeven kings is the exact count: Vratislaus II in 1085, Vladislaus II in 1158, then Otakar I, Wenceslas I, Otakar II, Wenceslas II, and Wenceslas III himself — every crowned king this whole timeline has actually followed, tallied up by a monk writing within the same year the last of them died.\n\nWhatever grief the kingdom felt, the scramble for the empty throne started almost immediately. Henry of Carinthia — Wenceslas III's own brother-in-law, married to his sister Anna, and the man the dead king had named regent before ever leaving for Olomouc — was elected King of Bohemia by a faction of the nobility within weeks. The appointment nobody had thought twice about a year earlier had just done exactly the job it was built for.\n\nBohemia's own throne would take years to settle. Let's turn back to Poland — the original destination of that same campaign. Within a month, Kraków's own nobles simply invited Władysław Łokietek in, and Bohemia's grip on the crown Wenceslas had died trying to defend was gone in practice, whatever title Prague kept claiming for decades afterward.",
      cz: "Zbraslavská kronika nečekala, až jí historikové vysvětlí, co smrt Václava III. znamenala. Řekla to rovnou, ve verších, ve stejném líčení, které popisuje i jeho vraždu:\n\n[[quote:0]]\n\nSedm králů je přesný počet: Vratislav II. v roce 1085, Vladislav II. v roce 1158, pak Otakar I., Václav I., Otakar II., Václav II. a sám Václav III. — úplně každý korunovaný král, kterého tahle časová osa doopravdy sledovala, sečtený mnichem, který psal v témže roce, kdy ten poslední z nich zemřel.\n\nAť už království cítilo jakýkoli zármutek, boj o prázdný trůn začal skoro okamžitě. Jindřich Korutanský — vlastní švagr Václava III., ženatý s jeho sestrou Annou, a muž, kterého mrtvý král jmenoval regentem, než vůbec odjel do Olomouce — byl během několika týdnů zvolen českým králem částí šlechty. Jmenování, kterému tehdy nikdo nevěnoval druhou myšlenku, právě odvedlo přesně tu práci, pro kterou bylo zamýšleno.\n\nČeský trůn se měl usazovat ještě roky. Vraťme se k Polsku — k původnímu cíli téhle výpravy. Do měsíce krakovská šlechta prostě sama pozvala dovnitř Vladislava Lokýtka, a český vliv na korunu, kterou se Václav vypravil bránit až za cenu vlastního života, byl v praxi u konce, ať si Praha ještě desítky let dál nárokovala jaký titul chtěla.",
      zh: "《兹布拉斯拉夫编年史》没有等着让后世历史学家来解释瓦茨拉夫三世之死意味着什么。它直接给出了答案，用的是诗句，就写在记述他遇刺经过的同一段落里：\n\n[[quote:0]]\n\n七位国王，这个数字不多不少：1085年的弗拉季斯拉夫二世、1158年的弗拉迪斯拉夫二世，然后是奥托卡一世、瓦茨拉夫一世、奥托卡二世、瓦茨拉夫二世，还有瓦茨拉夫三世本人——正是这条时间线一路真正追踪过的每一位加冕国王，被一位修士数了个遍，而他动笔的这一年，正是最后一位国王去世的那一年。\n\n不管这个王国当时有多悲痛，围绕空王位的争夺几乎立刻就开始了。克恩滕的亨利——瓦茨拉夫三世的妹夫，娶了他妹妹安娜，也正是这位已故国王在动身前往奥洛穆茨之前指定的摄政——短短几周内就被一部分贵族拥立为波希米亚国王。一年前谁都没多想一句的那项任命，此刻恰好派上了它当初被设计出来的那个用场。\n\n波希米亚自己的王位，还要再花上几年才能真正安定下来。我们说回瓦茨拉夫三世此次出征原本的目的地——波兰。不到一个月，克拉科夫的贵族们干脆自己把瓦迪斯瓦夫·洛凯泰克请了进来。波希米亚对这顶瓦茨拉夫拼上性命也要守住的王冠，实际控制就这样结束了，不管布拉格接下来几十年还要顶着这个头衔喊多久。",
    },
    quotes: [
      {
        text: {
          en: "The mighty royal line has been utterly overcome by the sting of death, for no male heir remained anywhere in the world. Only the bonds of the female line remained. Orphaned Czech nation, sing therefore a sorrowful lament. Behold, stricken here lies the Bohemian king, overcome by death: alas, your own native king, such as will never again be given you. Rightly do you weep, O kingdom: for behold, you are bereft of seven Bohemian kings, and wretchedly widowed.",
          cz: "Silný královský rod byl přemožen uštknutím smrti zcela, neb potomek mužský tu žádný na světě nezbyl. Zůstaly toliko svazky, jež pohlaví ženského byly. Sirý národe český, pěj proto žalozpěv smutný. Sklíčen tu leží, hle, král český, přemožen smrtí: běda, tvůj rodný král, jaký nikdy už nebude dán ti. Právem, království, lkáš: neb králů českých již sedmi, Ejhle, zbaveno jsi a ovdovělo jsi bídně.",
          zh: "这支强盛的王室血脉，已被死亡的毒刺彻底击垮，世间再无一位男性子嗣留存。留下的，唯有女系这一脉血缘的联系。孤苦的波希米亚民族啊，就此唱一曲悲伤的挽歌吧。看哪，波希米亚的国王倒卧于此，被死亡所征服：哀哉，你本族的国王，此后再也不会有这样一位赐予你了。王国啊，你理当哭泣：看哪，你已痛失七位波希米亚国王，凄惨地守了寡。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Henry_of_Bohemia",
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "The Foreigner, Crowned Twice",
      cz: "Cizinec, korunovaný dvakrát",
      zh: "两次登基的外族人",
    },
    hookLine: {
      en: "Bohemia's throne had never gone to a foreigner before. In the space of about a year, it went to two — and one of them had to be crowned twice just to make it stick.",
      cz: "Český trůn ještě nikdy nepatřil cizinci. Za necelý rok ho dostali dva — a jeden z nich musel být korunován dvakrát, jen aby to vydrželo.",
      zh: "波希米亚的王位，从来没落到过外族人手里。短短一年多一点的时间里，它落到了两个外族人头上——其中一个甚至得登基两次，才勉强坐稳。",
    },
    summary: {
      en: "The Zbraslav Chronicle remembered exactly how this all began, and made sure its readers knew from the very first line that the story wouldn't end where it started:\n\n[[quote:0]]\n\nThat 'evil' had a name, and it started arriving almost immediately.\n\nAlbert of Habsburg didn't accept Henry's election for a moment — and family politics made his objection personal as well as political: Henry was Albert's own brother-in-law too, married to a sister of Albert's own wife. None of that stopped him. Albert placed Henry under the imperial ban, marched an army into Bohemia, and pushed him out within months. Henry fled first to Bavaria, then home to Carinthia — a reign that had lasted barely long enough to be called one.\n\nThe throne Albert cleared went to his own son, Rudolf III, Duke of Austria — a familiar face by now, having helped his father invade Moravia back in 1304. Installed as King of Bohemia, Rudolf reached for the same trick this dynasty had used on outsiders for generations, only now turned back on itself: on 16 October 1306 he married Elizabeth Richeza of Poland, Wenceslas II's own widow, binding himself to the Přemyslid line by marriage since he couldn't claim it by blood. It made Elizabeth Richeza queen of Bohemia for the second time in her life — a title she'd wear twice before this whole mess was over, married to two different men who each held the crown only briefly. Bohemian nobles were not impressed: William Zajíc of Valdek and Bavor of Strakonice, among others, refused their allegiance outright, and the wider nobility took to calling him 'King Porridge' behind his back — a jab at a diet so frugal it ran to little more than gruel, though an empty royal treasury probably had as much to do with that as personal taste did. Plenty of others simply kept holding out for Henry's return instead.\n\nRudolf never got the chance to find out whether the marriage would work. On 3 July 1307, besieging a rebel-held fortress at Horažďovice, he came down with dysentery and died there — the same illness that had wrecked his own father's army outside Kutná Hora three years earlier, this time with nobody around to blame it on poisoned mine water, though rumor at the time, never proven, whispered that his death had come rather more conveniently than naturally. He had held the Bohemian throne for less than nine months.\n\nThe Bohemian nobility brought Henry back almost immediately, on one condition: a charter of privileges guaranteeing their own rights and sharply limiting his. Henry agreed, and was formally crowned King of Bohemia a second time that August — the only king in this whole dynasty's long story to sit through two separate coronations for the same throne, with a Habsburg usurper's brief reign wedged in between them. It wasn't the return of a strong king. Bohemia's own native line was gone; what replaced it, twice over now, was an outsider ruling on the nobility's terms rather than his own.\n\nAdd it up, and the whole stretch reads almost absurd on paper: in under three years, the Bohemian throne had changed hands four times — Wenceslas III, then Henry, then Rudolf, then Henry again — while the three crowns Wenceslas II had once worn all at once, Bohemia, Poland, and Hungary, had shrunk down to exactly one. Whatever August 1307 actually was, it wasn't stability. It only had to look enough like it, for the moment, to hold.",
      cz: "Zbraslavská kronika si přesně pamatovala, jak to všechno začalo, a hned od první věty dala čtenářům jasně najevo, že příběh neskončí tam, kde začal:\n\n[[quote:0]]\n\nTo „zlo\" mělo jméno a začalo se dostavovat téměř okamžitě.\n\nAlbrecht Habsburský Jindřichovo zvolení ani na okamžik nepřijal — a rodinná politika dělala jeho odpor osobním stejně jako politickým: Jindřich byl i Albrechtovým vlastním švagrem, ženatým se sestrou Albrechtovy manželky. Nic z toho ho nezastavilo. Albrecht uvalil na Jindřicha říšskou klatbu, vtáhl s vojskem do Čech a během pár měsíců ho vytlačil ven. Jindřich uprchl nejdřív do Bavorska, pak domů do Korutan — vláda, která trvala sotva dost dlouho, aby se jí tak vůbec dalo říkat.\n\nTrůn, který Albrecht uvolnil, připadl jeho vlastnímu synovi, Rudolfovi III., vévodovi rakouskému — už dobře známé tváři z tohoto oblouku příběhu, který svému otci v roce 1304 pomáhal vpadnout na Moravu. Dosazen na český trůn, sáhl Rudolf po stejném triku, který tahle dynastie po generace používala na cizince — jenže teď se obrátil sám proti ní: 16. října 1306 se oženil s Alžbětou Rejčkou Polskou, vlastní vdovou po Václavovi II., a svázal se s přemyslovskou linií sňatkem, protože si ji nemohl nárokovat krví. Alžbětu Rejčku to udělalo českou královnou už podruhé v jejím životě — titul, který si za tohle celé martyrium oblékne ještě jednou, provdaná za dva různé muže, z nichž každý držel korunu jen krátce. Čeští šlechtici z toho nadšení nebyli: Vilém Zajíc z Valdeka a Bavor ze Strakonic mu mimo jiné otevřeně odmítli složit hold, a širší šlechta si za jeho zády začala říkat „král Kaše\" — narážka na stravu tak skromnou, že se blížila obyčejné kaši, ačkoli prázdná královská pokladna k tomu měla přinejmenším stejné slovo jako jeho osobní vkus. Řada dalších prostě dál vyčkávala na Jindřichův návrat.\n\nRudolf se nedozvěděl, jestli by ten sňatek zabral. 3. července 1307, při obléhání povstalecké pevnosti v Horažďovicích, ho skolila úplavice a zemřel tam — stejná nemoc, která před třemi lety zdecimovala vojsko jeho vlastního otce před Kutnou Horou, tentokrát bez nikoho, na koho by se dala svést otrávená voda z dolů, ačkoli tehdejší, nikdy nepotvrzené řeči šeptaly, že ta smrt přišla až podezřele vhod. Na českém trůně vydržel necelých devět měsíců.\n\nČeská šlechta přivedla Jindřicha zpátky skoro okamžitě, pod jednou podmínkou: listinou výsad zaručující jejich vlastní práva a citelně omezující ta jeho. Jindřich souhlasil a byl toho srpna formálně korunován českým králem podruhé — jediný král v celém dlouhém příběhu téhle dynastie, který kvůli témuž trůnu prošel dvěma samostatnými korunovacemi, s krátkou vládou habsburského uzurpátora vklíněnou mezi ně. Nebyl to návrat silného krále. Vlastní domácí linie Čech byla pryč; to, co ji nahradilo, tentokrát už podruhé, byl cizinec vládnoucí za podmínek šlechty, ne svých vlastních.\n\nSečteno a podtrženo, celý ten úsek vypadá na papíře skoro absurdně: za necelé tři roky český trůn čtyřikrát změnil majitele — Václav III., pak Jindřich, pak Rudolf, pak znovu Jindřich — zatímco tři koruny, které kdysi najednou nosil Václav II., česká, polská a uherská, se scvrkly přesně na jednu. Ať už srpen 1307 byl čímkoli, stabilitou rozhodně ne. Stačilo mu jen na chvíli se jí dostatečně podobat, aby to vydrželo.",
      zh: "《兹布拉斯拉夫编年史》清楚记得这一切是怎么开始的，而且开篇第一句就让读者明白，这个故事不会在原地打转：\n\n[[quote:0]]\n\n那份“灾祸”是有名有姓的，而且几乎马上就找上门来了。\n\n哈布斯堡的阿尔布雷希特一刻也没接受亨利这次当选——而且家族关系让他的反对不只是政治上的，也是私人的：亨利同样是阿尔布雷希特自己的妹夫，娶的是阿尔布雷希特妻子的妹妹。这些都没能拦住他。阿尔布雷希特对亨利下达了帝国禁令，率军打进波希米亚，几个月内就把他赶了出去。亨利先逃往巴伐利亚，后来又逃回了克恩滕老家——这次在位的时间，短到几乎算不上一次统治。\n\n阿尔布雷希特腾出来的这个王位，落到了他自己的儿子——奥地利公爵鲁道夫三世头上，这条故事线里的老熟面孔了，1304年就曾帮父亲入侵摩拉维亚。被扶上波希米亚王位后，鲁道夫使出了这个王朝几代人一直用在外人身上的那招——只不过这一次，这一招反过来用在了这个王朝自己身上：1306年10月16日，他娶了波兰的伊丽莎白·蕾切卡——瓦茨拉夫二世本人的遗孀——既然没法靠血缘主张继承权，那就靠婚姻把自己绑进普热米斯尔家族的血脉里。这场婚姻，让伊丽莎白·蕾切卡这辈子第二次当上了波希米亚王后——这个头衔，在这整场乱局结束之前，她还会再戴上一次，先后嫁给两位各自只坐了短短一阵子王位的丈夫。波希米亚贵族并不买账。瓦尔德克的威廉·扎伊茨、斯特拉科尼采的巴沃尔等人干脆公开拒绝效忠。私底下，贵族们还给他起了个外号，“粥王”，笑话他饮食寒酸得几乎只剩粥可吃——不过王室国库当时确实亏空严重，这份“节俭”未必全是他自己乐意的。不少人依然在等着亨利回来。\n\n鲁道夫没能等到验证这桩婚姻到底管不管用的那一天。1307年7月3日，他在围攻霍拉日多维采一座叛军据点时染上了痢疾，死在了那里——正是三年前在库特纳霍拉城下拖垮他父亲那支军队的同一种病，只是这一次，没人可以把它归咎于被下毒的矿区水源。当时也有传言说，这场死亡来得未免太巧——传言从未被证实，但一直流传。他在波希米亚王位上，还没坐满九个月。\n\n波希米亚贵族几乎立刻就把亨利重新请了回来，但附带一个条件：一份特权状，保障他们自己的权利，同时大幅限制他的权力。亨利答应了，当年8月正式第二次登基为波希米亚国王——这是这整个王朝漫长历史里，唯一一位为了同一个王位经历过两次独立加冕礼的国王，中间还硬生生塞进了一位哈布斯堡篡位者的短暂统治。这不是一位强势国王的回归。波希米亚自己的本土血脉已经断了；取而代之的，如今已是第二次，是一个按贵族条件而非自己意愿统治的外族人。\n\n算总账的话，这段时间摆在纸面上几乎有点荒谬：不到三年，波希米亚的王位换了四次主人——瓦茨拉夫三世，然后是亨利，然后是鲁道夫，然后又是亨利。瓦茨拉夫二世曾经同时戴过的三顶王冠——波希米亚、波兰、匈牙利——如今也缩成了一顶。1307年8月的这一切，要说是稳定，那还差得远。它只不过在那一刻，看起来足够像稳定，撑住了而已。",
    },
    quotes: [
      {
        text: {
          en: "Prague rejoiced then, when Duke Henry was elected king… Alas, for they did not know the evil that would soon fall upon them, and upon the whole kingdom. Well known now are the blows of fortune's reversal, for the Bohemian land bears upon itself an immense weight of every misfortune — a weight it truly would never have known, had that man not become its ruler: a king it once loved, but came in the end to hate. Under him, robbery is everywhere, and murders occur just the same; disputes multiply, peace vanishes, and all law grows faint. The fields lie fallow, and little fruit is to be found on them, for nothing grows throughout the land but lamentation, since on every side nothing is born but the fury of war.",
          cz: "Praha se těšila tehdy, když vévoda Jindřich byl zvolen za krále… Běda, vždyť neznali zlo, jež vbrzku dopadnou mělo na ně a království celé. A dobře jsou nyní již známi zásahy zvratu štěstí, neb na sobě nese zem česká nesmírně velikou tíhu všech neštěstí, kterou by věru nebyla poznala ani, jí kdyby se vládcem byl nestal král, jejž měla dřív ráda, však posléz ho nenáviděla. Za něho loupeží kdekdo a rovněž dochází k vraždám, vzrůstají pře, mír mizí a umdlévá veškeré právo, pole tu leží ladem a málo lze nalézti na nich plodů, neb nevzrůstá nic než nářek po celé zemi, neboť se na všech stranách jen válečná lítice rodí.",
          zh: "当年，亨利公爵被推举为国王之时，布拉格曾一片欢腾……可叹，他们并不知道，即将降临在他们、乃至整个王国头上的，是怎样的灾祸。世事无常的打击，如今已再清楚不过：波希米亚这片土地，承受着如此沉重的重重不幸，若不是这个人当上了统治者，这片土地本不至于尝到这般滋味——一位曾经深受爱戴、到头来却遭人厌憎的国王。在他治下，抢劫四处横行，谋杀同样层出不穷；纷争与日俱增，和平荡然无存，一切律法都日渐衰微。田地荒芜，鲜有收成，因为整个国家再也长不出别的东西，只有哀号，因为四面八方，滋生的唯有战祸。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "A Thoroughly Incompetent King",
      cz: "Naprosto neschopný král",
      zh: "十足的昏君",
    },
    hookLine: {
      en: "Dalimil's Chronicle needed exactly six rhyming lines to sum up Henry of Carinthia's second reign — and didn't feel the need to add a seventh.",
      cz: "Dalimilova kronika potřebovala přesně šest rýmovaných veršů, aby shrnula druhou vládu Jindřicha Korutanského — a necítila potřebu přidat sedmý.",
      zh: "达利米尔编年史只用了六行押韵的诗句，就把亨利第二次统治总结完了——它显然觉得没必要再加第七行。",
    },
    summary: {
      en: "Dalimil's Chronicle — written not in Latin prose like Cosmas or the Zbraslav monks, but in rhymed Czech verse meant to be read aloud — summed up Henry's second reign in exactly six lines, and clearly felt no need to add a seventh:\n\n[[quote:0]]\n\nIt wasn't wrong. Real power in Bohemia during these years belonged to a different Henry entirely: Henry of Lipé, a Moravian lord who had helped defend Kutná Hora that same summer against a renewed siege by Albert of Habsburg — commanding the defense alongside John of Vartenberk, the same John who'd end up his fellow hostage at Sedlec two years later — was named the kingdom's highest marshal and chamberlain the following year, and by most contemporary accounts became the single most powerful man in the country. Two Henrys running Bohemia at once — one wearing the crown, one actually running things — is exactly the kind of coincidence this timeline has learned not to let pass without comment.\n\nAlbert wasn't finished, either. By spring 1308 he was quietly lining up a third invasion, this time with real support from part of the Moravian nobility. It never happened. On 1 May 1308, crossing a river back in his own Habsburg homeland, Albert was ambushed and cut down by his own nephew, John — a family inheritance dispute with nothing whatsoever to do with Bohemia. Whatever kept Henry on his throne a while longer, it wasn't strength. Bohemia's most persistent enemy in a decade simply ran out of family loyalty before he ran out of Bohemia.\n\nUnderneath both of them, the kingdom's finances came apart. Kutná Hora's silver mines — the same mines that had bankrolled Wenceslas II's entire reign barely a decade earlier — cut production to almost nothing; trade stalled; the shortage of coinable metal got bad enough that nobody could organize a proper minting run. Henry never controlled the Kutná Hora mines or the Prague mint, even nominally, and his reign remains to this day the only stretch in the whole history of the Bohemian crown when the reigning king struck no coins of his own at all.\n\nThe resentment building underneath it all boiled over on 15 February 1309. An armed mob of Kutná Hora miners, led by a patrician named Peregrin Puš and the Ruthard family — part of a wider plot by wealthy townsmen in both Kutná Hora and Prague to seize control of both cities — stormed Sedlec Monastery, where Henry of Lipé and several other lords were spending the night. They killed Kutná Hora's own mayor, Jenslin of Rosenthal, on the spot, and took Henry of Lipé and John of Vartenberk hostage.\n\nKing Henry's answer was to call in Carinthian muscle: a mercenary captain named Henry Aufenstein, brought in with several hundred armed men. It didn't restore order. It just gave the kingdom's growing hatred of its own king a face to focus on.\n\nBy 1309, King Henry's opponents had already started looking abroad for a replacement, opening contact with the newly elected King of the Romans, Henry VII of Luxembourg — already the third Henry in this one section — about his own son John. What came next is its own story.",
      cz: "Dalimilova kronika — psaná nikoli latinskou prózou jako u Kosmy nebo zbraslavských mnichů, ale rýmovaným českým veršem určeným ke čtení nahlas — shrnula druhou vládu Jindřicha v přesně šesti verších a zjevně necítila potřebu přidat sedmý:\n\n[[quote:0]]\n\nNemýlila se. Skutečná moc v Čechách v těchto letech patřila úplně jinému Jindřichovi: Jindřichu z Lipé, moravskému pánu, který téhož léta pomohl ubránit Kutnou Horu před obnoveným obležením Albrechta Habsburského — obranu vedl společně s Janem z Vartenberka, týmž Janem, který o dva roky později skončí jako jeho spoluvězeň v Sedlci — byl následujícího roku jmenován nejvyšším maršálkem a komorníkem království a podle většiny dobových svědectví se stal jednoznačně nejmocnějším mužem v zemi. Dva Jindřichové řídící Čechy zároveň — jeden s korunou na hlavě, druhý skutečně u kormidla — je přesně ten druh shody okolností, kterou si tahle časová osa už dávno odvykla nechávat bez poznámky.\n\nAlbrecht ještě neskončil. Na jaře 1308 potichu chystal třetí invazi, tentokrát s reálnou podporou části moravské šlechty. K ní už nedošlo. 1. května 1308, při přechodu řeky ve svém vlastním habsburském domově, na něj číhal a zabil ho jeho vlastní synovec Jan — rodinný spor o dědictví, který s Čechami neměl vůbec nic společného. Ať už Jindřicha na trůně udrželo cokoli, síla to nebyla. Nejvytrvalejší nepřítel Čech za celou dekádu prostě vyčerpal rodinnou loajalitu dřív, než vyčerpal Čechy.\n\nPod nimi oběma se rozpadaly královské finance. Kutnohorské stříbrné doly — tytéž doly, které necelou dekádu předtím financovaly celou vládu Václava II. — omezily těžbu téměř na nulu; obchod se zastavil; nedostatek kovu vhodného na ražbu dospěl tak daleko, že se nepodařilo zorganizovat pořádnou ražbu mincí. Jindřich nikdy neměl pod kontrolou ani kutnohorské doly, ani pražskou mincovnu, byť jen formálně, a jeho vláda zůstává dodnes jediným obdobím v celých dějinách české koruny, kdy vládnoucí král nerazil žádné vlastní mince.\n\nNahromaděná zloba vybuchla 15. února 1309. Ozbrojený dav kutnohorských horníků, vedený měšťanem Peregrinem Pušem a rodinou Ruthardů — součást širšího spiknutí bohatých měšťanů v Kutné Hoře i v Praze, kteří chtěli ovládnout obě města — přepadl klášter v Sedlci, kde přenocoval Jindřich z Lipé a několik dalších pánů. Kutnohorského purkmistra Jenslina z Rosenthalu na místě zabili a Jindřicha z Lipé s Janem z Vartenberka zajali jako rukojmí.\n\nKrál Jindřich odpověděl tím, že si povolal korutanskou posilu: žoldnéřského velitele jménem Jindřich z Aufensteinu, s několika sty ozbrojenci. Pořádek to neobnovilo. Jen to dalo sílící nenávisti království k vlastnímu králi konkrétní tvář, na kterou se dalo soustředit.\n\nUž v roce 1309 se odpůrci krále Jindřicha začali ohlížet po náhradě v cizině a navázali kontakt s nově zvoleným římským králem Jindřichem VII. Lucemburským — už třetím Jindřichem v této jediné kapitole — ohledně jeho vlastního syna Jana. Co přišlo dál, je už jiný příběh.",
      zh: "达利米尔编年史——不像科斯马斯或兹布拉斯拉夫的僧侣们那样用拉丁散文写作，而是用押韵的捷克语诗句写成，专为朗读而生——只用六行诗句，就总结完了亨利的第二次统治，显然觉得没必要再加第七行：\n\n[[quote:0]]\n\n它说得没错。这几年波希米亚真正的权力，握在另一位亨利手里：摩拉维亚贵族利佩的亨利，同年夏天曾协助抵御阿尔布雷希特卷土重来的围城——与他并肩指挥防守的，正是瓦滕贝克的约翰，两年后又会和他一起沦为塞德莱茨的人质。第二年，利佩的亨利就被任命为王国最高元帅兼宫廷总管，按当时多数记载，他实际上成了国内权力最大的人。两个亨利同时执掌波希米亚——一个头顶王冠，另一个才是真正掌舵的——这种巧合，这条时间线早就学会不会轻易放过不提。\n\n阿尔布雷希特还没死心。1308年春，他正悄悄筹备第三次入侵，这次还拉来了部分摩拉维亚贵族的实际支持。可这次入侵始终没有成行。1308年5月1日，在自己哈布斯堡老家渡河时，他遭到亲侄子约翰的伏击，当场被杀——起因是一桩和波希米亚毫无关系的家族遗产纠纷。亨利能继续坐在王位上，靠的从来不是自己的实力。波希米亚这十年来最难缠的敌人，不过是家族忠诚耗尽得比对波希米亚的耐心还快。\n\n在这两位亨利之下，王国的财政彻底崩溃了。库特纳霍拉的银矿——就是不到十年前还撑起瓦茨拉夫二世整个统治的那些银矿——产量几乎跌到了零；贸易停滞；铸币用的金属短缺到根本组织不起一次像样的铸币。亨利从未真正掌控过库特纳霍拉的矿山或布拉格的铸币厂，哪怕只是名义上的。他的统治，也是波希米亚王室历史上唯一一段在位国王没有铸造过任何自己钱币的时期。\n\n积压已久的怨恨在1309年2月15日爆发了。一群全副武装的库特纳霍拉矿工，由市民佩雷格林·普什和鲁塔尔德家族带头——这背后其实是库特纳霍拉和布拉格两地富裕市民想要夺取两座城市控制权的更大阴谋——冲进了塞德莱茨修道院，当时利佩的亨利和另外几位贵族正在那里过夜。他们当场杀死了库特纳霍拉市长罗森塔尔的延斯林，并把利佩的亨利和瓦滕贝克的约翰掳去当了人质。\n\n国王亨利的应对办法，是从克恩滕请来了武力：一位名叫奥芬施泰因的亨利的雇佣兵队长，带着几百名武装人员。这并没能恢复秩序，只是让这个王国日渐高涨的对国王本人的怨恨，找到了一张具体的脸来发泄。\n\n到1309年，国王亨利的反对者们已经开始向国外物色替代人选，联系上了刚刚当选罗马人民的国王的卢森堡的亨利七世——这已经是这一小节的第三个亨利了，谈起了他自己的儿子约翰。接下来发生的事，是另一个故事了。",
    },
    quotes: [
      {
        text: {
          en: "Henry of Carinthia then took the Bohemian land in hand — a good enough fellow, but something of a bungler. He stood in for young Wenceslas while he was off on campaign, and later married that same king's sister. He cares nothing for the realm, and that is his great sin — for nothing interests him but his own belly.",
          cz: "Jindřich z Korutan pak českou zemi řídil. Byl to sice dobrák, ale trochu břídil. Zastupoval Vaňka když byl na tažení, později se taky s jeho sestrou žení. O zem nestará se, má veliký hřích, že ho nezajímá nic než vlastní břich.",
          zh: "科林西亚的亨利，就这样接手了波希米亚这片土地——算是个不错的人，可惜办事有点笨手笨脚。年轻的瓦茨拉夫出征在外时，他曾代为摄政；后来又娶了这位国王的妹妹。他压根不操心国事，这是他最大的罪过——因为除了自己的肚子，什么都入不了他的眼。",
        },
        attribution: {
          en: "Dalimil's Chronicle",
          cz: "Dalimilova kronika",
          zh: "达利米尔编年史",
        },
      },
    ],
    relatedLandmarks: [
      {
        slug: "sedlecky-klaster",
        relation: {
          en: "The Cistercian monastery where the mob struck on 15 February 1309 — founded a century and a half earlier on land granted by a different lord of Vartenberk than the one taken hostage here.",
          cz: "Cisterciácký klášter, kde dav udeřil 15. února 1309 — založený o půldruhého století dříve na pozemku darovaném jiným pánem z Vartenberka, než tím, který zde skončil jako rukojmí.",
          zh: "1309年2月15日暴民袭击的正是这座熙笃会修道院——一个半世纪前，它的建寺土地正是由另一位瓦滕贝克家族的贵族所捐赠，与这次沦为人质的约翰同姓，却不是同一个人。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Henry_of_Bohemia",
  },
  {
    ...
    title: {
      ...
      cz: "Prchající princezna",
      zh: "出逃的公主",
    },
    hookLine: {
      en: "For a year, two disgruntled abbots quietly built a conspiracy around the one person left who could end King Henry's reign just by getting married. When her own uncle tried to marry her off first, she ran.",
      cz: "Rok si dva rozladění opati potichu budovali spiknutí kolem jediné osoby, která mohla vládu krále Jindřicha ukončit pouhým sňatkem. Když se ji vlastní strýc pokusil provdat jako první, utekla.",
      zh: "两位心怀不满的修道院院长，花了整整一年悄悄策划一场阴谋——阴谋的核心，是唯一一个只要结婚就能终结国王亨利统治的人。她自己的叔叔抢先一步想把她嫁出去时，她选择了出逃。",
    },
    summary: {
      en: "By 1309, the opposition to King Henry of Carinthia had a new front, and it wasn't nobles with swords this time — it was two Cistercian abbots with a grudge. Heidenreich of Sedlec and Konrad of Zbraslav had both turned against King Henry over his predatory treatment of their own Cistercian houses, and they had a plan to end his reign for good.\n\nThe one person who could actually do it was Elizabeth Přemyslovna, Wenceslas II's younger daughter — the last unmarried member of the Přemyslid line, and sister to both the murdered Wenceslas III and to King Henry's own wife, Anna. Whoever married Elizabeth would have the strongest possible claim to the Bohemian throne left standing. The abbots opened contact with the newly elected King of the Romans, Henry VII of Luxembourg, about his own son John. According to the Zbraslav Chronicle's own account, Abbot Konrad met Elizabeth face to face at St. Vitus Basilica around July 1309 — and the young princess agreed to the plot herself.\n\nKing Henry found out, and moved to close the question down permanently: he tried to force Elizabeth into marrying an obscure Meissen baron, Otto of Burgau, deliberately unremarkable enough to take her off the board for good. His own marshal, Konrad of Aufenstein — brother of Henry Aufenstein, the same mercenary captain hired to keep order the year before — intercepted a delegation sent by Henry VII in 1309 and held them for five days before letting them go, on their promise to leave Bohemia at once.\n\nThe Zbraslav Chronicle adds one more accusation, though the chronicler himself admits he isn't sure how much of it to believe: that King Henry's own wife, Anna — Elizabeth's own older sister — schemed against her too, pushing the humiliating marriage and, by some accounts, attempting to have her poisoned outright. Whatever the truth of it, the sisters were no longer on the same side.\n\nElizabeth moved first. On the night of 28 May 1310, she dressed herself as an old woman and slipped out through the gate of Prague Castle on foot, taking only two maids, Cecilia and Agnes, with her:\n\n[[quote:0]]\n\nJohn of Vartenberk — the same John taken hostage at Sedlec the year before — was waiting at Vyšehrad with an armed escort, and together they rode on to Nymburk, a well-fortified town held by Henry of Lipé, the very man who'd been dragged off in chains alongside him.\n\nWith the last Přemyslid princess safely beyond King Henry's reach, the marriage the abbots had spent a year quietly arranging could finally happen. What came next is its own story.",
      cz: "V roce 1309 měl odpor proti králi Jindřichovi Korutanskému novou frontu, a tentokrát to nebyli šlechtici s meči — byli to dva rozladění cisterciáčtí opati. Heidenreich ze Sedlce a Konrád ze Zbraslavi se oba obrátili proti králi Jindřichovi kvůli jeho dravému zacházení s vlastními cisterciáckými domy, a měli plán, jak jeho vládu ukončit nadobro.\n\nJedinou osobou, která to skutečně dokázala, byla Eliška Přemyslovna, mladší dcera Václava II. — poslední neprovdaná členka přemyslovského rodu, sestra zavražděného Václava III. i vlastní manželky krále Jindřicha, Anny. Kdokoli by si Elišku vzal, měl by nejsilnější možný nárok na český trůn, jaký ještě zbýval. Opati navázali kontakt s nově zvoleným římským králem Jindřichem VII. Lucemburským ohledně jeho syna Jana. Podle Zbraslavské kroniky se opat Konrád s Eliškou osobně setkal u baziliky svatého Víta na Pražském hradě kolem července 1309 — a mladá kněžna se spiknutí sama přidala.\n\nKrál Jindřich se to dozvěděl a rozhodl se otázku uzavřít natrvalo: pokusil se Elišku provdat za bezvýznamného míšeňského šlechtice Otu z Burgavy, záměrně natolik nenápadného, aby ji navždy vyřadil ze hry. Jeho vlastní maršálek Konrád z Aufensteinu — bratr Jindřicha z Aufensteinu, téhož žoldnéřského velitele najatého o rok dříve k udržení pořádku — zadržel delegaci vyslanou Jindřichem VII. v roce 1309 a držel ji pět dní, než ji propustil, poté co delegace slíbila okamžitě opustit Čechy.\n\nZbraslavská kronika přidává ještě jedno obvinění, byť si sám kronikář není jistý, nakolik mu věřit: že proti Elišce intrikovala i vlastní manželka krále Jindřicha, Anna, její vlastní starší sestra — prosazovala ponižující sňatek a podle některých podání se ji dokonce pokusila otrávit. Ať už na tom bylo cokoli pravdy, sestry už rozhodně nestály na stejné straně.\n\nEliška jednala první. V noci 28. května 1310 se převlékla za stařenu a pěšky vyklouzla branou Pražského hradu, s sebou jen dvě dívky, Cecílii a Anežku:\n\n[[quote:0]]\n\nNa Vyšehradě už na ni s ozbrojeným doprovodem čekal Jan z Vartenberka — týž Jan, který byl o rok dříve zajat v Sedlci — a spolu odjeli do Nymburka, dobře opevněného města, které držel Jindřich z Lipé, tentýž muž, jenž byl tehdy odvlečen v poutech po jeho boku.\n\nKdyž byla poslední přemyslovská princezna bezpečně mimo dosah krále Jindřicha, mohl se sňatek, který opati rok potichu chystali, konečně uskutečnit. Co přišlo dál, je už jiný příběh.",
      zh: "到1309年，反对国王亨利的阵营多了一条新战线——这次不是拿剑的贵族，而是两位心怀不满的熙笃会院长。塞德莱茨的海登赖希和兹布拉斯拉夫的康拉德，两人都因为国王亨利对熙笃会修道院的掠夺性政策而倒向了反对派，手里还握着一个能彻底终结他统治的计划。\n\n真正能做到这一点的人，是瓦茨拉夫二世的次女，伊丽莎白·普热美斯洛夫娜——普热米斯尔家族最后一位未婚的成员，既是遇刺身亡的瓦茨拉夫三世的妹妹，也是国王亨利自己妻子安娜的妹妹。不管谁娶了伊丽莎白，谁就等于拿到了目前波希米亚王位最强的继承依据。两位院长联系上了刚当选罗马人民的国王的卢森堡的亨利七世，谈起了他儿子约翰。据《兹布拉斯拉夫编年史》记载，1309年7月前后，康拉德院长亲自在布拉格城堡的圣维特罗马式教堂里见了伊丽莎白一面——这位年轻的公主，自己也答应加入了这场密谋。\n\n国王亨利很快就察觉到了，决心一劳永逸地解决这个隐患：他试图强迫伊丽莎白嫁给一位籍籍无名的迈森贵族，奥托·冯·布尔高——刻意挑了个毫不起眼的对象，好把她彻底排除出这场王位争夺。他自己的元帅，奥芬施泰因的康拉德——正是前一年被请来维持秩序的那位奥芬施泰因的亨利的亲兄弟——在1309年拦截了亨利七世派来的一支使团，扣押了五天，直到对方承诺立刻离开波希米亚才放人。\n\n《兹布拉斯拉夫编年史》还提到了另一项指控，不过编年史作者自己也说不准该信几分：国王亨利自己的妻子安娜——伊丽莎白的亲姐姐——也曾密谋对付她，不仅极力促成这桩羞辱性的婚事，据一些说法，甚至企图直接毒杀她。真相如何已难以考证，但姐妹俩显然已经站到了对立面。\n\n伊丽莎白抢先一步。1310年5月28日夜里，她换上一身老妇人的装扮，只带了两个女孩——采西莉亚和阿格尼丝——徒步溜出了布拉格城堡的大门：\n\n[[quote:0]]\n\n瓦滕贝克的约翰——就是一年前在塞德莱茨被俘的那位——已经带着一支武装护卫在维谢赫拉德等候，两人随后一起赶往宁布尔克，一座由利佩的亨利据守的坚城——正是当年和约翰一起被绑走的那个人。\n\n普热米斯尔家族最后这位公主终于安全脱离了国王亨利的掌控，两位院长花了整整一年悄悄筹备的这桩婚事，也终于可以成行了。接下来发生的事，是另一个故事了。",
    },
    quotes: [
      {
        text: {
          en: "She quickly dressed herself in a poor woman's cloak, taking only two girls with her, Cecilia and Agnes, and disguised as an old woman, walked swiftly on foot — the maiden's own blossoming youth showing through the disguise all the way to Vyšehrad.",
          cz: "Rychle se oblékla do pláště chudačky, vzavši s sebou jen dvě dívky, Cecílii a Anežku, zahaleno jako jedna stařena šlo pěšky hodně rychle kráčejíc kvetoucí mládí panny až na Vyšehrad.",
          zh: "她匆匆换上一件穷苦妇人的斗篷，只带了两个女孩——采西莉亚和阿格尼丝——伪装成一位老妇人，徒步快步而行，少女那藏不住的青春气息，一路透过伪装，直到维谢赫拉德。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        slug: "nymburk",
        relation: {
          en: "The 'well-fortified town' Elizabeth and John of Vartenberk rode to — its double ring of brick walls, built barely a generation earlier under Otakar II and Wenceslas II, was exactly the kind of defense Henry of Lipé needed to keep the last Přemyslid princess out of her uncle's reach.",
          cz: "„Dobře opevněné město“, kam Eliška s Janem z Vartenberka dojeli — jeho dvojitý prstenec cihlových hradeb, vybudovaný sotva o generaci dříve za Otakara II. a Václava II., byl přesně tou obranou, kterou Jindřich z Lipé potřeboval, aby poslední přemyslovskou princeznu udržel mimo dosah jejího strýce.",
          zh: "伊丽莎白和瓦滕贝克的约翰投奔的正是这座“坚城”——它那两道砖砌城墙，不过是一代人之前奥托卡二世和瓦茨拉夫二世在位时才建成的，正是利佩的亨利用来把最后一位普热米斯尔公主挡在叔叔手够不着的地方所需要的那种防御工事。",
        },
      },
    ],
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "Two Henrys: The Alliance That Fell Apart",
      cz: "Dva Jindřichové: spojenectví, které se rozpadlo",
      zh: "两位亨利：一场破裂的同盟",
    },
    hookLine: {
      en: "It would be easy to assume two men sharing a name and competing for the same kingdom's power were rivals from day one. The real story is messier — and more familiar than that.",
      cz: "Snadno by se dalo předpokládat, že dva muži stejného jména, soupeřící o moc nad stejným královstvím, byli rivaly od prvního dne. Skutečný příběh je spletitější — a povědomější, než by se zdálo.",
      zh: "两个同名的人，为同一个王国的权力较劲——很容易让人以为他们从一开始就是死对头。真实的故事更复杂，也更眼熟。",
    },
    summary: {
      en: "Calling this era's two Henrys 'the king' and 'the man really running things' makes for a tidy joke, but it flattens a relationship that actually moved through three distinct stages in barely three years: partnership, quiet erosion, and open betrayal.\n\nIt started as a genuine alliance, not a hostile takeover. After Rudolf III's death in 1307, Henry of Lipé and his Ronov kinsmen threw their weight behind Henry of Carinthia's restoration — and were paid for it in real offices, not vague goodwill. In 1308, following the murder of the previous marshal, Tobiáš of Bechyně, Henry of Lipé became the kingdom's highest marshal; not long after, he added the office of cupbearer, which meant control of the treasury too. King Henry needed exactly this kind of native muscle to hold a throne he'd already agreed to rule on the nobility's terms, not his own — and the Lipé family got precisely the kind of power a Bohemian magnate wanted. Neither side was being cheated. It worked, for a while.\n\nIt stopped working as King Henry's own household filled up with outsiders — Carinthian favorites, and eventually the armed retinue of the Aufenstein brothers. Every foreign face that gained the king's ear was, quietly, one more degree of separation between the throne and the men who'd actually put him back on it. Henry of Lipé and John of Vartenberk didn't lose their titles. They just stopped being listened to.\n\nThe break, when it came, wasn't subtle. King Henry's attempt to force the last Přemyslid princess into a humiliating, politically meaningless marriage was the kind of decision a king makes when he's stopped consulting the men who'd once run his government for him. By 1309, Henry of Lipé was one of the key figures working to put Elizabeth beyond her uncle's reach — and to replace King Henry altogether.\n\nThe coda makes the whole arc unmistakable: once King Henry was actually deposed, John of Luxembourg's very first acts included naming Henry of Lipé his own chamberlain and supreme marshal. The offices changed hands; the man holding them didn't. Whatever else can be said about Henry of Lipé, his loyalty was never really to a king — it was to whichever king kept him in power.",
      cz: "Nazývat tyhle dva Jindřichy z tohoto období „králem“ a „tím, kdo skutečně vládne“, je hezký vtip, ale zplošťuje vztah, který za necelé tři roky prošel třemi zřetelnými fázemi: partnerstvím, tichým rozkladem a otevřenou zradou.\n\nZačalo to jako skutečné spojenectví, ne nepřátelské převzetí moci. Po smrti Rudolfa III. v roce 1307 vsadili Jindřich z Lipé a jeho ronovští příbuzní svou váhu na obnovu vlády Jindřicha Korutanského — a dostali za to zaplaceno skutečnými úřady, ne jen vágní vděčností. V roce 1308, po vraždě předchozího maršálka Tobiáše z Bechyně, se Jindřich z Lipé stal nejvyšším maršálkem království; nedlouho poté k tomu přidal i úřad nejvyššího číšníka, což znamenalo kontrolu i nad pokladnou. Král Jindřich potřeboval přesně tenhle druh domácí síly, aby udržel trůn, na kterém už souhlasil vládnout za podmínek šlechty, ne svých vlastních — a rod pánů z Lipé získal přesně ten druh moci, po jakém český magnát toužil. Ani jedna strana nebyla podvedená. Nějakou dobu to fungovalo.\n\nPřestalo to fungovat ve chvíli, kdy se dvůr krále Jindřicha začal plnit cizinci — korutanskými oblíbenci a nakonec i ozbrojeným doprovodem bratrů z Aufensteinu. Každá nová cizí tvář, která si získala králův sluch, znamenala o kousek větší vzdálenost mezi trůnem a muži, kteří na něj krále vlastně znovu dosadili. Jindřich z Lipé a Jan z Vartenberka o své tituly nepřišli. Prostě je přestali poslouchat.\n\nRozkol, když přišel, nebyl nenápadný. Pokus krále Jindřicha vnutit poslední přemyslovské princezně ponižující, politicky bezvýznamný sňatek byl přesně ten druh rozhodnutí, jaké dělá král, který se přestal radit s muži, jež mu kdysi vedli vládu. Do roku 1309 patřil Jindřich z Lipé k hlavním postavám, které pracovaly na tom, dostat Elišku mimo dosah jejího strýce — a nahradit krále Jindřicha úplně.\n\nDovětek dělá celý oblouk příběhu naprosto jasným: jakmile byl král Jindřich skutečně sesazen, patřilo mezi vůbec první kroky Jana Lucemburského jmenování Jindřicha z Lipé jeho vlastním komořím a nejvyšším maršálkem. Úřady změnily majitele; muž, který je držel, ne. Ať už se o Jindřichovi z Lipé dá říct cokoli, jeho věrnost nikdy nepatřila králi jako takovému — patřila tomu králi, který ho zrovna udržoval u moci.",
      zh: "把这段时期的两位亨利简单称作\"国王\"和\"真正掌权的人\"，是个不错的段子，但也把一段关系简化过头了。这段关系不到三年，其实经历了三个明显阶段：结盟、逐渐边缘化、公开反目。\n\n一开始，这是一场真正的结盟，不是敌意接管。1307年鲁道夫三世去世后，利佩的亨利和他罗诺夫家族的亲戚，把分量都压在了支持国王亨利复位这件事上——换来的是实打实的官职，不是空口道谢。1308年，前任元帅托比亚什·冯·贝希涅遇刺身亡后，利佩的亨利接任了王国最高元帅；没过多久，他又兼任了司酒官，等于连财政大权也一并拿下。国王亨利需要正是这种本土力量，才能守住这顶他早已同意按贵族条件、而非自己意愿来坐的王位；利佩家族也正好得到了一个波希米亚贵族最想要的那种权力。谁都没吃亏。这套安排，运转了一阵子。\n\n运转失灵，是从国王亨利自己的宫廷里塞满外人开始的——克恩滕的宠臣，最后还有奥芬施泰因兄弟带来的那支武装护卫。每多一张能说上话的外人面孔，国王和当初真正把他扶上王位的那些人之间，就又远了一步。利佩的亨利和瓦滕贝克的约翰，头衔没丢，只是渐渐没人再听他们的了。\n\n反目来临时，一点也不含蓄。国王亨利执意要把最后一位普热米斯尔公主嫁给一个毫无政治意义、纯属羞辱性质的对象——这正是一位已经不再和当初替自己撑起朝政的那些人商量的国王，才会做出的决定。到1309年，利佩的亨利已经成了策划让伊丽莎白脱离叔叔掌控的核心人物之一——顺带也要把国王亨利本人换掉。\n\n结局把整段故事的性质讲得再清楚不过：国王亨利真正被废黜后，卢森堡的约翰最早的举动之一，就是任命利佩的亨利做自己的宫廷总管兼最高元帅。官职换了主人，握着官职的人却没换。不管利佩的亨利这个人还能怎么评价，他的忠诚从来不属于某一位国王本人——只属于当下能让他继续握有权力的那一位。",
    },
    quotes: [],
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Henry_of_Lip%C3%A1",
  },
  {
    ...
    images: [
      ...
      "/history/capital-changed-hands-thrice-1310-peace.webp",
    ],
    tone: "humorous",
    title: {
      en: "The Capital That Changed Hands Three Times",
      cz: "Hlavní město, které třikrát změnilo majitele",
      zh: "三度易主的都城",
    },
    hookLine: {
      en: "King Henry had already been driven out of Bohemia once and talked back onto the throne once. In 1310, Prague itself would change hands three separate times before the year was through.",
      cz: "Král Jindřich byl z Čech už jednou vyhnán a jednou zpátky na trůn vyjednán. V roce 1310 změnila samotná Praha majitele hned třikrát, než ten rok skončil.",
      zh: "国王亨利此前已经被赶出波希米亚一次，又靠谈判重新登基一次。到了1310年，光是布拉格这座城市本身，一年之内就三度易主。",
    },
    summary: {
      en: "In mid-June 1310, a Carinthian-Meissen force under Henry Aufenstein — yes, a fourth Henry, the same mercenary captain hired to prop up King Henry three years earlier — met King Henry's opponents in battle outside Prague Castle, and lost decisively. The city fell to the anti-Henry lords; only the castle itself stayed in the king's hands. On 29 June, the victorious side brought Elizabeth back into Prague in triumph — seven months after she'd slipped out of it disguised as an old woman.\n\nThe fight wasn't over. In early September, Meissen intervened again, and this time it wasn't a hired army — it was family. Margrave Frederick the Bitten sent his own son, seventeen-year-old Frederick the Lame, to relieve the city, because Frederick's mother, Agnes of Carinthia, was King Henry's own sister. It was a nephew riding to his uncle's rescue, not a mercenary contract. By 14 September, the Meissen force had fought its way back into Prague and retaken the whole city.\n\nJohn's own chance didn't arrive until that winter — and when it did, it found him still a boy who understood none of it, having somehow ended up tagging along with the army all the way from his home in Luxembourg to Prague. On 3 December 1310, Archbishop Peter of Aspelt of Mainz — the same diplomat who'd once failed to talk Albert of Habsburg down from war back in 1304 — arranged a secret understanding with a group of Prague citizens, among them a priest of Elizabeth's own household named Berengar. Under their guidance, John's forces slipped into the city through a small gate near where the Old Town's Powder Tower stands today — though the tower tourists climb now is a soaring Gothic structure built in 1475, a century and a half after this night; in 1310 it was just an unremarkable gap in the city wall. Shouting 'Peace, peace, peace!' as they poured through, they took Prague in short order and drove out the Meissen and Carinthian garrisons. King Henry fled the city on 9 December — his third and final departure.\n\nPrague had changed hands three times in six months. Making the city, let alone the kingdom, actually feel like his would take the fourteen-year-old John rather longer.",
      cz: "V polovině června 1310 se korutansko-míšeňské vojsko pod vedením Jindřicha z Aufensteinu — ano, už čtvrtý Jindřich, téhož žoldnéřského velitele najatého o tři roky dříve k udržení krále Jindřicha na trůně — utkalo před Pražským hradem s Jindřichovými odpůrci a bylo na hlavu poraženo. Město padlo do rukou protikrálovských pánů; v Jindřichových rukou zůstal jen samotný hrad. 29. června přivedla vítězná strana zpátky do Prahy Elišku, tentokrát triumfálně — sedm měsíců poté, co z ní vyklouzla přestrojená za stařenu.\n\nBoj tím ale neskončil. Začátkem září zasáhlo Míšeňsko znovu, a tentokrát to nebylo najaté vojsko — byla to rodina. Markrabě Fridrich Pokousaný poslal na pomoc městu svého vlastního syna, sedmnáctiletého Fridricha Kulhavého, protože Fridrichova matka, Anežka Korutanská, byla vlastní sestrou krále Jindřicha. Na pomoc strýci přijel synovec, ne žoldnéřská smlouva. Do 14. září se míšeňské vojsko probojovalo zpátky do Prahy a ovládlo celé město.\n\nJanova vlastní příležitost dorazila až tu zimu — a když konečně přišla, zastihla ho jako chlapce, který jí vůbec nerozuměl a který se nějakým řízením osudu ocitl na cestě s vojskem až z rodného Lucemburska do Prahy. 3. prosince 1310 domluvil mohučský arcibiskup Petr z Aspeltu — týž diplomat, kterému se v roce 1304 nepodařilo odradit Albrechta Habsburského od války — tajnou dohodu se skupinou pražských měšťanů, mezi nimi i s knězem z Eliščina vlastního doprovodu jménem Berengar. Pod jejich vedením se Janovo vojsko vplížilo do města brankou nedaleko místa, kde dnes stojí Prašná brána — ačkoli věž, na kterou dnes lezou turisté, je vzdušná gotická stavba z roku 1475, postavená o půldruhého století později; v roce 1310 to byla jen nenápadná mezera v hradbách. S pokřikem „Mír, mír, mír!“ se prohnali dovnitř, rychle ovládli Prahu a vytlačili míšeňskou i korutanskou posádku. Král Jindřich z města uprchl 9. prosince — potřetí a naposledy.\n\nPraha za šest měsíců třikrát změnila majitele. Aby se město, natožpak celé království, čtrnáctiletému Janovi doopravdy začalo cítit jako jeho vlastní, to mělo trvat mnohem déle.",
      zh: "1310年6月中旬，一支科林西亚-迈森联军在奥芬施泰因的亨利指挥下——好吧，第四个亨利，就是三年前被请来撑住国王亨利王位的那位雇佣兵队长——在布拉格城堡外与反对国王亨利的一方交战，结果一败涂地。布拉格城落入了反国王阵营手中，只有城堡本身还留在国王亨利手里。6月29日，得胜的一方把伊丽莎白风风光光地接回了布拉格——距离她伪装成老妇人溜出城，才过去七个月。\n\n战事并未就此结束。9月初，迈森再度出手，但这次不是雇佣军——是家人。迈森藩侯“被咬伤的”弗里德里希，派出了自己的儿子，年仅十七岁的“跛脚的”弗里德里希前来解围，因为这位弗里德里希的母亲，科林西亚的阿格尼丝，正是国王亨利的亲姐姐。这是侄子驰援舅舅，不是一纸雇佣合同。到9月14日，迈森军队已经打回布拉格，重新夺回了整座城市。\n\n约翰自己的机会，直到那年冬天才姗姗来迟，当时他还是个什么都不懂的孩子，就这样莫名其妙地从卢森堡家乡跟随军队远赴布拉格。1310年12月3日，美因茨大主教彼得·冯·阿斯佩尔特——就是1304年那位没能劝住阿尔布雷希特罢兵的外交官——秘密联络上了一批布拉格市民，其中就有伊丽莎白自己身边的一位神父，名叫贝伦加尔。在他们的接应下，约翰的军队从一道小门潜入城中，位置就在今天火药塔所在的地方——不过今天游客爬上去参观的那座哥特式高塔，其实是1475年才建成的，比这一夜晚了一个半世纪；1310年那会儿，那里不过是城墙上一处毫不起眼的缺口。士兵们涌入城内，高喊着“和平，和平，和平！”，很快就拿下了整座布拉格，把迈森和科林西亚的驻军统统赶了出去。国王亨利12月9日仓皇出逃——这是他第三次、也是最后一次离开这座城市。\n\n短短六个月，布拉格三度易主。要让这座城市——更不用说整个王国——真正感觉像是自己的，十四岁的约翰还要等上更久。",
    },
    quotes: [],
    relatedLandmarks: [
      {
        slug: "celetna",
        relation: {
          en: "The very street that would later open every royal coronation procession into the city — the night John's men slipped through the gate nearby, they may well have marched this same route in, torches and swords instead of a crown and ceremony.",
          cz: "Ulice, která později otevírala každý korunovační průvod do města — tu noc, kdy Janovi muži proklouzli brankou opodál, možná šli přesně touto cestou, jenže místo koruny a obřadu je čekaly pochodně a meče.",
          zh: "这条街后来成了每一次王室加冕游行入城的起点——约翰的人马那晚从附近城门潜入，走的很可能就是这条路，只不过等着他们的不是王冠和仪仗，而是火把和刀剑。",
        },
      },
      {
        slug: "malostranska-mostecka-vez",
        relation: {
          en: "The older, shorter of the two Malá Strana bridge towers carries a permanent scar from exactly this conflict: burned during the fighting between John and King Henry, it had to be rebuilt one story shorter than before — the very reason it still looks squat next to its taller Gothic neighbor today.",
          cz: "Starší, nižší z obou malostranských mosteckých věží nese trvalou jizvu právě z tohoto konfliktu: vyhořela během bojů mezi Janem a králem Jindřichem a musela být obnovena o jedno patro nižší než dřív — přesně proto dodnes vypadá podsaditě vedle své vyšší gotické sousedky.",
          zh: "小城桥塔中那座更老、更矮的一座，身上还留着这场冲突的实际伤痕：约翰和国王亨利交战期间被烧毁，重建时不得不比原来矮了一层——这也是它至今站在旁边那座更高的哥特式塔楼身边，看起来格外矮壮的真正原因。",
        },
      },
    ],
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "The Dawn of the Luxembourg Dynasty",
      cz: "Úsvit lucemburské dynastie",
      zh: "卢森堡王朝的开端",
    },
    hookLine: {
      en: "Henry's exit from Bohemia turned out almost gentle, arranged by his own wife. What he apparently never grasped was that the throne he'd spent six months fighting to keep had already been signed away, on paper, months before.",
      cz: "Jindřichův odchod z Čech byl nakonec téměř mírný, zařídila ho jeho vlastní manželka. Co si zjevně nikdy neuvědomil: trůn, o který půl roku bojoval, byl na papíře pryč už měsíce předtím.",
      zh: "亨利离开波希米亚，最后走得几乎算得上体面，全靠他自己的妻子安排。他大概到最后都没弄明白：他打了半年仗要保住的那顶王冠，早在几个月前就已经在纸面上易了主。",
    },
    summary: {
      en: "Henry's own exit wasn't dramatic, and the credit for that belongs mostly to his wife. Anna Přemyslovna personally negotiated the terms: a bloodless surrender for the remaining Carinthian-Meissen garrison, and free passage out of the kingdom for herself and her husband. On 9 December 1310, the two of them left Prague for Tyrol.\n\nNeither of them came back. Anna died in Carinthia barely three years later, in 1313, quietly and without children — largely forgotten even there, her remains eventually moved to Bolzano. Henry outlived her by more than two decades, dying at Tyrol Castle on 2 April 1335, and he never once let the claim go: he kept calling himself King of Bohemia for the rest of his life, using the title as late as 1314 at a Roman-king election, and no formal peace was ever signed between him and the Luxembourgs. As far as Henry was concerned, this was never actually over.\n\nExcept, on paper, it already was — and had been for months before he even lost the city. On 31 August 1310, Henry VII, King of the Romans, formally invested his own son John with the Kingdom of Bohemia. The next day, John married Elizabeth at Speyer, with a splendor the Zbraslav Chronicle's own Peter of Zittau — who was there in person, part of Elizabeth's own retinue — still remembered vividly enough to write down years later:\n\n[[quote:0]]\n\nBack in Prague itself, the transition was almost administrative. Henry of Lipé — the man who'd spent three years first propping King Henry's throne up, then working to knock it back down — kept both his old offices under the new king: chamberlain, supreme marshal. Whatever else changed, the man actually running the government did not.\n\nBy the time Henry actually left Prague, the throne he'd spent half a year fighting for had already been signed away in writing, three months before the fighting even started. In its own way, that was perfectly in character.",
      cz: "Jindřichův vlastní odchod nebyl dramatický, a zásluhu na tom má hlavně jeho manželka. Anna Přemyslovna osobně vyjednala podmínky: bezkrevnou kapitulaci zbylé korutansko-míšeňské posádky a volný odchod z království pro sebe i svého muže. 9. prosince 1310 oba opustili Prahu a zamířili do Tyrolska.\n\nAni jeden se už nevrátil. Anna zemřela v Korutanech necelé tři roky nato, v roce 1313, tiše a bezdětně — zapomenutá i tam, její ostatky byly později přeneseny do Bolzana. Jindřich ji přežil o více než dvacet let a zemřel na hradě Tyrol 2. dubna 1335 — a nárok se nikdy doopravdy nevzdal: po zbytek života se dál nazýval českým králem, tento titul použil ještě v roce 1314 při volbě římského krále, a mezi ním a Lucemburky nikdy nebyla podepsána žádná formální mírová smlouva. Z Jindřichova pohledu tohle nikdy doopravdy neskončilo.\n\nNa papíře to ale bylo hotové už měsíce předtím, než vůbec přišel o město. 31. srpna 1310 formálně udělil římský král Jindřich VII. své vlastní synovi Janovi České království v léno. Následujícího dne se Jan ve Špýru oženil s Eliškou, a to s takovou nádherou, že si ji Zbraslavská kronika — jejíž spoluautor Petr Žitavský tam byl osobně přítomen jako člen Eliščina doprovodu — pamatovala dost živě, aby ji o léta později sepsala:\n\n[[quote:0]]\n\nV samotné Praze proběhl přechod moci téměř úřednicky. Jindřich z Lipé — muž, který tři roky nejprve podpíral trůn krále Jindřicha a pak pracoval na jeho svržení — si u nového krále podržel obě své staré funkce: komořího i nejvyššího maršálka. Ať se změnilo cokoli jiného, muž, který zemi skutečně řídil, zůstal stejný.\n\nNež Jindřich Prahu skutečně opustil, trůn, o který se půl roku pral, byl na papíře pryč už tři měsíce předtím, než ten boj vůbec začal. Svým způsobem to bylo dokonale v jeho stylu.",
      zh: "亨利自己的退场并不算戏剧性，这多亏了他的妻子。安娜·普热美斯洛夫娜亲自出面谈判条件：剩下的科林西亚-迈森驻军不流血投降，她和丈夫本人则获准自由离境。1310年12月9日，两人离开布拉格，前往蒂罗尔。\n\n两人都再没回来过。安娜三年不到就去世了，1313年，在科林西亚，悄无声息，没有留下子嗣——即便在那里也几乎被人遗忘，遗骨后来被迁往博尔扎诺。亨利比她多活了二十多年，1335年4月2日死于蒂罗尔城堡——他这辈子从没真正放下过这份念想：余生一直自称波希米亚国王，1314年罗马人民的国王选举时还在用这个头衔，他和卢森堡家族之间也从未签过任何正式和约。在亨利自己看来，这件事从来没有真正结束过。\n\n但在纸面上，这件事早在他丢掉布拉格之前几个月就已经尘埃落定了。1310年8月31日，罗马人民的国王亨利七世正式把波希米亚王国封给了自己的儿子约翰。第二天，约翰在施派尔迎娶了伊丽莎白，场面之盛大，连《兹布拉斯拉夫编年史》的作者之一彼得·冯·日塔瓦——他本人当时就在场，是伊丽莎白随行队伍中的一员——多年后写下这段记忆时，依然历历在目：\n\n[[quote:0]]\n\n布拉格城内的权力交接，几乎纯粹是走个流程。利佩的亨利——那位先撑住国王亨利的王位、后来又亲手把他掀翻的人——在新国王手下保住了原来的两个职位：宫廷总管和最高元帅。不管别的什么变了，真正管着这个国家的人，没变。\n\n等亨利真正离开布拉格的时候，他打了半年仗想保住的那顶王冠，早在开战前三个月就已经在纸面上易了主。从某种角度说，这倒挺符合他一贯的作风。",
    },
    quotes: [
      {
        text: {
          en: "Early in the morning, once the sun had risen, we waited some time before the bride's chamber, until the bride came out with her hair loose and flowing freely about her shoulders, entirely without wreath or crown, without any ornament on her head at all, dressed only in a very long French gown.",
          cz: "Časně zrána, když slunce vyšlo, před ložnicí nevěstinou jsme nějaký čas čekali, až nevěsta vyšla ze své ložnice s rozpuštěnými a volnými vlasy splývajícími po ramenou, zcela bez věnce a koruny, bez jakékoli ozdoby hlavy, oděná jen předlouhým francouzským rouchem.",
          zh: "清晨，太阳刚刚升起，我们在新娘的寝室外等了好一会儿，直到新娘走了出来——她的头发松散地披在肩头，没戴花环，也没戴王冠，头上没有任何装饰，身上只穿着一件极长的法式长袍。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
  ...
  },
  {
    ...
    title: {
      ...
      cz: "Chlapecký král, který neuměl česky",
      zh: "语言不通的少年王",
    },
    hookLine: {
      en: "A fourteen-year-old who'd just crossed half of Europe to claim a crown found out his own castle wasn't fit to sleep in. Prague Castle was in such disrepair that the newly arrived King John had to be put up in a private house on Old Town Square instead.",
      cz: "Čtrnáctiletý chlapec, který právě přejel půl Evropy, aby si vyzvedl korunu, zjistil, že jeho vlastní hrad se nedá ani obydlet. Pražský hrad byl v tak žalostném stavu, že nově příchozí král Jan musel bydlet v soukromém domě na Staroměstském náměstí.",
      zh: "一个刚刚横跨半个欧洲、来领王冠的十四岁少年，发现自己的城堡竟然没法住人。布拉格城堡当时破败到根本无法居住，刚到布拉格的国王约翰，只能暂住在老城广场上的一栋民宅里。",
    },
    summary: {
      en: "When the fourteen-year-old finally reached the city he supposedly now ruled, Prague itself had nothing fit to offer him. Prague Castle — the seat he'd just fought half a year for — was in such poor repair after years of neglect and repeated fighting that it couldn't house a king. John and Elizabeth were put up instead in a private residence on Old Town Square, very likely the building now known as the House at the Stone Bell — a king who nominally ruled an entire kingdom, unable yet to move into his own home.\n\nHe also couldn't understand a word anyone around him was saying. John had grown up at the Luxembourg court speaking French, with some German picked up along the way; Czech was not among them, and it never really would be — for the rest of his reign, John relied on interpreters and Czech-speaking officials to run a kingdom whose own language he simply never learned. It's an odd foundation to build a kingship on, and it would define the whole of it.\n\nWhatever he lacked in language, the court chronicler was quick to note he made up for in looks. Peter of Zittau, continuing the Zbraslav Chronicle, described the young king this way:\n\n[[quote:0]]\n\nNone of that stopped the Bohemian nobility from getting exactly what they wanted out of him. On 25 December 1310, John summoned a diet in Prague and, in exchange for the crown, signed what became known as the inaugural charter — a document that gave away, in writing, most of the leverage a king could hope to hold. Land offices would go only to native-born Bohemians, never again to foreign favorites. Noble landholding was guaranteed down to the third generation. The land tax could be levied only to cover the coronation's own costs and the dowries of royal daughters — not, notably, whatever else the king might want money for. And every liberty the nobility had already seized for itself during two years of interregnum and civil war was formally recognized, not merely tolerated. John hadn't just inherited a kingdom; he'd signed away a good deal of the actual power that came with it before he'd even been crowned.\n\nThe coronation itself came six weeks later, on 7 February 1311, in the Basilica of St. Vitus — not the soaring Gothic cathedral that stands on the same site today (that wouldn't begin rising until 1344, under John's own son), but the older Romanesque church built three centuries earlier by Duke Spytihněv. Presiding was Archbishop Peter of Aspelt of Mainz — by now John's single most trusted advisor, the same man who had arranged his marriage to Elizabeth, negotiated Prague's secret surrender the previous December, and once tried and failed to talk Albert of Habsburg out of war back in 1304. If John understood almost nothing else about the kingdom he'd just been handed, he at least knew whose advice to follow.\n\nA beautiful, well-connected, thoroughly foreign fourteen-year-old now wore the Bohemian crown, backed by a charter that had already given most of his power away and an archbishop who understood the kingdom far better than he did. Whether Bohemia had gained a king or merely a very handsome figurehead was a question John would spend the next three decades answering — mostly by not being in Bohemia to answer it.",
      cz: "Když čtrnáctiletý chlapec konečně dorazil do města, kterému teď měl údajně vládnout, Praha mu neměla co nabídnout. Pražský hrad — sídlo, o které bojoval půl roku — byl po letech zanedbávání a opakovaných bojů v tak žalostném stavu, že nemohl hostit krále. Jan s Eliškou byli místo toho ubytováni v soukromém domě na Staroměstském náměstí, velmi pravděpodobně v budově, která je dnes známá jako dům U Kamenného zvonu — král, který formálně vládl celému království, se zatím nemohl nastěhovat ani do vlastního domova.\n\nNavíc nerozuměl ani slovo z toho, co kolem něj lidé říkali. Jan vyrůstal na lucemburském dvoře, kde se mluvilo francouzsky, s trochou němčiny, kterou pochytil cestou; čeština mezi tím nebyla — a nikdy doopravdy nebude. Po celou dobu své vlády se Jan spoléhal na tlumočníky a česky mluvící úředníky, aby řídil království, jehož vlastní jazyk se prostě nikdy nenaučil. Je to zvláštní základ pro královskou vládu — a bude ji určovat od začátku do konce.\n\nCokoli mu chybělo v jazyce, si dvorský kronikář pospíšil zaznamenat, že si to vynahradil vzhledem. Petr Žitavský, pokračovatel Zbraslavské kroniky, popsal mladého krále takto:\n\n[[quote:0]]\n\nNic z toho nezabránilo české šlechtě dostat od něj přesně to, co chtěla. 25. prosince 1310 svolal Jan do Prahy sněm a výměnou za korunu podepsal listinu, které se začalo říkat inaugurační diplom — dokument, který písemně vzdal většiny páky, jakou by král mohl doufat mít. Zemské úřady měly připadnout jen rodilým Čechům, nikdy víc cizím oblíbencům. Šlechtické vlastnictví půdy bylo zaručeno až do třetího kolena. Zemská berně se směla vybírat jen na pokrytí nákladů korunovace a věna královských dcer — ne, jak stojí za povšimnutí, na cokoli jiného, na co by král mohl chtít peníze. A každá svoboda, kterou si šlechta už sama uzurpovala během dvou let bezvládí a občanské války, byla formálně uznána, ne jen trpěna. Jan nezdědil jen království — ještě než byl korunován, vzdal se písemně pořádného kusu moci, která k němu patřila.\n\nSamotná korunovace přišla o šest týdnů později, 7. února 1311, v bazilice svatého Víta — nikoli ve vzdušné gotické katedrále, která na stejném místě stojí dnes (ta se začala stavět až v roce 1344, za vlády Janova vlastního syna), ale ve starší románské stavbě, kterou o tři století dříve postavil kníže Spytihněv. Obřad vedl mohučský arcibiskup Petr z Aspeltu — v té chvíli už Janův nejdůvěryhodnější rádce, tentýž muž, který zařídil jeho sňatek s Eliškou, o předchozím prosinci vyjednal tajnou kapitulaci Prahy a v roce 1304 se marně pokoušel odradit Albrechta Habsburského od války. Pokud Jan o království, které právě dostal, skoro ničemu nerozuměl, aspoň věděl, čí rady poslouchat.\n\nKrásný, dobře propojený a naprosto cizí čtrnáctiletý chlapec teď nosil českou korunu — podepřenou listinou, která už předem vzdala většinu jeho moci, a arcibiskupem, který království rozuměl mnohem líp než on sám. Zda Čechy získaly krále, nebo jen velmi pohledného reprezentativního figuranta, na to měl Jan odpovídat příštích třicet let — hlavně tím, že v Čechách kvůli té odpovědi většinou nebyl.",
      zh: "这个十四岁的少年终于抵达了这座名义上归他统治的城市，可布拉格却拿不出什么能给他。布拉格城堡——他打了半年仗才夺回的宝座所在——多年疏于修缮、又屡遭战火，早已破败到没法住人。约翰和伊丽莎白只能被安置在老城广场上的一栋民宅里，很可能就是如今被称为“石铃之家”的那栋建筑——一位名义上统治着整个王国的国王，此刻却连自己的家都住不进去。\n\n更糟的是，身边人说的话他一句也听不懂。约翰在卢森堡宫廷长大，说的是法语，路上顺带学了点德语；捷克语从来不在其中——往后也始终不在。终其一生，约翰治理这个国家都要靠翻译和说捷克语的官员，因为这门语言他自己压根没学会。用这个来当国王的起点，说来是挺奇怪的——而这个起点，也将贯穿他往后的整段统治。\n\n语言上欠缺的，宫廷史官很快就替他在容貌上找补了回来。续写《兹布拉斯拉夫编年史》的彼得·冯·日塔瓦，是这样描述这位年轻国王的：\n\n[[quote:0]]\n\n这一切都没能阻止波希米亚贵族从他身上榨出他们想要的一切。1310年12月25日，约翰在布拉格召集了一次议会，作为换取王冠的代价，他签下了后来被称为“就职文书”的文件——这份文件白纸黑字地交出了一位国王本可以握有的大部分筹码。地方官职从此只能由土生土长的波希米亚人担任，再也不留给外籍宠臣。贵族对土地的所有权，一直保证到第三代。地税只能用于支付加冕典礼本身的开销和王室公主的嫁妆——值得注意的是，不包括国王想拿钱做的任何其他事情。而贵族在两年空位期和内战期间自行攫取的每一项自由，都得到了正式承认，而不只是被默许。约翰继承的不只是一个王国——他还没登基，就先把这份王权里相当一部分的实权，用白纸黑字签了出去。\n\n加冕典礼本身是六周后的事，1311年2月7日，地点在圣维特大教堂——不是今天矗立在同一片土地上那座高耸的哥特式大教堂（那要到1344年、约翰自己儿子的时代才动工），而是三个世纪前由公爵斯皮季赫涅夫建造的那座更古老的罗马式教堂。主持仪式的是美因茨大主教彼得·冯·阿斯佩尔特——此时已是约翰最信任的谋士，正是这位促成了他与伊丽莎白婚事、去年12月一手谈成布拉格秘密投降、又在1304年徒劳地想劝住阿尔布雷希特罢兵的人。就算约翰对自己刚刚接手的这个王国几乎一无所知，至少他知道该听谁的话。\n\n一个英俊、人脉深厚、彻头彻尾的外国十四岁少年，此刻戴上了波希米亚的王冠——支撑着这顶王冠的，是一份早已交出大半王权的文书，和一位比他自己更懂这个王国的大主教。波希米亚到底是得到了一位国王，还是只得到了一个格外好看的门面人物，这个问题约翰接下来要花三十年去回答——而他给出的答案，大多数时候是压根不在波希米亚。",
    },
    quotes: [
      {
        text: {
          en: "For he was then, and remains to this day, a most beautiful youth — graceful in bearing, his face 'white and red, chosen from among thousands,' more handsome than nearly every other son born in that age to the tall, fair stock of the Czechs' own chosen natural beauty...",
          cz: "Neboť byl tehdy a je dodnes mladík překrásný, zjevem spanilý, v tváři „bílý a červený, vybraný z tisíců“, sličný krásou nad syny skoro všech lidí, které v těch dobách zrodila spanilá ztepilost vybrané přirozené krásy Čechů...",
          zh: "因为他当时是、如今依旧是一位绝美的少年——仪态优雅，面容“白里透红，千里挑一”，比那个年代几乎所有人生养的儿子都要俊美，得益于捷克人那种修长秀丽、精挑细选的天生美貌……",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        ...
        relation: {
          en: "Believed to be the very house where John and Elizabeth lived while Prague Castle stood unfit for a king — and, fittingly, the same building whose corner bell is said to commemorate Berengar's role in letting John's men into the city that December.",
          cz: "Věří se, že je to přesně ten dům, kde Jan s Eliškou bydleli, dokud byl Pražský hrad pro krále neobyvatelný — a docela příhodně jde o stejnou budovu, jejíž rohový zvon má připomínat roli, kterou Berengar sehrál, když toho prosince pustil Janovy muže do města.",
          zh: "据信这正是布拉格城堡还不宜居时，约翰和伊丽莎白落脚的那栋房子——而颇为应景的是，这栋建筑角落那口铃铛，据说正是为了纪念贝伦加尔那年12月放约翰的人马入城一事而得名。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/John_of_Bohemia",
  },
  {
    ...
    title: {
      ...
      cz: "Dvůr ve válce sám se sebou",
      zh: "宫廷内部的矛盾",
    },
    hookLine: {
      en: "Bohemia had just survived four years of civil war, and all it wanted from its new king was peace. What it got instead was a teenager caught between three competing ideas of how the kingdom should be ruled — none of which agreed with each other.",
      cz: "Čechy právě přežily čtyři roky občanské války a od nového krále nechtěly nic jiného než mír. Místo toho dostaly teenagera, který se ocitl mezi třemi lidmi s odlišnou představou, jak by se mělo vládnout — a žádná z nich se neshodovala s ostatními.",
      zh: "波希米亚刚刚熬过四年内战，对新国王的期望只有一个：和平。可它得到的，却是一个被夹在三方之间的少年——三方各自都有一套自己想要的治国方式，结果谁也说服不了谁。",
    },
    summary: {
      en: "When John rode into Prague at the end of 1310, the goodwill waiting for him was real. Bohemia had spent four years tearing itself apart — a disputed succession, a Habsburg occupation, a capital that had changed hands three times in 1310 alone — and the kingdom wanted, more than anything, a ruler who could simply make the fighting stop. For a little while, it looked like that might actually happen.\n\nIt didn't last.\n\nStill finding his footing in a country whose language he didn't speak, the teenage king leaned on the men his father had sent with him — Archbishop Peter of Aspelt above all, but also Bertold of Henneberg and Walter of Castell, both trusted hands from the elder Henry's own court. Between them, they steered John toward governing the way the Luxembourg dynasty actually cared about: as a piece of imperial politics first, a Bohemian kingdom second, run with the kind of centralized administration John had grown up watching at the French royal court in Paris, where he'd spent much of his childhood.\n\nThe Bohemian nobility wanted precisely none of that. They'd spent the interregnum years assembling exactly the kind of local power a strong central government threatened, and they'd already extracted a written promise — the inaugural charter John signed before his own coronation — that native offices would stay in native hands. A king actually trying to govern, whether on the Luxembourg model or any other, was the opposite of what they'd bargained for.\n\nElizabeth complicated things further, and from an entirely different direction. As a Přemyslid princess, John's queen had her own idea of what strong kingship should look like, closer to her father Wenceslas II's centralized rule than to anything French or imperial — and for a while, as the wife of a young husband still finding his footing, she had real influence in pushing for it. It was, by any practical measure, a decade too late. The nobility that had just spent four years fighting off exactly this kind of royal authority wasn't about to hand it back to a Přemyslid restoration any more readily than to a Luxembourg one.\n\nThen, in the summer of 1313, the ground shifted again. Barely seven weeks after Elizabeth gave birth to their first child, a daughter named Margaret, word reached John's camp near Ulm: his father was dead. Henry VII had died on 24 August near Siena, on the road back from a campaign in Italy — officially of fever, though rumors of poison followed him for years afterward. John, marching west at the head of a Czech contingent to join his father's army, learned the news before he'd even reached the border. The imperial army he was riding to join simply dissolved; the Czech soldiers who'd worn the emperor's colors found themselves, almost overnight, foreigners in hostile territory, and John sent them home rather than risk the retreat with them.\n\nHe couldn't even inherit what his father had built. At seventeen, John was a year too young to stand for election as King of the Romans himself — the office required eighteen — so the crown that might have anchored Luxembourg power in the empire went instead, in October 1314, to Louis of Bavaria. What John did inherit was a county, not an empire: he spent the turn of 1313–14 securing his father's actual homeland, the small hereditary territory of Luxembourg itself, a consolation far short of what the family had been building toward.\n\nBohemia noticed the absence. With John tied up abroad and without his father's authority behind him, the nobility finally had the leverage to make good on everything the 1310 charter had only promised on paper. In April 1315, Czech lords forced John to dismiss Peter of Aspelt, Bertold of Henneberg, and Walter of Castell from office altogether — the very men who'd been steering his imperial-minded governing style since the start. The offices they'd held went back to Bohemian hands, and a familiar face reappeared at the center of it: Henry of Lipé, the same operator who'd first propped up King Henry of Carinthia, then helped bring him down, then served as John's own chamberlain until the foreign advisors elbowed him out — walked straight back into that same chamberlain's office as if he'd never left it.\n\nWithin five years of promising the nobility a kingdom they could control, John had delivered on it almost exactly — not because he wanted to, but because a dead father, a missed crown, and a country he still barely understood had left him with no better option. The peace Bohemia had hoped for in 1310 never really arrived either. What it got instead was a king who mostly wasn't there.",
      cz: "Když Jan koncem roku 1310 vjel do Prahy, dobrá vůle, která na něj čekala, byla skutečná. Čechy strávily čtyři roky vzájemným trháním — sporné nástupnictví, habsburská okupace, hlavní město, které jen v roce 1310 třikrát změnilo majitele — a království si přálo víc než cokoli jiného panovníka, který by prostě dokázal boje zastavit. Na chvíli to vypadalo, že se to opravdu podaří.\n\nNevydrželo to.\n\nMladý král, který se teprve rozkoukával v zemi, jejíž jazyk neuměl, se opíral o muže, které mu poslal otec — v první řadě o arcibiskupa Petra z Aspeltu, ale i o Bertolda z Henebergu a Waltra z Castellu, oba osvědčené lidi ze dvora staršího Jindřicha. Ti společně nasměrovali Jana k vládnutí tím způsobem, na kterém lucemburské dynastii skutečně záleželo: nejdřív jako na součásti říšské politiky, teprve pak jako na českém království, řízeném tím druhem centralizované správy, jaký Jan sledoval na francouzském královském dvoře v Paříži, kde strávil velkou část dětství.\n\nČeská šlechta nechtěla přesně nic z toho. Roky bezvládí strávila budováním přesně toho druhu místní moci, jaký silná centrální vláda ohrožovala, a už si vymohla písemný slib — inaugurační diplom, který Jan podepsal ještě před vlastní korunovací — že zemské úřady zůstanou v rukou domácích. Král, který se skutečně snažil vládnout, ať už podle lucemburského vzoru nebo jakéhokoli jiného, byl přesným opakem toho, na co si šlechta smluvila.\n\nEliška věci komplikovala ještě z úplně jiné strany. Jako přemyslovská princezna měla Janova královna vlastní představu o tom, jak by mělo vypadat silné království — blíže centralizované vládě jejího otce Václava II. než čemukoli francouzskému nebo říšskému — a nějakou dobu, jako manželka mladého manžela, který se teprve rozkoukával, měla při prosazování téhle představy skutečný vliv. Byla to, prakticky vzato, představa o deset let opožděná. Šlechta, která právě strávila čtyři roky bojem přesně proti tomuto druhu královské moci, nehodlala vracet moc zpátky do rukou přemyslovské restaurace o nic ochotněji než do rukou lucemburské.\n\nPak se v létě 1313 půda znovu pohnula. Necelých sedm týdnů poté, co Eliška porodila jejich první dítě, dceru jménem Markéta, dorazila do Janova tábora u Ulmu zpráva: jeho otec je mrtev. Jindřich VII. zemřel 24. srpna nedaleko Sieny, na cestě zpátky z italského tažení — oficiálně na horečku, i když se za ním ještě dlouho táhly fámy o jedu. Jan, který v čele českého oddílu táhl na západ, aby se připojil k otcově vojsku, se o zprávě dozvěděl dřív, než vůbec stihl dorazit k hranici. Říšské vojsko, ke kterému se chystal připojit, se prostě rozpadlo; čeští vojáci, kteří nosili císařovy barvy, se téměř přes noc ocitli jako cizinci na nepřátelském území, a Jan je raději poslal domů, než aby s nimi riskoval ústup.\n\nAni nemohl zdědit, co jeho otec vybudoval. V sedmnácti byl Jan o rok mladší, než aby mohl sám kandidovat na římského krále — podmínkou bylo osmnáct let — a koruna, která mohla lucemburskou moc v říši ukotvit, tak v říjnu 1314 připadla Ludvíku Bavorskému. Co Jan zdědil, bylo hrabství, ne říše: přelom let 1313 a 1314 strávil zajišťováním skutečné otcovy domoviny, malého dědičného území Lucemburska — útěcha hluboko pod tím, k čemu se rodina chystala.\n\nČechy si té nepřítomnosti všimly. Když byl Jan vázaný v zahraničí a bez otcovy autority v zádech, měla šlechta konečně páku, aby si vynutila přesně to, co diplom z roku 1310 zatím jen sliboval na papíře. V dubnu 1315 čeští páni Jana donutili úplně odvolat z úřadu Petra z Aspeltu, Bertolda z Henebergu a Waltra z Castellu — přesně ty muže, kteří od začátku řídili jeho říšsky orientovaný styl vlády. Úřady, které drželi, se vrátily do českých rukou, a uprostřed toho se znovu objevila známá tvář: Jindřich z Lipé, tentýž muž, který nejdřív podepřel krále Jindřicha Korutanského, pak pomohl ho svrhnout, pak sloužil jako Janův vlastní komoří, dokud ho cizí rádci nevystrnadili — vešel zpátky do stejného komornického úřadu, jako by z něj nikdy neodešel.\n\nBěhem pěti let od slibu šlechtě království, které bude moct ovládat, ho Jan splnil skoro do puntíku — ne proto, že by chtěl, ale protože mrtvý otec, ztracená koruna a země, které stále sotva rozuměl, mu nenechaly lepší možnost. Mír, v jaký Čechy v roce 1310 doufaly, taky vlastně nikdy nedorazil. Místo něj dostaly krále, který většinou nebyl doma.",
      zh: "1310年底，约翰骑马进入布拉格时，等着他的那份善意是真心实意的。波希米亚已经自相残杀了整整四年——王位继承起争议、哈布斯堡占领、光是1310年一年，都城就三度易主——这个王国最想要的，不过是一位能真正让战乱平息下来的国王。有那么一阵子，看起来这事真的能成。\n\n可这份和平没能撑太久。\n\n这位仍在摸索这个语言不通的陌生国度的少年国王，只能仰仗父亲派给他的那些人——首推美因茨大主教彼得·冯·阿斯佩尔特，此外还有贝托尔德·冯·亨内贝格和瓦尔特·冯·卡斯特尔，都是老亨利七世宫廷里的得力干将。在他们的引导下，约翰逐渐倾向于按卢森堡家族真正在意的方向来治国：先当帝国政治的一部分，其次才是波希米亚王国，套用的是他童年大半时间在巴黎的法国王室宫廷里见惯了的那种中央集权式治理。\n\n波希米亚贵族对这一切一样都不想要。空位期那几年，他们苦心经营的正是一套强大的中央政府会威胁到的地方权力，而且他们早就拿到了白纸黑字的承诺——约翰在自己加冕前签下的那份就职文书——地方官职将只留给本地人。一位真的想要治理国家的国王，不管走的是卢森堡路线还是别的什么路线，都是贵族当初这笔交易里最不想要的东西。\n\n伊丽莎白又从完全不同的方向把事情搅得更复杂。作为普热米斯尔家的公主，约翰的王后自有一套关于什么才叫强势王权的想法——更接近她父亲瓦茨拉夫二世那种中央集权的统治，而不是什么法式或帝国式的做派——而在丈夫这位还在摸索状态的年轻人身边，她一度确实拥有推动这套想法的真实影响力。可从实际情况来看，这个想法足足晚了十年。那些刚刚花了四年时间才把这类王权顶回去的贵族，可不会更乐意把权力交还给一场普热米斯尔式的复辟，跟交还给卢森堡式的强权比起来，半斤八两。\n\n接着，1313年夏天，局势再次翻转。伊丽莎白刚生下他们的第一个孩子——女儿玛格丽特——还不到七周，消息就传到了约翰驻扎在乌尔姆附近的军营：他父亲死了。亨利七世8月24日死在锡耶纳附近，正走在意大利远征归途上——官方说法是发烧，但毒杀的传闻此后多年一直流传。约翰当时正率领一支捷克部队向西行军，准备与父亲的大军会合，还没赶到边境就听到了这个消息。他本要投奔的那支帝国军队，就这么散了；那些穿着皇帝旗色的捷克士兵，几乎一夜之间，就在敌意环伺的土地上成了外人，约翰索性把他们遣送回国，没有冒险带他们一起撤退。\n\n他甚至没法继承父亲留下的东西。十七岁的约翰，比参选罗马人民的国王所需的年龄还差一岁——门槛是十八岁——于是那顶本可以把卢森堡家族的权力钉进帝国的王冠，1314年10月落到了巴伐利亚的路易头上。约翰真正继承到的，只是一个伯国，不是一个帝国：他在1313年末到1314年初这段时间，忙着巩固的是父亲真正的老家——卢森堡这块不大的世袭领地——比这个家族原本的野心，差了一大截。\n\n波希米亚注意到了这份缺席。约翰远在国外脱不开身，又没了父亲的权威撑腰，贵族们终于等到了筹码，可以把1310年那份文书当年只是白纸上的承诺，变成实实在在的事实。1315年4月，波希米亚贵族逼着约翰彻底罢免了彼得·冯·阿斯佩尔特、贝托尔德·冯·亨内贝格和瓦尔特·冯·卡斯特尔——正是这几位从一开始就在主导他那套帝国式治国风格的人。他们腾出来的官职，重新回到了波希米亚人手里，而这中间又冒出了一张我们的老熟人的脸：利佩的亨利——那位先是撑住了科林西亚的国王亨利，接着又亲手把他扳倒，后来当上约翰自己的宫廷总管，直到被这几位外籍谋臣挤下台的人——如今又径直走回了那个宫廷总管的位子上，仿佛他从来没离开过。\n\n从向贵族许下一个他们能掌控的王国，到几乎原样兑现这个承诺，约翰只花了不到五年——不是因为他自己想要这样，而是因为一位去世的父亲、一顶擦肩而过的王冠，再加上一个他至今仍不太懂的国家，没给他留下更好的选择。波希米亚在1310年盼来的那份和平，其实也从未真正到来过。它得到的，是一位大多数时候都不在国内的国王。",
    },
    quotes: [],
    relatedLandmarks: [],
    wikipediaUrl: "https://en.wikipedia.org/wiki/John_of_Bohemia",
  },
  {
    ...
    images: [
      ...
      "/history/the-two-queens-proxy-war-1315-domazlice.webp",
    ],
    tone: "humorous",
    title: {
      en: "The Two Queens' Proxy War",
      cz: "Zástupná válka dvou královen",
      zh: "两位王后的代理人战争",
    },
    hookLine: {
      en: "Six months after clawing back his old office, Henry of Lipé was in a prison cell instead — arrested at his own queen's urging. The civil war that followed took its name from two women who never drew a sword between them.",
      cz: "Šest měsíců poté, co si zpátky vydobyl svůj starý úřad, seděl Jindřich z Lipé místo toho ve vězení — zatčen na popud vlastní královny. Občanská válka, která následovala, nese jméno dvou žen, z nichž ani jedna nikdy sama nepozvedla zbraň.",
      zh: "重新夺回旧职位才过去六个月，利佩的亨利就锒铛入狱——逮捕他的命令，出自他自己国王的王后之口。随之而来的内战，用两位女性的名字命名，可她们谁都没有亲自动过一件兵器。",
    },
    summary: {
      en: "Henry of Lipé had barely settled back into the chamberlain's office — regained that April, after the Bohemian nobility forced John to dismiss his foreign advisors — when, on 26 October 1315, the king had him arrested instead. He was hauled off to Týřov Castle on a charge of conspiracy against the crown. The man behind the arrest, more than John himself, was almost certainly Elizabeth.\n\nElizabeth's reasons were personal before they were political. Henry had grown close — how close exactly, sources differ on, though 'romantic partner' is the term historians now use — to Elizabeth Richeza of Poland, the dowager queen: Wenceslas II's widow, later briefly married to Rudolf III, a woman who'd already worn the Bohemian crown twice over by two different husbands. John's own queen loathed her stepmother, and loathed the sight of Henry at her side even more. Some accounts add a second, less personal grievance on top: that Henry, who controlled much of the crown's own revenue from the Kutná Hora silver mines, had gotten into the habit of routing that income toward paying off the nobility's own creditors rather than the king's treasury — less a betrayal of feeling than of bookkeeping, but a betrayal all the same. Whichever reason mattered more, the arrest needed no further justification once it was made.\n\nIt backfired immediately. Henry's own Ronov kinsmen rose in protest, and the wider nobility split into two camps that had, by now, been forming for years: one behind Henry and the dowager queen Richeza, the other behind Elizabeth and her own ally, William Zajíc of Valdek — another familiar face, one of the lords who'd refused Rudolf III his allegiance back in 1306. (Zajíc means 'hare,' for what it's worth — an odd name for a man about to lead an armed faction.) Later historians gave the whole affair a name that fits rather well: the War of the Two Queens, fought entirely by proxy, with neither queen so much as raising a weapon herself. Henry sat it out in Týřov for roughly six months before the pressure told, and he walked free the following spring, in April 1316.\n\nPeace, such as it was, didn't hold John's attention for long. Shortly after Henry's release, the king left again — this time for Luxembourg — and handed the actual governing of Bohemia to the one man he still trusted after everything: Archbishop Peter of Aspelt, the very advisor the nobility had forced out of formal office barely a year before. It held together only as long as Aspelt stayed in the job. By early 1317, worn down by a country he could no longer manage, he resigned the post and left Bohemia to Elizabeth outright. Ambitious, capable, and entirely done with being sidelined, she took the reins of government herself — and the war that had never really ended simply picked back up.\n\nElizabeth called her husband home, and John answered by bringing an army of German mercenaries with him to put the rebellious nobility down by force. It was, if anything, the worst possible move: a foreign-raised king turning foreign soldiers loose on Bohemian lords did more to unite the nobility against him than either queen's faction-building ever had. For a while, John's own hold on the Bohemian crown looked genuinely at risk.\n\nIt took an outside party to end it. Louis of Bavaria — the same king who'd won the imperial election John himself had been too young to contest back in 1314, and by now an ally rather than a rival — brokered the peace. At a diet in Domažlice on 24 April 1318, John agreed to terms that amounted to reaffirming, in stronger language, everything the 1310 inaugural charter had already promised.\n\nThe final irony belonged to Henry of Lipé alone. The man John had thrown in a castle cell three years earlier walked out of Domažlice holding the actual administration of Bohemia and Moravia in his own hands — a position the Zbraslav Chronicle itself would later describe in terms that left little room for subtlety:\n\n[[quote:0]]\n\nWhatever the two queens had actually been fighting over, it was Henry, as usual, who ended up running the country — and for Elizabeth, the peace bought at Domažlice would turn out to be the quiet before something considerably worse.",
      cz: "Jindřich z Lipé se sotva stihl usadit zpátky v úřadu komořího — získal ho zpátky ono dubnové, poté co česká šlechta donutila Jana odvolat jeho cizí rádce — když ho 26. října 1315 dal král místo toho zatknout. Byl odvezen na hrad Týřov s obviněním ze spiknutí proti koruně. Za tím zatčením stála, víc než sám Jan, téměř jistě Eliška.\n\nEliščiny důvody byly osobní dřív, než byly politické. Jindřich se sblížil — jak moc přesně, na tom se zdroje neshodnou, i když dnešní historici používají slovo „partner\" — s Eliškou Rejčkou, vdovou po Václavu II., později krátce provdanou za Rudolfa III., ženou, která si už dvakrát v životě oblékla korunu českých královen díky dvěma různým manželům. Janova vlastní královna svou macechu neměla ráda a pohled na Jindřicha po jejím boku snášela ještě hůř. Některé prameny přidávají ještě druhý, méně osobní důvod: že Jindřich, který ovládal značnou část královniných příjmů z kutnohorského stříbra, si zvykl posílat tyto peníze na splácení dluhů šlechtě, místo do královy pokladny — méně zrada citu, spíš zrada účetnictví, ale pořád zrada. Ať už vážil víc jakýkoli z těch důvodů, samotné zatčení už žádné další zdůvodnění nepotřebovalo.\n\nOkamžitě se to obrátilo proti němu. Jindřichovi vlastní ronovští příbuzní povstali na protest a širší šlechta se rozdělila do dvou táborů, které se formovaly už léta: jeden za Jindřichem a vdovskou královnou Rejčkou, druhý za Eliškou a jejím spojencem Vilémem Zajícem z Valdeka — další známou tváří, jedním z pánů, kteří v roce 1306 odmítli složit hold Rudolfovi III. (Zajíc, mimochodem, znamená přesně to, co znamená — poněkud zvláštní jméno pro muže, který se zrovna chystá vést ozbrojenou frakci.) Pozdější historici tomu všemu dali jméno, které sedí docela dobře: válka dvou královen, vedená čistě v zastoupení, aniž by kterákoli z královen sama zvedla zbraň. Jindřich to na Týřově vyseděl zhruba šest měsíců, než tlak zabral, a na jaře 1316 vyšel na svobodu.\n\nMír, jaký to byl, Janovu pozornost dlouho nezaměstnal. Krátce po Jindřichově propuštění král znovu odjel — tentokrát do Lucemburska — a skutečnou správu Čech svěřil jedinému muži, kterému po tom všem ještě věřil: arcibiskupovi Petru z Aspeltu, tomu samému rádci, kterého šlechta necelý rok předtím donutila odvolat z formálního úřadu. Drželo to pohromadě jen tak dlouho, dokud Aspelt zůstával v úřadu. Začátkem roku 1317, vyčerpaný zemí, kterou už nedokázal zvládat, funkci složil a Čechy nechal rovnou Elišce. Ctižádostivá, schopná a s odstavením na vedlejší kolej definitivně hotová, převzala vládu do vlastních rukou — a válka, která nikdy doopravdy neskončila, se prostě znovu rozjela.\n\nEliška si zavolala manžela domů a Jan odpověděl tak, že s sebou přivedl vojsko německých žoldnéřů, aby vzbouřenou šlechtu srazil silou. Byl to, ne-li přímo nejhorší možný tah: cizí král, který na české pány poštval cizí vojáky, sjednotil šlechtu proti sobě víc, než dokázalo budování frakcí kterékoli z královen. Na chvíli vypadalo Janovo vlastní držení českého trůnu skutečně ohroženě.\n\nK ukončení bylo potřeba vnější strany. Ludvík Bavorský — týž král, který vyhrál říšskou volbu, o niž se sám Jan v roce 1314 nemohl kvůli věku ucházet, a teď už spíš spojenec než soupeř — dojednal mír. Na sněmu v Domažlicích 24. dubna 1318 Jan přistoupil na podmínky, které v podstatě znovu, silnějším jazykem, potvrzovaly vše, co už slíbil inaugurační diplom z roku 1310.\n\nPoslední ironii si odnesl jedině Jindřich z Lipé. Muž, kterého Jan před třemi lety nechal zavřít na hradě, odešel z Domažlic se skutečnou správou Čech a Moravy ve vlastních rukou — postavení, které Zbraslavská kronika sama později popsala způsobem, jenž nenechává prostor pro jemnosti:\n\n[[quote:0]]\n\nAť už se ty dvě královny doopravdy přely o cokoli, byl to nakonec, jako obvykle, Jindřich, kdo zemi řídil — a pro Elišku se mír vydobytý v Domažlicích měl brzy ukázat jako klid před něčím mnohem horším.",
      zh: "利佩的亨利刚重新坐稳宫廷总管的位子——四月份，波希米亚贵族逼着约翰罢免外籍顾问后，他才拿回这个职位——1315年10月26日，国王却下令把他逮捕了。他被押往蒂罗夫城堡，罪名是密谋反对王权。这场逮捕的幕后主使，与其说是约翰本人，不如说几乎可以肯定是伊丽莎白。\n\n伊丽莎白的动机，与其说是政治，不如说首先是私人恩怨。亨利跟太后埃利什卡·雷奇卡走得很近——具体有多近，史料说法不一，但今天的历史学家会用“情人”这个词——她是瓦茨拉夫二世的遗孀，后来又短暂改嫁鲁道夫三世，这辈子已经先后靠两任丈夫两次戴上波希米亚王后的桂冠。约翰自己的王后，本来就厌恶这位继母，看见亨利伴在她身边，更是厌恶到极点。也有一些史料补充了第二个、不那么私人的理由：亨利掌控着王室从库特纳霍拉银矿获得的大部分收入，据说他养成了一个习惯——把这笔钱先拿去替贵族偿还他们自己欠下的债务，而不是上缴国王的国库——与其说是感情上的背叛，不如说是账本上的背叛，但终归是背叛。不管哪个理由分量更重，逮捕这件事本身，一旦发生，就再不需要更多解释了。\n\n结果立刻适得其反。亨利自己罗诺夫家族的亲戚们群起抗议，更广泛的贵族阵营，也分裂成了两派——这两派其实已经酝酿多年：一派站在亨利和太后雷奇卡一边，另一派站在伊丽莎白和她的盟友、瓦尔德克的威廉·扎伊茨一边——又是一张熟面孔，1306年那批公开拒绝向鲁道夫三世效忠的贵族之一。（顺带一提，“扎伊茨”这个姓氏在捷克语里就是“野兔”的意思——对一个即将带兵起事的人来说，倒是个挺微妙的名字。）后世历史学家给这整件事起了个相当贴切的名字：“两位王后之战”——一场完完全全靠代理人打的战争，两位王后本人谁都没有亲自动过一件兵器。亨利在蒂罗夫足足关了大约六个月，压力终于起了作用，1316年春天，他重获自由。\n\n和平——如果那也算和平的话——没能让约翰的注意力停留太久。亨利获释后不久，国王再次离开——这次是回卢森堡——把波希米亚的实际治理，交给了他历经这一切风波后仍然信任的唯一一个人：大主教彼得·冯·阿斯佩尔特——正是不到一年前，贵族们才逼着约翰从正式官职上撤下来的那位顾问。这套安排，也只撑到阿斯佩尔特本人还坐在这个位置上为止。1317年初，被这个他再也管不动的国家拖垮，他辞去了这个职务，直接把波希米亚留给了伊丽莎白。这位野心勃勃、能力出众、早已受够被晾在一边的王后，亲自接过了治国大权——那场从未真正结束的战争，就这么重新打了起来。\n\n伊丽莎白把丈夫召唤回国，约翰的回应，是带回了一支德意志雇佣军，打算用武力镇压反叛的贵族。这大概是能做出的最糟糕的选择：一位在外国长大的国王，放任外国士兵冲着波希米亚贵族动手，比两位王后各自拉帮结派加起来，更能把贵族逼到统一战线上去。有那么一阵子，约翰自己在波希米亚王位上的位置，看起来是真的岌岌可危。\n\n最终得靠外人出面才能收场。巴伐利亚的路易——就是1314年那场帝国选举的赢家，约翰当年因为年纪不够都没资格参选，如今这位路易已经从对手变成了盟友——出面斡旋促成了和平。1318年4月24日，在多马日利采召开的议会上，约翰接受了一系列条件，这些条件说到底，不过是用更强硬的措辞，重申了1310年那份就职文书早就许下的一切。\n\n最后的讽刺，独独落在了利佩的亨利一个人身上。三年前被约翰关进城堡地牢的那个人，走出多马日利采时，手里握着的，是波希米亚和摩拉维亚真正的治理大权——这个地位，后来连《兹布拉斯拉夫编年史》自己都是这样毫不客气地记录下来的：\n\n[[quote:0]]\n\n不管这两位王后当初争的到底是什么，到头来，还是一如既往，是亨利在管着这个国家——而对伊丽莎白来说，多马日利采换来的这份和平，很快就会证明只是暴风雨前，一段短暂的宁静。",
    },
    quotes: [
      {
        text: {
          en: "...all the kingdom's affairs were entrusted to him... Favored by Fortune, he grew greater than anyone else in Bohemia, and with him grew his reputation, his fame, his court, and his excessive retinue...",
          cz: "…svěřeny všechny záležitosti královské… Vzrostl z přízně Štěstěny nade všechny v Čechách, vzrostla zároveň jeho pověst, sláva, dvůr a nadměrné služebnictvo…",
          zh: "……王国的一切事务，都交到了他手上……凭借命运女神的眷顾，他在波希米亚一跃凌驾于众人之上，随之水涨船高的，还有他的声望、他的荣耀、他的宫廷排场，以及那支过分庞大的随从队伍……",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        slug: "tyrov-castle",
        relation: {
          en: "The remote royal fortress where Henry of Lipé spent roughly six months in custody after his October 1315 arrest — its one true long-term prisoner, unlike a young rebellious Otakar II decades earlier, who was only ever captured here before being shipped off to Přimda to actually serve his sentence.",
          cz: "Odlehlá královská pevnost, kde Jindřich z Lipé strávil zhruba šest měsíců ve vazbě po svém zatčení v říjnu 1315 — její jediný skutečně dlouhodobý vězeň, na rozdíl od mladého vzbouřeného Otakara II. o desítky let dříve, který tu byl jen zajat, než ho poslali odpykat si trest na Přimdu.",
          zh: "利佩的亨利1315年10月被捕后，就是在这座偏僻的王室要塞里被关押了大约六个月——这也是这座城堡历史上唯一一位真正长期服刑的囚犯，跟几十年前那位年轻造反的奥托卡二世不同——他当年只是在这里被擒获，随后就被押去普日姆达服刑了。",
        },
      },
      {
        slug: "domazlice",
        relation: {
          en: "The town whose arcaded square hosted the actual peace-making: it was here, on 24 April 1318, that John accepted the terms that ended the war and left Henry of Lipé running the kingdom in all but name.",
          cz: "Město, jehož podloubím lemované náměstí bylo dějištěm skutečného usmíření: právě tady Jan 24. dubna 1318 přijal podmínky, které ukončily válku a nechaly Jindřicha z Lipé řídit království, chybělo mu k tomu jen jméno.",
          zh: "这座小镇带拱廊的广场，正是真正促成和解的地方：1318年4月24日，约翰就是在这里接受了终结这场战争的条件，也让利佩的亨利实际上执掌了这个王国，只差一个名分。",
        },
      },
      {
        slug: "kutna-hora",
        relation: {
          en: "The silver town whose royal revenue Henry of Lipé was accused of quietly redirecting toward noble creditors instead of the king's own treasury — one of the two grievances that landed him in a castle cell in October 1315.",
          cz: "Stříbrné město, jehož královské příjmy Jindřich z Lipé podle obvinění potichu přesměrovával k šlechtickým věřitelům místo do královy pokladny — jeden ze dvou důvodů, kvůli kterým skončil v říjnu 1315 na hradě za mřížemi.",
          zh: "这座银都的王室收入，据说被利佩的亨利悄悄挪去替贵族偿还了债务，而不是送进国王的国库——这正是1315年10月他锒铛入狱的两个原因之一。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/John_of_Bohemia",
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        text: {
          en: "…And so, when we had come to Bohemia, we found neither father, nor mother, nor brother, nor sisters, nor anyone we knew. We had also completely forgotten the Czech language, but later learned it again, so that we spoke and understood it like any other Czech… We found this kingdom so devastated that we did not find a single free castle that was not pledged along with all the royal estates, so that we had nowhere to live except in the houses of townsmen, like any other townsman.",
          cz: "…A tak, když jsme byli přišli do Čech, nenalezli jsme ani otce, ani matky, ani bratra, ani sester, aniž koho známého. Také řeč českou jsme úplně zapomněli, ale později jsme se jí opět naučili, takže jsme mluvili a rozuměli jako každý jiný Čech… Toto království jsme nalezli tak zpustošené, že jsme nenašli ani jediného hradu svobodného, který by nebyl zastaven se všemi královskými statky, takže jsme neměli, kde bychom přebývali, leč v domech měšťanských jako jiný měšťan.",
          zh: "……我们抵达波希米亚的时候，没有父亲，没有母亲，没有兄弟，也没有姐妹，甚至连一个熟人都找不到。我们也把捷克语忘得一干二净，后来才重新学会，说起来、听起来才终于像个地道的捷克人……我们发现这个王国已经残破不堪，找不到一座还没被抵押出去的自由城堡，连带着所有的王室领地也是一样，我们竟没有地方可住，只能像普通市民一样，寄住在市民家里。",
        },
        attribution: {
          en: "Charles IV, Vita Caroli",
          cz: "Karel IV., Vita Caroli",
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "So Much to Rebuild",
      cz: "Všechno čeká na obnovu",
      zh: "百废待兴",
    },
    hookLine: {
      en: "The kingdom he'd come home to lay in ruins, and nobody else was in a hurry to fix it. Charles just started: one castle, one town, one language at a time.",
      cz: "Království, do kterého se vrátil, leželo v troskách, a nikdo jiný se je opravit nehrnul. Karel prostě začal: hrad po hradu, město po městě, jazyk po jazyku.",
      zh: "他回到的，是一个百废待兴的王国，却没人急着动手收拾。查理索性自己来，一座城堡、一座城镇、一门语言，一点一点拾掇起来。",
    },
    summary: {
      en: "By 1334 the arrangement Charles had been running since his arrival got a formal name: Margrave of Moravia. Bohemia's nobles didn't need much convincing to back him. Historians would later give the whole setup its own label, the Luxembourg dvojvládí, dual rule, two kings technically sharing one kingdom, one of whom was almost never actually in it.\n\nThe title mattered less than what was actually happening to Charles himself. Prague, ruined as it was, gave him back something eleven years in France never had: pieces of a childhood he'd barely gotten to keep, a city that felt like his rather than a country he was merely governing. Within a couple of years the language came back too, and then some. Charles grew fluent again in Czech, and picked up German alongside it, the language an increasing share of the kingdom's own towns actually ran on.\n\nCompetence did the rest. Bohemia had grown used to a king who was almost never there and had never bothered learning Czech in the first place. A son who actually showed up, spoke their language, and did the work earned trust faster than any formal title could have.\n\n[[quote:0]]\n\nNone of that changed what Charles had actually walked into. Thirty years of civil war and a chronically empty treasury had left Bohemia genuinely wrecked: castles pledged away to cover debts, monasteries and towns left to fend for themselves, a capital that still looked more like a crime scene than a kingdom's seat. Getting Bohemia back on its feet wasn't going to be one grand gesture. It was going to be a very long list of smaller ones.\n\nCharles started with the castles. Within a few years he'd bought back at least some of what his father had pledged away, Křivoklát among them, the same castle where he himself had once been kept apart from his mother as a small child, along with Týřov and Veveří.\n\nHe also began granting Moravia's and Bohemia's monasteries broad privileges and legal immunities, buying their loyalty the same way he'd been buying back castles, and moved to bring a handful of the kingdom's more important towns, Kouřim, Jihlava, Ústí nad Labem, Hradec Králové, and Písek among them, under his own direct control rather than leaving them to whichever noble happened to be holding the reins locally.\n\nThe rebuilding project he actually cared most about was the royal palace at Prague Castle itself, redesigned in the French style he'd grown up with, modeled on the residences of the French kings. Charles pushed the construction along faster than it might otherwise have gone for a very specific reason: he wanted somewhere fit to receive his own wife.\n\nCharles's wife, Blanche, arrived in Prague with a sizable retinue of her own Luxembourg courtiers in tow. Bohemia's nobles were dazzled at first: nobody at court had ever seen French fashion up close before, and Blanche's own beauty didn't hurt. The dazzle wore off fast once anyone actually tried to follow a conversation. Neither the king nor his French-speaking advisors made much sense to a hall full of Czech nobles who didn't speak a word of French.\n\nThe Zbraslav Chronicle recorded the problem in about as diplomatic a way as fourteenth-century Latin allowed.\n\n[[quote:1]]\n\nBlanche and Charles's first daughter was born the following year, in 1335. Whatever else Prague still lacked, it finally had the beginnings of a family in it again.",
      cz: "V roce 1334 dostalo uspořádání, které Karel od svého příjezdu fakticky vedl, i formální jméno: markrabě moravský. Čeští šlechtici ho nepotřebovali dlouho přemlouvat, aby ho podpořili. Historikové dali celému uspořádání později vlastní název, lucemburské dvojvládí, dva králové technicky sdílející jedno království, z nichž jeden v něm skoro nikdy skutečně nebyl.\n\nTitul znamenal míň než to, co se dělo se samotným Karlem. Praha, ať byla sebevíc rozbořená, mu vrátila něco, co jedenáct let ve Francii nikdy nedaly: kousky dětství, které si sotva stihl podržet, město, které začínalo působit jako jeho vlastní, ne jen jako země, kterou zrovna spravuje. Během pár let se mu vrátil i jazyk, a rovnou dvojnásob. Karel znovu ovládl češtinu a k tomu se naučil i němčinu, jazyk, kterým se čím dál víc mluvilo i v samotných městech království.\n\nZbytek udělala schopnost. Čechy si zvykly na krále, který tam skoro nikdy nebyl a navíc se nikdy neobtěžoval naučit česky. Syn, který se skutečně objevil, mluvil jejich jazykem a dělal tu práci, si získal důvěru rychleji než jakýkoli formální titul.\n\n[[quote:0]]\n\nNic z toho ale nezměnilo to, do čeho Karel doopravdy přišel. Třicet let občanských válek a chronicky prázdná pokladna nechaly Čechy opravdu zdevastované: hrady zastavené na pokrytí dluhů, kláštery a města ponechané napospas sama sobě, hlavní město, které pořád vypadalo spíš jako místo činu než sídlo království. Postavit Čechy zpátky na nohy nemělo být jedno velké gesto. Měl to být velmi dlouhý seznam menších.\n\nKarel začal u hradů. Během pár let vykoupil zpátky přinejmenším část toho, co jeho otec zastavil, mimo jiné Křivoklát, tentýž hrad, kde ho samotného kdysi jako malé dítě drželi odděleně od matky, spolu s Týřovem a Veveřím.\n\nZačal také udělovat moravským a českým klášterům rozsáhlé výsady a právní imunity, čímž si kupoval jejich věrnost stejným způsobem, jakým vykupoval hrady, a snažil se dostat pod svou přímou kontrolu i hrstku důležitějších měst království, mimo jiné Kouřim, Jihlavu, Ústí nad Labem, Hradec Králové a Písek, místo aby je nechal tomu šlechtici, který zrovna místně držel otěže.\n\nAle ta stavební práce, na které mu záleželo nejvíc, byla přestavba královského paláce přímo na Pražském hradě, navržená ve francouzském stylu, na jakém Karel sám vyrostl, podle vzoru sídel francouzských králů. Stavbu popoháněl rychleji, než by jinak asi šla, z docela konkrétního důvodu: chtěl mít kam přivést vlastní manželku.\n\nKarlova manželka Blanka dorazila do Prahy s poměrně velkým doprovodem vlastních lucemburských dvořanů. Čeští šlechtici byli zprvu okouzleni: nikdo u dvora dosud neviděl francouzskou módu zblízka, a Blančina vlastní krása tomu taky nepomohla o nic míň. Okouzlení ale rychle vyprchalo, jakmile se kdokoli pokusil sledovat rozhovor. Ani král, ani jeho francouzsky mluvící rádci nedávali velký smysl sálu plnému českých šlechticů, kteří francouzsky neuměli ani slovo.\n\nZbraslavská kronika ten problém zaznamenala tak diplomaticky, jak to čtrnácté století vůbec umožňovalo.\n\n[[quote:1]]\n\nBlančina a Karlova první dcera se narodila následujícího roku, 1335. Ať Praze pořád chybělo cokoli jiného, konečně v ní zase byly i začátky rodiny.",
      zh: "到1334年，查理自抵达以来一直在实际操持的这套安排，有了一个正式名号：摩拉维亚藩侯。波希米亚的贵族们没花多少工夫就被说服支持他。后来的历史学家给这整套安排起了个名字：卢森堡“双重统治”，两位国王名义上共治一个王国，其中一位几乎从不真正待在这个王国里。\n\n头衔本身，其实不如查理自己身上正在发生的事重要。布拉格虽然满目疮痍，却还给了他一样在法国十一年里从没得到过的东西：一点点童年的碎片，一座开始感觉像是“自己的”城市，而不只是一个正在治理的国家。没过几年，语言也跟着找回来了，还是双份的——查理不仅重新说得一口流利的捷克语，还顺带学会了德语，这门语言在王国境内的城镇里，用的人越来越多。\n\n剩下的，靠的是实打实的能力。波希米亚早已习惯了一位几乎从不露面、连捷克语都懒得学的国王。而这个真正出现在眼前、说着他们的语言、实实在在做事的儿子，赢得的信任，比任何正式头衔来得都快。\n\n[[quote:0]]\n\n但这一切，都没能改变查理真正走进的是个什么样的局面。三十年内战，加上长期空虚的国库，让波希米亚实实在在地满目疮痍：城堡被典当出去抵债，修道院和城镇被撂在一边自生自灭，首都看起来还是更像案发现场，而不是一国之都。让波希米亚重新站起来，靠的不会是一次惊天动地的大动作，而是一长串琐碎却缺一不可的小事。\n\n查理先从城堡入手。短短几年内，他就赎回了至少一部分被父亲典当出去的城堡，其中就包括克日沃克拉特城堡——正是他幼年时曾被迫与母亲分开、寄住过的那座城堡——还有蒂罗夫城堡和韦韦日城堡。\n\n他还开始向摩拉维亚和波希米亚的修道院授予广泛的特权和司法豁免，用的是和赎回城堡差不多的路数：花钱换忠诚。他还着手把库日姆、伊赫拉瓦、乌斯季纳德拉贝姆、赫拉德茨-克拉洛韦、皮塞克等几座国内较重要的城镇，直接收归自己掌控，而不是继续听凭当地不管哪位贵族说了算。\n\n而在查理最上心的这场重建计划里，是布拉格城堡本身那座王宫的翻修：按照他自己从小熟悉的法国风格设计，仿照法国国王居所的样式。他把工程进度推得比原本会有的更快，理由也很具体：他想有个像样的地方，迎接自己的妻子。\n\n查理的妻子——布兰奇抵达布拉格时，还带着一大批属于自己的卢森堡侍臣随行。波希米亚的贵族们起初都看呆了：宫廷里从没人这么近距离见过法国的服饰，布兰奇本人的美貌也添了不少分。可这份新鲜劲儿很快就散了——只要有人真想听懂在场谈的是什么，就会发现根本没戏。国王本人和他那些说法语的顾问，对满堂一句法语都不会的波希米亚贵族来说，几乎等于在说天书。\n\n《兹布拉斯拉夫编年史》把这个问题记录了下来，用词已经算得上相当克制。\n\n[[quote:1]]\n\n布兰奇和查理的第一个女儿，在第二年，也就是1335年出生了。不管布拉格当时还缺些什么，这座城市总算又有了一个家庭的雏形。",
    },
    quotes: [
      {
        text: {
      ...
      {
        text: {
          en: "We consider it a great difficulty that she speaks only the French language ... but she is beginning to learn German, and practices herself in it more than in Czech, since in nearly all the towns of the kingdom, and before the king himself, German is these days more commonly used than Czech.",
          cz: "Za velikou obtíž pokládáme, že sama mluví jen francouzským jazykem ... (ale) začíná se učit jazyku německému a více se v něm cvičívá než v jazyce českém; neboť se skoro ve všech městech království a před králem obecněji užívá v této době jazyka německého než českého.",
          zh: "我们认为，她只会说法语，是一件相当麻烦的事……不过她已经开始学习德语，练习德语的功夫，比练习捷克语还要多，因为如今在王国境内几乎所有的城镇里，包括在国王本人面前，用德语的场合都比用捷克语更普遍。",
        },
        attribution: {
          en: "Zbraslav Chronicle",
          cz: "Zbraslavská kronika",
    ...
    relatedLandmarks: [
      {
        slug: "krivoklat-castle",
        relation: {
          en: "One of the castles Charles bought back this same year, the very castle where he himself had once been kept apart from his mother as a small child.",
          cz: "Jeden z hradů, které Karel téhož roku vykoupil zpátky, tentýž hrad, kde ho samotného kdysi jako malé dítě drželi odděleně od matky.",
          zh: "查理这一年赎回的城堡之一，正是他幼年时曾被迫与母亲分开、寄住过的那座城堡。",
        },
      },
      {
        slug: "tyrov-castle",
        relation: {
          en: "Another of the mortgaged royal castles Charles redeemed this year, alongside Křivoklát.",
          cz: "Další ze zastavených královských hradů, které Karel tento rok vykoupil, vedle Křivoklátu.",
          zh: "查理这一年一并赎回的另一座被抵押的王室城堡，与克日沃克拉特城堡一起。",
        },
      },
      {
        slug: "veveri-castle",
        relation: {
          en: "The third of the named castles Charles redeemed this year, a fortress on the Svratka near Brno that had already been changing hands for a century.",
          cz: "Třetí z jmenovaných hradů, které Karel tento rok vykoupil, pevnost na Svratce nedaleko Brna, která už tou dobou celé století měnila majitele.",
          zh: "查理这一年赎回的第三座具名城堡，坐落在布尔诺附近的斯夫拉特卡河畔，此前已经易主了整整一个世纪。",
        },
      },
      {
        slug: "kourim",
        relation: {
          en: "One of the kingdom's more important towns Charles moved to bring under his own direct control rather than leave to local nobles.",
          cz: "Jedno z důležitějších měst království, které se Karel snažil dostat pod svou přímou kontrolu místo toho, aby je nechal místní šlechtě.",
          zh: "查理试图直接收归自己掌控、而不再听凭当地贵族说了算的几座重要城镇之一。",
        },
      },
      {
        slug: "jihlava",
        relation: {
          en: "One of the towns Charles moved to bring under his own control in 1334, a Moravian mining town whose silver had already been enriching Bohemia's kings for generations.",
          cz: "Jedno z měst, která se Karel v roce 1334 snažil dostat pod svou kontrolu, moravské hornické město, jehož stříbro už po generace obohacovalo české krále.",
          zh: "查理在1334年试图收归掌控的城镇之一，一座摩拉维亚矿业城镇，它出产的白银已经让波希米亚历代国王受益了好几代人。",
        },
      },
      {
        slug: "usti-nad-labem",
        relation: {
          en: "One more of the towns on Charles's 1334 list, sitting on the Elbe at the kingdom's own northern edge.",
          cz: "Další z měst na Karlově seznamu z roku 1334, ležící na Labi na severním okraji království.",
          zh: "查理1334年名单上的又一座城镇，坐落在拉贝河畔、王国的北部边缘。",
        },
      },
      {
        slug: "hradec-kralove",
        relation: {
          en: "Another of the towns on Charles's 1334 list, already a city with history of its own by this point, having spent 1308 to 1318 as Eliška Rejčka's own dower town.",
          cz: "Další z měst na Karlově seznamu z roku 1334, v té době už město s vlastní historií, které v letech 1308 až 1318 sloužilo jako věnné město Elišky Rejčky.",
          zh: "查理1334年名单上的又一座城镇，此时早已有了自己的一段来历：1308年到1318年间，它曾是埃丽什卡·雷奇卡的王后寡妇领地城市。",
        },
      },
      {
        slug: "pisek",
        relation: {
          en: "The southernmost of the towns Charles tried to bring under his own direct control this year.",
          cz: "Nejjižnější z měst, která se Karel tento rok snažil dostat pod svou přímou kontrolu.",
          zh: "查理这一年试图直接掌控的这批城镇里，位置最靠南的一座。",
        },
      },
      {
        slug: "brno",
  ...
  },
  {
    ...
    tone: "humorous",
    title: {
      en: "The Crown Wasn't the Point",
      cz: "Koruna nebyla to podstatné",
      zh: "舍末逐本",
    },
    hookLine: {
      en: "Father and son looked out over a ruined capital, castles pawned away, subjects going hungry, and wondered how anyone was supposed to fix this mess. The real problem, as always, was money. Then it hit them: there was one thing left they could actually sell for a fortune...",
      cz: "Otec se synem se dívali na zpustošené hlavní město, zastavené hrady a hladovějící poddané a přemítali, jak se má tenhle nepořádek vůbec dát dohromady. Ten skutečný problém byl, jako vždycky, v penězích. A pak je to napadlo: zbývala jedna věc, kterou by ještě mohli prodat za pořádné jmění...",
      zh: "卢森堡父子看着满目疮痍的都城，被典当出去的城堡和饥饿贫困的国民陷入了沉思，到底怎么来收拾这个烂摊子。说到底，还是缺钱。父子俩突然想到，有一个东西，似乎可以换一大笔钱，拯救这个国家……",
    },
    summary: {
  ...
  },
  {
    ...
    summary: {
      en: "Settling who Bohemia belonged to didn't settle how father and son actually got along. Within a year of that June 1341 diet, the relationship cracked wide open, and the pressure behind it had been building for years, long before blindness ever forced John's hand. The more independently young Charles governed, first in Moravia and then in Tyrol, the more it unsettled both his father and Bohemia's nobility, who had a reliable trick for handling a capable heir, keeping father and son from ever fully trusting each other. John, for his part, resented a son whose growing competence cut into his own old habit of raiding church and town treasuries whenever money ran short. Charles had plenty to resent back: a father who wandered from court to court, spent freely, borrowed more, and switched imperial alliances depending on who'd paid for them last.\n\nWhen Margaret's own father died in 1335, the Habsburgs and Emperor Louis IV joined forces to contest a succession that should have passed straight to the Luxembourgs, and Louis flatly refused to recognize John Henry's claim, one of the first real cracks in a friendship that would keep widening. An unlikely escape from that fight came from Charles's own younger brother. In February 1336, at John Henry's urgent request, Charles took on the guardianship of Tyrol, stepping out of the friction at home and into a county of his own. Tellingly, he brought only a small armed escort with him. The rest of the retinue he built around himself was suited to running a government, not fighting a war, and soldiering, it turned out, was never going to be the main part of what Charles was.\n\nHe rode north again that same year at his father's side, on the Lithuanian campaign that cost John the sight in his right eye. It bought the family no lasting peace. Within weeks the old quarrels resumed, and Charles went back to Tyrol rather than stay in Bohemia.\n\nPrague, meanwhile, supplied its own drama. John's new queen, Beatrice of Bourbon, was crowned there in May 1337, and the city made its preference plain. She never learned Czech, kept a cold distance from her new subjects, bore John a son, Wenceslas, then left Bohemia for good that same July, handing the infant to a nurse rather than raise him herself. What stung John more was the comparison: Prague openly favored Charles's own wife, Blanche of Valois, over his new queen, and under pressure Blanche was sent from Prague to Brno that same year. John also cut off the pension meant to fund Charles's margraviate. He'd clashed the same way with Charles's own mother, Elizabeth, years before.\n\nCharles did not stick around to see how long his father's anger would last. He got out instead, the hard way: overland through Hungary and Croatia, then by ship across the Adriatic, back to Tyrol. Pirates surrounded the vessel and took him captive.\n\n[[quote:0]]\n\nHe spent nine days in their hands before he and two companions slipped away on a borrowed fishing boat, hidden under nets and sacks, and made the rest of the way to Aquileia overland. He reached Tyrol in June 1337 and put himself straight to use, joining Venice's side against Verona and Padua's Mastino della Scala in the wars over Lombardy. That autumn, with John out of the country, Charles quietly returned to Bohemia.\n\nThe one thing that reliably brought John and Charles back together was a shared enemy, and Emperor Louis IV obliged: from 1339 on, the two Luxembourgs worked as allies again. The following year, with John already blind in both eyes, he traveled to Montpellier for one more try at treatment from the university's physicians there, a trip that went nowhere, like all the ones before it. Charles, staying with him, wanted to ride south instead and help Castile's Alfonso XI against the Moors of Granada. John said no. He'd already lost his own sight to a life spent on campaign; he wasn't about to risk losing his heir to one too.\n\nNone of that goodwill survived what came next. Charles had gone on holding Tyrol for his brother John Henry and John Henry's wife, Margaret, Countess of Tyrol, defending it against a standing alliance of Wittelsbach and Habsburg interests who wanted the county for themselves. In November 1341, the decision that ended it was entirely Margaret's own: she locked John Henry out of his own castle, declared the marriage never properly consummated, and a year later married Emperor Louis IV's own son instead. Tyrol was gone, handed straight to the family whose emperor already had every reason to distrust the Luxembourgs, and losing it was one more grievance stacked on years of them already, not the cause of the rift by itself.\n\nBy 1342, father and son were in open dispute again, serious enough now that it took outside intervention to settle. The intervention, when it came, was oddly personal: the new pope, Clement VI, had literally been Charles's own tutor years earlier at the French court. He talked father and son back into something resembling agreement.\n\nThe reconciliation came with a price for Emperor Louis IV, whether he knew it yet or not. In June 1342, at the papal palace, John formally renounced his own oath of fealty to him. It was a quiet document at the time. It would matter enormously four years later.",
      cz: "Vyřešit, komu Čechy vlastně patří, ještě neznamenalo vyřešit, jak spolu otec se synem vlastně vycházejí. Necelý rok po tom červnovém sněmu v roce 1341 vztah otevřeně praskl, a tlak, který za tím stál, se hromadil už léta, dávno předtím, než k tomu Jana donutila slepota. Čím samostatněji mladý Karel vládl, nejdřív na Moravě a pak v Tyrolsku, tím víc to znepokojovalo otce i českou šlechtu, která měla na schopného dědice osvědčený trik, udržet otce a syna v takové nedůvěře k sobě navzájem, aby si nikdy úplně nevěřili. Jan zase nesl nelibě, že rostoucí synova schopnost mu ukrajuje z jeho starého zvyku sáhnout si podle potřeby do pokladny kostelů a měst. Karel měl toho na oplátku dost, co vyčítat: otce, který se toulal ze dvora na dvůr, utrácel bez zábran, půjčoval si další a další peníze a měnil říšská spojenectví podle toho, kdo mu naposled zaplatil nejvíc.\n\nKdyž v roce 1335 zemřel Markétin vlastní otec, spojili Habsburkové a císař Ludvík IV. síly, aby zpochybnili nástupnictví, které mělo připadnout rovnou lucemburkům, a Ludvík Janu Jindřichovi jeho nárok rovnou odmítl uznat, jedna z prvních skutečných trhlin v přátelství, které se mělo dál a dál prohlubovat. Nečekaný únik z toho sporu přišel od Karlova vlastního mladšího bratra. V únoru 1336, na naléhavou žádost Jana Jindřicha, převzal Karel poručnictví nad Tyrolskem, čímž unikl třenicím doma a získal vlastní hrabství. Příznačné je, že si s sebou přivedl jen malý ozbrojený doprovod. Zbytek jeho družiny byl sestavený spíš na vedení vlády než na vedení války, a z vojáka se, jak se ukázalo, nikdy neměla stát Karlova hlavní stránka.\n\nJeště téhož roku znovu vyrazil na sever po boku svého otce, na tažení do Litvy, které Jana stálo zrak na pravém oku. Rodině to natrvalo klid nepřineslo. Během pár týdnů se staré spory obnovily a Karel se místo pobytu v Čechách vrátil do Tyrolska.\n\nPraha mezitím měla vlastní drama. Janova nová manželka, Beatrix Bourbonská, tam byla korunována v květnu 1337, a město dalo svou nechuť jasně najevo. Beatrix se nikdy nenaučila česky, k novým poddaným se chovala chladně, porodila Janovi syna Václava a už v červenci téhož roku Čechy natrvalo opustila, dítě svěřila do péče kojné místo toho, aby ho vychovávala sama. Jana bolelo víc srovnání: Praha zjevně dávala přednost Karlově vlastní manželce, Blance z Valois, před jeho novou královnou, a Blanka byla pod tlakem téhož roku poslána z Prahy do Brna. Jan také zastavil vyplácení penze určené na financování Karlova markrabství. Stejně se už dřív střetl i s Karlovou vlastní matkou Eliškou.\n\nKarel nezůstával, aby zjistil, jak dlouho otcův hněv vydrží. Místo toho zmizel, tou těžší cestou: po souši přes Uhry a Chorvatsko a pak lodí přes Jadran, zpátky do Tyrolska. Piráti loď obklíčili a Karla zajali.\n\n[[quote:0]]\n\nDevět dní strávil v jejich zajetí, než se s dvěma společníky vytratili na vypůjčeném rybářském člunu, schovaní pod sítěmi a pytli, a zbytek cesty do Akvileje absolvovali po souši. Do Tyrolska dorazil v červnu 1337 a hned se dal do práce, přidal se na stranu Benátek proti Veroně a Padově Mastina della Scaly ve válkách o Lombardii. Na podzim toho roku, zatímco byl Jan mimo zemi, se Karel tiše vrátil do Čech.\n\nJediná věc, která Jana s Karlem spolehlivě zase sblížila, byl společný nepřítel, a císař Ludvík IV. posloužil dobře: od roku 1339 oba lucemburkové znovu spolupracovali jako spojenci. Následujícího roku, kdy byl Jan už slepý na obě oči, odcestoval do Montpellier na další pokus o léčbu u tamních univerzitních lékařů, cestu, která nikam nevedla, stejně jako všechny předchozí. Karel, který u něj zůstával, chtěl místo toho vyrazit na jih a pomoct kastilskému králi Alfonsovi XI. proti granadským Maurům. Jan řekl ne. Vlastní zrak už ztratil kvůli životu stráveném na taženích; riskovat, že tímtéž způsobem přijde o svého dědice, nehodlal.\n\nNic z té dobré vůle nepřežilo to, co přišlo dál. Karel dál držel Tyrolsko pro svého bratra Jana Jindřicha a jeho manželku Markétu, tyrolskou hraběnku, a bránil je proti stálému spojenectví wittelsbašských a habsburských zájmů, které si na hrabství dělaly zálusk. V listopadu 1341 bylo rozhodnutí, které tomu udělalo přítrž, čistě Markétino vlastní: nepustila Jana Jindřicha do jeho vlastního hradu, prohlásila manželství za nikdy řádně nenaplněné a o rok později se provdala za vlastního syna císaře Ludvíka IV. Tyrolsko bylo pryč, předané rovnou rodině, jejíž císař už tak měl spoustu důvodů lucemburkům nevěřit, a jeho ztráta byla jen další křivda navrch těch, které se hromadily už léta, ne příčina roztržky sama o sobě.\n\nDo roku 1342 byli otec se synem znovu v otevřeném sporu, natolik vážném, že ho musel urovnat někdo zvenčí. Ten zásah, když přišel, byl podivně osobní: nový papež, Kliment VI., byl kdysi doslova Karlovým vlastním vychovatelem na francouzském dvoře. Otce se synem přemluvil zpátky k něčemu, co se alespoň podobalo dohodě.\n\nUsmíření mělo cenu i pro císaře Ludvíka IV., ať už to tehdy tušil, nebo ne. V červnu 1342, v papežském paláci, se Jan formálně zřekl své přísahy věrnosti vůči němu. Tehdy to byl tichý dokument. O čtyři roky později bude mít nesmírnou váhu.",
      zh: "波希米亚到底该归谁，解决了；父子俩到底处得怎么样，却没有。1341年6月那场议会之后不到一年，这段关系就彻底破裂了，而积压在背后的压力，早在约翰失明逼他摊牌之前好几年，就已经在悄悄累积。年轻的查理越是独立地施政，先是在摩拉维亚，后来在蒂罗尔，就越是让他父亲和波希米亚贵族感到不安，而贵族们对付一个能干的继承人，向来有一套屡试不爽的办法，让父子俩彼此都信不过对方。约翰这边，本就不满一个越来越能干的儿子，挤占了他手头缺钱时随意打劫教会和城市金库的老习惯。查理那边，可抱怨的也不少：一个到处游走各国宫廷、挥金如土、债台高筑，还老是看谁出钱多就跟谁结盟的父亲。\n\n1335年，玛格丽特的父亲一死，哈布斯堡家族和皇帝路易四世就联起手来，对这份本该直接落到卢森堡家族头上的继承权提出挑战，路易更是干脆拒绝承认约翰·亨利的继承资格。这是那段友谊最早裂开的一道口子，日后只会越裂越大。一次意外的解脱，来自查理自己的弟弟。1336年2月，应约翰·亨利的紧急请求，查理接下了蒂罗尔的监护权，从家里的摩擦中脱身，得到了一块属于自己的领地。值得注意的是，他这次只带了一支规模很小的武装随从，而他其余随从的组成，更像是为了治理政务，而不是打仗。事实证明，当兵打仗，从来都不是查理这个人身上最主要的那一面。\n\n同年，他又一次跟随父亲北上，参加了那场让约翰赔上右眼视力的立陶宛远征。这趟出征没能给这个家庭带来长久的和平。没过几个星期，老矛盾又冒了出来，查理索性回了蒂罗尔，没留在波希米亚。\n\n与此同时，布拉格自己也上演着一出戏码。约翰的新王后，波旁的贝娅特丽克丝，1337年5月在那里加冕，而这座城市把自己的态度摆得很明白。贝娅特丽克丝始终没学会捷克语，对新臣民也是一副冷淡的样子，为约翰生下了儿子瓦茨拉夫，可就在同一个七月，她永远离开了波希米亚，把这个婴儿交给乳母抚养，自己却没留下来。更让约翰难堪的，是对比：布拉格明显更偏爱查理自己的妻子瓦卢瓦的布兰奇，而不是这位新王后，于是同一年，布兰奇在压力之下从布拉格被打发去了布尔诺。约翰还断了本该用来供养查理藩侯领地的那笔津贴。多年以前，他就用同样的方式，和查理的母亲伊丽莎白起过冲突。\n\n查理没有留下来看父亲的怒火会烧多久，而是干脆走了，走了一条更艰难的路：先是走陆路穿过匈牙利和克罗地亚，再从海路横渡亚得里亚海，回到蒂罗尔。半路上，海盗的船只把他乘坐的船团团围住，将他掳走。\n\n[[quote:0]]\n\n他在海盗手里被扣了九天，才和两名同伴借来一条小渔船，藏在渔网和麻袋底下逃了出来，剩下的路程改走陆路，一直到阿奎莱亚。1337年6月，他抵达蒂罗尔，一到地方就立刻派上了用场，加入威尼斯一方，在争夺伦巴第的战争里，对抗维罗纳和帕多瓦的统治者马斯蒂诺·德拉·斯卡拉。那年秋天，趁约翰人不在国内，查理又悄悄回了波希米亚。\n\n真正能让约翰和查理重新走到一起的，向来只有一个共同的敌人，而巴伐利亚皇帝路易四世恰好就扮演了这个角色：从1339年起，卢森堡父子俩又开始并肩合作。第二年，此时约翰双眼已经彻底失明，他前往法国南部的蒙彼利埃，想再让当地大学的医生们试一次治疗，结果和之前所有的尝试一样，一无所获。留在他身边的查理，本想南下去帮卡斯蒂利亚国王阿方索十一世，对抗格拉纳达的摩尔人。约翰不答应。他自己的视力，已经断送在了常年出征的路上；他可不打算让继承人也这样搭进去。\n\n这份好不容易修复的关系，没能撑过接下来发生的事。查理一直替弟弟约翰·亨利和他的妻子、蒂罗尔女伯爵玛格丽特，守着蒂罗尔，抵挡着觊觎这块地方的维特尔斯巴赫家族和哈布斯堡家族结成的常设同盟。1341年11月，最终画上句号的这个决定，完全出自玛格丽特自己：她把约翰·亨利挡在了自己城堡的门外，宣称这段婚姻从未真正圆房，一年后转头嫁给了皇帝路易四世自己的儿子。蒂罗尔就这么没了，直接落进了那个本来就有一大堆理由不信任卢森堡家族的皇帝手里，丢掉它不过是多年积怨之上又添的一笔，并不是这场家庭裂痕的起因本身。\n\n到1342年，父子俩再度公开争执，严重到需要外人出面调停。而这次出面调停的人，身份说来还挺私人：新任教皇克莱门特六世，多年前竟然真的当过查理在法国宫廷时的私人教师。他把父子俩劝回到了勉强算得上和解的状态。\n\n这场和解，也让皇帝路易四世付出了代价，尽管他当时未必意识到。1342年6月，就在教皇宫廷里，约翰正式放弃了对他的效忠誓言。在当时，这不过是一份不起眼的文件。可四年之后，它的分量会变得举足轻重。",
    },
    quotes: [
      {
        text: {
          en: "They surrounded our ship with their ships, so that it could not escape in any way.",
          cz: "Obklíčili naši loď svými loděmi, takže nemohla nijak uniknout.",
          zh: "他们用他们的船只把我们的船团团围住，使它无论如何都无法逃脱。",
        },
        attribution: {
          en: "Charles IV, Vita Caroli",
          cz: "Karel IV., Vita Caroli",
    ...
    relatedLandmarks: [
      {
        slug: "brno",
        relation: {
          en: "Blanche of Valois was sent here from Prague under pressure in 1337, to the same city already familiar on this timeline as Charles's own Moravian margravial seat.",
          cz: "Sem byla v roce 1337 pod tlakem poslána Blanka z Valois, do stejného města, které na téhle časové ose už dobře známe jako Karlovo vlastní moravské markraběcí sídlo.",
          zh: "1337年，布兰奇在压力之下从布拉格被打发到了这里，也就是我们的老熟人、查理本人的摩拉维亚藩侯驻地。",
        },
      },
    ],
    wikipediaUrl: "https://en.wikipedia.org/wiki/Charles_IV,_Holy_Roman_Emperor",
